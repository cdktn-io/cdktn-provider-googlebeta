...
# CDKTN prebuilt bindings for hashicorp/google-beta provider version 7.42.0

This repo builds and publishes the [Terraform google-beta provider](https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform google-beta provider](https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0)
