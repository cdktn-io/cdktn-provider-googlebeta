...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlefirestoreindex"
...
&googlefirestoreindex.GoogleFirestoreIndexConfig {
	...
	Project: *string,
	QueryScope: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFirestoreIndex.GoogleFirestoreIndexTimeouts,
}
```
...
&googlefirestoreindex.GoogleFirestoreIndexFields {
	...
	FieldPath: *string,
	Order: *string,
	VectorConfig: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFirestoreIndex.GoogleFirestoreIndexFieldsVectorConfig,
}
```
...
&googlefirestoreindex.GoogleFirestoreIndexFieldsVectorConfig {
	Dimension: *f64,
	Flat: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFirestoreIndex.GoogleFirestoreIndexFieldsVectorConfigFlat,
}
```
