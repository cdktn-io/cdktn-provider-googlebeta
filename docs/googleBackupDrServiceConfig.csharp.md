...
new GoogleBackupDrServiceConfig(Construct Scope, string Id, GoogleBackupDrServiceConfigConfig Config);
```
...
```csharp
private void PutTimeouts(GoogleBackupDrServiceConfigTimeouts Value)
```
...
GoogleBackupDrServiceConfig.IsConstruct(object X);
```
...
GoogleBackupDrServiceConfig.IsTerraformElement(object X);
```
...
GoogleBackupDrServiceConfig.IsTerraformResource(object X);
```
...
GoogleBackupDrServiceConfig.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleBackupDrServiceConfigTimeoutsOutputReference Timeouts { get; }
```
...
```csharp
public IResolvable|GoogleBackupDrServiceConfigTimeouts TimeoutsInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigTimeouts">GoogleBackupDrServiceConfigTimeouts</a>
...
new GoogleBackupDrServiceConfigConfig {
    ...
    string Id = null,
    string Project = null,
    GoogleBackupDrServiceConfigTimeouts Timeouts = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleBackupDrServiceConfigTimeouts Timeouts { get; set; }
```
...
new GoogleBackupDrServiceConfigTimeouts {
    string Create = null,
    string Delete = null
};
```
...
new GoogleBackupDrServiceConfigTimeoutsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigTimeoutsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google-beta.googleBackupDrServiceConfig.GoogleBackupDrServiceConfigTimeoutsOutputReference.resolve.parameter._context"></a>
...
```csharp
public IResolvable|GoogleBackupDrServiceConfigTimeouts InternalValue { get; }
```
