...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputepublicadvertisedprefix"
...
&googlecomputepublicadvertisedprefix.GoogleComputePublicAdvertisedPrefixConfig {
	...
	PdpScope: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixTimeouts,
}
```
