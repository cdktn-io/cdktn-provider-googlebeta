...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputetargethttpsproxy"
...
&googlecomputetargethttpsproxy.GoogleComputeTargetHttpsProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeTargetHttpsProxy.GoogleComputeTargetHttpsProxyTimeouts,
	TlsEarlyData: *string,
}
```
