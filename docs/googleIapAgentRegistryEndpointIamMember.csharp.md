...
Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member google_iap_agent_registry_endpoint_iam_member}.
...
new GoogleIapAgentRegistryEndpointIamMember(Construct Scope, string Id, GoogleIapAgentRegistryEndpointIamMemberConfig Config);
```
...
```csharp
private void PutCondition(GoogleIapAgentRegistryEndpointIamMemberCondition Value)
```
...
GoogleIapAgentRegistryEndpointIamMember.IsConstruct(object X);
```
...
GoogleIapAgentRegistryEndpointIamMember.IsTerraformElement(object X);
```
...
GoogleIapAgentRegistryEndpointIamMember.IsTerraformResource(object X);
```
...
GoogleIapAgentRegistryEndpointIamMember.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMember.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleIapAgentRegistryEndpointIamMemberConditionOutputReference Condition { get; }
```
...
```csharp
public GoogleIapAgentRegistryEndpointIamMemberCondition ConditionInput { get; }
```
...
new GoogleIapAgentRegistryEndpointIamMemberCondition {
    string Expression,
    string Title,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberCondition.property.expression">Expression</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#expression GoogleIapAgentRegistryEndpointIamMember#expression}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#expression GoogleIapAgentRegistryEndpointIamMember#expression}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#title GoogleIapAgentRegistryEndpointIamMember#title}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#description GoogleIapAgentRegistryEndpointIamMember#description}.
...
new GoogleIapAgentRegistryEndpointIamMemberConfig {
    ...
    string Member,
    string Role,
    GoogleIapAgentRegistryEndpointIamMemberCondition Condition = null,
    string Id = null,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#endpoint_id GoogleIapAgentRegistryEndpointIamMember#endpoint_id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#member GoogleIapAgentRegistryEndpointIamMember#member}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#role GoogleIapAgentRegistryEndpointIamMember#role}.
...
```csharp
public GoogleIapAgentRegistryEndpointIamMemberCondition Condition { get; set; }
```
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#condition GoogleIapAgentRegistryEndpointIamMember#condition}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#id GoogleIapAgentRegistryEndpointIamMember#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#location GoogleIapAgentRegistryEndpointIamMember#location}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iap_agent_registry_endpoint_iam_member#project GoogleIapAgentRegistryEndpointIamMember#project}.
...
new GoogleIapAgentRegistryEndpointIamMemberConditionOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConditionOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConditionOutputReference.resolve.parameter._context"></a>
...
```csharp
public GoogleIapAgentRegistryEndpointIamMemberCondition InternalValue { get; }
```
