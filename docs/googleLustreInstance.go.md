...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlelustreinstance"
...
&googlelustreinstance.GoogleLustreInstanceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleLustreInstance.GoogleLustreInstanceTimeouts,
}
```
