...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googlelustreinstance"
...
&googlelustreinstance.GoogleLustreInstanceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleLustreInstance.GoogleLustreInstanceTimeouts,
}
```
