...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleservicedirectorynamespace"
...
&googleservicedirectorynamespace.GoogleServiceDirectoryNamespaceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleServiceDirectoryNamespace.GoogleServiceDirectoryNamespaceTimeouts,
}
```
