...
```typescript
import { googleApphubBoundary } from '@cdktn/provider-google-beta'

new googleApphubBoundary.GoogleApphubBoundary(scope: Construct, id: string, config: GoogleApphubBoundaryConfig)
```
...
```typescript
public putTimeouts(value: GoogleApphubBoundaryTimeouts): void
```
...
googleApphubBoundary.GoogleApphubBoundary.isConstruct(x: any)
```
...
googleApphubBoundary.GoogleApphubBoundary.isTerraformElement(x: any)
```
...
googleApphubBoundary.GoogleApphubBoundary.isTerraformResource(x: any)
```
...
googleApphubBoundary.GoogleApphubBoundary.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundary.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundaryTimeouts">GoogleApphubBoundaryTimeouts</a></code> | *No description.* |
...
```typescript
public readonly timeouts: GoogleApphubBoundaryTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | GoogleApphubBoundaryTimeouts;
```
...
const googleApphubBoundaryConfig: googleApphubBoundary.GoogleApphubBoundaryConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundaryConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundaryConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundaryConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundaryConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly timeouts: GoogleApphubBoundaryTimeouts;
```
...
const googleApphubBoundaryTimeouts: googleApphubBoundary.GoogleApphubBoundaryTimeouts = { ... }
```
...
new googleApphubBoundary.GoogleApphubBoundaryTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleApphubBoundary.GoogleApphubBoundaryTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | GoogleApphubBoundaryTimeouts;
```
