...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleprojectusageexportbucket"
...
&googleprojectusageexportbucket.GoogleProjectUsageExportBucketConfig {
	...
	Prefix: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts,
}
```
