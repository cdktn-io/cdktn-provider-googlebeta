...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeserviceattachment"
...
&googlecomputeserviceattachment.GoogleComputeServiceAttachmentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeServiceAttachment.GoogleComputeServiceAttachmentTimeouts,
}
```
