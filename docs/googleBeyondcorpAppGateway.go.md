...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlebeyondcorpappgateway"
...
&googlebeyondcorpappgateway.GoogleBeyondcorpAppGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleBeyondcorpAppGateway.GoogleBeyondcorpAppGatewayTimeouts,
	Type: *string,
}
```
