...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googledialogflowagent"
...
&googledialogflowagent.GoogleDialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleDialogflowAgent.GoogleDialogflowAgentTimeouts,
}
```
