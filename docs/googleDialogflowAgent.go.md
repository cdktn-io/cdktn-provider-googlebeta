...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v19/googledialogflowagent"
...
&googledialogflowagent.GoogleDialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v19.googleDialogflowAgent.GoogleDialogflowAgentTimeouts,
}
```
