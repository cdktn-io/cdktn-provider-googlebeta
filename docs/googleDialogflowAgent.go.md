...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googledialogflowagent"
...
&googledialogflowagent.GoogleDialogflowAgentConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleDialogflowAgent.GoogleDialogflowAgentTimeouts,
}
```
