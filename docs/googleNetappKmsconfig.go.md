...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetappkmsconfig"
...
&googlenetappkmsconfig.GoogleNetappKmsconfigConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetappKmsconfig.GoogleNetappKmsconfigTimeouts,
}
```
