...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlebigtablelogicalview"
...
&googlebigtablelogicalview.GoogleBigtableLogicalViewConfig {
	...
	Instance: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeouts,
}
```
