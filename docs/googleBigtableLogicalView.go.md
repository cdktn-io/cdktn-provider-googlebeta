...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlebigtablelogicalview"
...
&googlebigtablelogicalview.GoogleBigtableLogicalViewConfig {
	...
	Instance: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeouts,
}
```
