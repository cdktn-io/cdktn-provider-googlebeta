...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworkservicesgateway"
...
&googlenetworkservicesgateway.GoogleNetworkServicesGatewayConfig {
	...
	Subnetwork: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesGateway.GoogleNetworkServicesGatewayTimeouts,
}
```
