...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleapigatewaygateway"
...
&googleapigatewaygateway.GoogleApiGatewayGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts,
}
```
