...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlesecretmanagersecretversion"
...
&googlesecretmanagersecretversion.GoogleSecretManagerSecretVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleSecretManagerSecretVersion.GoogleSecretManagerSecretVersionTimeouts,
}
```
