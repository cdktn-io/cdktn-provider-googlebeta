...
&googlestoragetransferjob.GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSource {
	...
	FederatedIdentityConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleStorageTransferJob.GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig,
	Path: *string,
}
```
