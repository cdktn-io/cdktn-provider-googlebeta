...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworkservicestcproute"
...
&googlenetworkservicestcproute.GoogleNetworkServicesTcpRouteConfig {
	...
	Meshes: *[]*string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesTcpRoute.GoogleNetworkServicesTcpRouteTimeouts,
}
```
...
&googlenetworkservicestcproute.GoogleNetworkServicesTcpRouteRules {
	Action: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesTcpRoute.GoogleNetworkServicesTcpRouteRulesAction,
	Matches: interface{},
}
```
