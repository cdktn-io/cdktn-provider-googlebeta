...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputerouternataddress"
...
&googlecomputerouternataddress.GoogleComputeRouterNatAddressConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeRouterNatAddress.GoogleComputeRouterNatAddressTimeouts,
}
```
