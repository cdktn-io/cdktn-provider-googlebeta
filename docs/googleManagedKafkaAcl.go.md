...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlemanagedkafkaacl"
...
&googlemanagedkafkaacl.GoogleManagedKafkaAclConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclTimeouts,
}
```
