...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeimageiambinding"
...
&googlecomputeimageiambinding.GoogleComputeImageIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeImageIamBinding.GoogleComputeImageIamBindingCondition,
	Id: *string,
	Project: *string,
}
```
