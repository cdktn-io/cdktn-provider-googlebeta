...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeglobaladdress"
...
&googlecomputeglobaladdress.GoogleComputeGlobalAddressConfig {
	...
	Project: *string,
	Purpose: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeouts,
}
```
