...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlesccsourceiammember"
...
&googlesccsourceiammember.GoogleSccSourceIamMemberConfig {
	...
	Role: *string,
	Source: *string,
	Condition: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleSccSourceIamMember.GoogleSccSourceIamMemberCondition,
	Id: *string,
}
```
