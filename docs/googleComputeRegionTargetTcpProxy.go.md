...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeregiontargettcpproxy"
...
&googlecomputeregiontargettcpproxy.GoogleComputeRegionTargetTcpProxyConfig {
	...
	ProxyHeader: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeRegionTargetTcpProxy.GoogleComputeRegionTargetTcpProxyTimeouts,
}
```
