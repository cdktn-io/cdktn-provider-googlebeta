...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlefolder"
...
&googlefolder.GoogleFolderConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFolder.GoogleFolderTimeouts,
}
```
