...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googleactivedirectorypeering"
...
&googleactivedirectorypeering.GoogleActiveDirectoryPeeringConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringTimeouts,
}
```
