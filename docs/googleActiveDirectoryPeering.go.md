...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleactivedirectorypeering"
...
&googleactivedirectorypeering.GoogleActiveDirectoryPeeringConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringTimeouts,
}
```
