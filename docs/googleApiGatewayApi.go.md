...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleapigatewayapi"
...
&googleapigatewayapi.GoogleApiGatewayApiConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleApiGatewayApi.GoogleApiGatewayApiTimeouts,
}
```
