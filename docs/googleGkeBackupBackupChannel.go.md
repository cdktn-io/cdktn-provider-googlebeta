...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegkebackupbackupchannel"
...
&googlegkebackupbackupchannel.GoogleGkeBackupBackupChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeouts,
}
```
