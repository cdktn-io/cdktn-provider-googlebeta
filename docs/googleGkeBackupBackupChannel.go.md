...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlegkebackupbackupchannel"
...
&googlegkebackupbackupchannel.GoogleGkeBackupBackupChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeouts,
}
```
