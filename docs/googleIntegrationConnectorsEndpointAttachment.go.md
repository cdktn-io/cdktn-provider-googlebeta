...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleintegrationconnectorsendpointattachment"
...
&googleintegrationconnectorsendpointattachment.GoogleIntegrationConnectorsEndpointAttachmentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleIntegrationConnectorsEndpointAttachment.GoogleIntegrationConnectorsEndpointAttachmentTimeouts,
}
```
