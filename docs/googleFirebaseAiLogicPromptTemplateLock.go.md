...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlefirebaseailogicprompttemplatelock"
...
&googlefirebaseailogicprompttemplatelock.GoogleFirebaseAiLogicPromptTemplateLockConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleFirebaseAiLogicPromptTemplateLock.GoogleFirebaseAiLogicPromptTemplateLockTimeouts,
}
```
