...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleeventarcenrollment"
...
&googleeventarcenrollment.GoogleEventarcEnrollmentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleEventarcEnrollment.GoogleEventarcEnrollmentTimeouts,
}
```
