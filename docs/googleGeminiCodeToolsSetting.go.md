...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlegeminicodetoolssetting"
...
&googlegeminicodetoolssetting.GoogleGeminiCodeToolsSettingConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleGeminiCodeToolsSetting.GoogleGeminiCodeToolsSettingTimeouts,
}
```
