...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegkehubscope"
...
&googlegkehubscope.GoogleGkeHubScopeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGkeHubScope.GoogleGkeHubScopeTimeouts,
}
```
