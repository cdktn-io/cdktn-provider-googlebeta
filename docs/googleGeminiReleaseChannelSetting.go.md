...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegeminireleasechannelsetting"
...
&googlegeminireleasechannelsetting.GoogleGeminiReleaseChannelSettingConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingTimeouts,
}
```
