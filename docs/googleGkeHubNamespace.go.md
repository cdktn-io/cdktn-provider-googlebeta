...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegkehubnamespace"
...
&googlegkehubnamespace.GoogleGkeHubNamespaceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGkeHubNamespace.GoogleGkeHubNamespaceTimeouts,
}
```
