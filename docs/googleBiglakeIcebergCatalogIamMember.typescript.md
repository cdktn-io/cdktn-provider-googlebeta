...
```typescript
import { googleBiglakeIcebergCatalogIamMember } from '@cdktn/provider-google-beta'

new googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember(scope: Construct, id: string, config: GoogleBiglakeIcebergCatalogIamMemberConfig)
```
...
```typescript
public putCondition(value: GoogleBiglakeIcebergCatalogIamMemberCondition): void
```
...
googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.isConstruct(x: any)
```
...
googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.isTerraformElement(x: any)
```
...
googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.isTerraformResource(x: any)
```
...
googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMember.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleBiglakeIcebergCatalogIamMemberConditionOutputReference;
```
...
```typescript
public readonly conditionInput: GoogleBiglakeIcebergCatalogIamMemberCondition;
```
...
const googleBiglakeIcebergCatalogIamMemberCondition: googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberCondition = { ... }
```
...
const googleBiglakeIcebergCatalogIamMemberConfig: googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleBiglakeIcebergCatalogIamMemberCondition;
```
...
new googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeIcebergCatalogIamMember.GoogleBiglakeIcebergCatalogIamMemberConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: GoogleBiglakeIcebergCatalogIamMemberCondition;
```
