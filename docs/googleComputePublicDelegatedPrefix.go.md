...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputepublicdelegatedprefix"
...
&googlecomputepublicdelegatedprefix.GoogleComputePublicDelegatedPrefixConfig {
	...
	Mode: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputePublicDelegatedPrefix.GoogleComputePublicDelegatedPrefixTimeouts,
}
```
