...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecontaineranalysisnoteiammember"
...
&googlecontaineranalysisnoteiammember.GoogleContainerAnalysisNoteIamMemberConfig {
	...
	Note: *string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleContainerAnalysisNoteIamMember.GoogleContainerAnalysisNoteIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
