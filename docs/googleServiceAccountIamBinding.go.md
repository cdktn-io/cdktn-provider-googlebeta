...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleserviceaccountiambinding"
...
&googleserviceaccountiambinding.GoogleServiceAccountIamBindingConfig {
	...
	Condition: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition,
	Id: *string,
}
```
