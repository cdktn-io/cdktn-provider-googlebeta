...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworksecuritymirroringdeploymentgroup"
...
&googlenetworksecuritymirroringdeploymentgroup.GoogleNetworkSecurityMirroringDeploymentGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkSecurityMirroringDeploymentGroup.GoogleNetworkSecurityMirroringDeploymentGroupTimeouts,
}
```
