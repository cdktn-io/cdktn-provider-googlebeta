...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegeminicoderepositoryindex"
...
&googlegeminicoderepositoryindex.GoogleGeminiCodeRepositoryIndexConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGeminiCodeRepositoryIndex.GoogleGeminiCodeRepositoryIndexTimeouts,
}
```
