...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleoracledatabaseodbsubnet"
...
&googleoracledatabaseodbsubnet.GoogleOracleDatabaseOdbSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleOracleDatabaseOdbSubnet.GoogleOracleDatabaseOdbSubnetTimeouts,
}
```
