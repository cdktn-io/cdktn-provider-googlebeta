...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleoracledatabaseodbsubnet"
...
&googleoracledatabaseodbsubnet.GoogleOracleDatabaseOdbSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleOracleDatabaseOdbSubnet.GoogleOracleDatabaseOdbSubnetTimeouts,
}
```
