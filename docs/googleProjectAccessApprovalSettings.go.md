...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleprojectaccessapprovalsettings"
...
&googleprojectaccessapprovalsettings.GoogleProjectAccessApprovalSettingsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleProjectAccessApprovalSettings.GoogleProjectAccessApprovalSettingsTimeouts,
}
```
