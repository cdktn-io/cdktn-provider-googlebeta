...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworksecurityfirewallendpoint"
...
&googlenetworksecurityfirewallendpoint.GoogleNetworkSecurityFirewallEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkSecurityFirewallEndpoint.GoogleNetworkSecurityFirewallEndpointTimeouts,
}
```
