...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputesslpolicy"
...
&googlecomputesslpolicy.GoogleComputeSslPolicyConfig {
	...
	Profile: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicyTimeouts,
}
```
