...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleresourcemanagercapability"
...
&googleresourcemanagercapability.GoogleResourceManagerCapabilityConfig {
	...
	Value: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleResourceManagerCapability.GoogleResourceManagerCapabilityTimeouts,
}
```
