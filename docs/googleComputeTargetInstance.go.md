...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputetargetinstance"
...
&googlecomputetargetinstance.GoogleComputeTargetInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeouts,
	Zone: *string,
}
```
