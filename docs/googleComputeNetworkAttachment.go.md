...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlecomputenetworkattachment"
...
&googlecomputenetworkattachment.GoogleComputeNetworkAttachmentConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleComputeNetworkAttachment.GoogleComputeNetworkAttachmentTimeouts,
}
```
