...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlealloydbuser"
...
&googlealloydbuser.GoogleAlloydbUserConfig {
	...
	Id: *string,
	Password: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleAlloydbUser.GoogleAlloydbUserTimeouts,
}
```
