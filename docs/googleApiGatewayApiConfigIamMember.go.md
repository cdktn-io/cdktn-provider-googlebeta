...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleapigatewayapiconfigiammember"
...
&googleapigatewayapiconfigiammember.GoogleApiGatewayApiConfigIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleApiGatewayApiConfigIamMember.GoogleApiGatewayApiConfigIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
