...
| <code><a href="#@cdktn/provider-google-beta.googleNetworkServicesGateway.GoogleNetworkServicesGateway.property.allowGlobalAccessInput">AllowGlobalAccessInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleNetworkServicesGateway.GoogleNetworkServicesGateway.property.allowGlobalAccess">AllowGlobalAccess</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public bool|IResolvable AllowGlobalAccessInput { get; }
```
...
```csharp
public bool|IResolvable AllowGlobalAccess { get; }
```
...
new GoogleNetworkServicesGatewayConfig {
    ...
    bool|IResolvable AllowGlobalAccess = null,
...
| <code><a href="#@cdktn/provider-google-beta.googleNetworkServicesGateway.GoogleNetworkServicesGatewayConfig.property.allowGlobalAccess">AllowGlobalAccess</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | Optional. |
...
```csharp
public bool|IResolvable AllowGlobalAccess { get; set; }
```
