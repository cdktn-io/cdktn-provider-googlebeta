...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeinstantsnapshot"
...
&googlecomputeinstantsnapshot.GoogleComputeInstantSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotTimeouts,
	Zone: *string,
}
```
