...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputesharedvpchostproject"
...
&googlecomputesharedvpchostproject.GoogleComputeSharedVpcHostProjectConfig {
	...
	Project: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeSharedVpcHostProject.GoogleComputeSharedVpcHostProjectTimeouts,
}
```
