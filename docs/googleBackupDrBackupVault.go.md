...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlebackupdrbackupvault"
...
&googlebackupdrbackupvault.GoogleBackupDrBackupVaultConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleBackupDrBackupVault.GoogleBackupDrBackupVaultTimeouts,
}
```
