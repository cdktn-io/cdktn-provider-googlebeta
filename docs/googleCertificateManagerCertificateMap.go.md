...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecertificatemanagercertificatemap"
...
&googlecertificatemanagercertificatemap.GoogleCertificateManagerCertificateMapConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleCertificateManagerCertificateMap.GoogleCertificateManagerCertificateMapTimeouts,
}
```
