...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputestoragepool"
...
&googlecomputestoragepool.GoogleComputeStoragePoolConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeStoragePool.GoogleComputeStoragePoolTimeouts,
	Zone: *string,
}
```
