...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlecomputestoragepool"
...
&googlecomputestoragepool.GoogleComputeStoragePoolConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleComputeStoragePool.GoogleComputeStoragePoolTimeouts,
	Zone: *string,
}
```
