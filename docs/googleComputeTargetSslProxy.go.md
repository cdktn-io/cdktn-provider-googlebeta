...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecomputetargetsslproxy"
...
&googlecomputetargetsslproxy.GoogleComputeTargetSslProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyTimeouts,
}
```
