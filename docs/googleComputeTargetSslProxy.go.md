...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputetargetsslproxy"
...
&googlecomputetargetsslproxy.GoogleComputeTargetSslProxyConfig {
	...
	SslPolicy: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyTimeouts,
}
```
