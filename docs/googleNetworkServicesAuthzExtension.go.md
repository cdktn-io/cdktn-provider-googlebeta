...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googlenetworkservicesauthzextension"
...
&googlenetworkservicesauthzextension.GoogleNetworkServicesAuthzExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleNetworkServicesAuthzExtension.GoogleNetworkServicesAuthzExtensionTimeouts,
	WireFormat: *string,
}
```
