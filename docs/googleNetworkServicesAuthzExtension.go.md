...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googlenetworkservicesauthzextension"
...
&googlenetworkservicesauthzextension.GoogleNetworkServicesAuthzExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleNetworkServicesAuthzExtension.GoogleNetworkServicesAuthzExtensionTimeouts,
	WireFormat: *string,
}
```
