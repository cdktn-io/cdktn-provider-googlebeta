...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleorganizationaccessapprovalsettings"
...
&googleorganizationaccessapprovalsettings.GoogleOrganizationAccessApprovalSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleOrganizationAccessApprovalSettings.GoogleOrganizationAccessApprovalSettingsTimeouts,
}
```
