...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputerouterroutepolicy"
...
&googlecomputerouterroutepolicy.GoogleComputeRouterRoutePolicyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeRouterRoutePolicy.GoogleComputeRouterRoutePolicyTimeouts,
	Type: *string,
}
```
...
&googlecomputerouterroutepolicy.GoogleComputeRouterRoutePolicyTerms {
	Match: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeRouterRoutePolicy.GoogleComputeRouterRoutePolicyTermsMatch,
	Priority: *f64,
	Actions: interface{},
}
```
