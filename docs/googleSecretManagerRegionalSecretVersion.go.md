...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlesecretmanagerregionalsecretversion"
...
&googlesecretmanagerregionalsecretversion.GoogleSecretManagerRegionalSecretVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleSecretManagerRegionalSecretVersion.GoogleSecretManagerRegionalSecretVersionTimeouts,
}
```
