...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlelogginglogviewiambinding"
...
&googlelogginglogviewiambinding.GoogleLoggingLogViewIamBindingConfig {
	...
	Parent: *string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleLoggingLogViewIamBinding.GoogleLoggingLogViewIamBindingCondition,
	Id: *string,
	Location: *string,
}
```
