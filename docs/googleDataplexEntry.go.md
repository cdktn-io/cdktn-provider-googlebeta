...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledataplexentry"
...
&googledataplexentry.GoogleDataplexEntryAspects {
	Aspect: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexEntry.GoogleDataplexEntryAspectsAspect,
	AspectKey: *string,
}
```
...
&googledataplexentry.GoogleDataplexEntryConfig {
	...
	EntryGroupId: *string,
	EntryId: *string,
	EntrySource: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexEntry.GoogleDataplexEntryEntrySource,
	FullyQualifiedName: *string,
	Id: *string,
	Location: *string,
	ParentEntry: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexEntry.GoogleDataplexEntryTimeouts,
}
```
