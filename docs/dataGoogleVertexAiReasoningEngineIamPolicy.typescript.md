...
```typescript
import { dataGoogleVertexAiReasoningEngineIamPolicy } from '@cdktn/provider-google-beta'

new dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy(scope: Construct, id: string, config: DataGoogleVertexAiReasoningEngineIamPolicyConfig)
```
...
dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.isConstruct(x: any)
```
...
dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.isTerraformElement(x: any)
```
...
dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.isTerraformDataSource(x: any)
```
...
dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicy.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const dataGoogleVertexAiReasoningEngineIamPolicyConfig: dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicyConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.dataGoogleVertexAiReasoningEngineIamPolicy.DataGoogleVertexAiReasoningEngineIamPolicyConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
