...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleactivedirectorydomaintrust"
...
&googleactivedirectorydomaintrust.GoogleActiveDirectoryDomainTrustConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleActiveDirectoryDomainTrust.GoogleActiveDirectoryDomainTrustTimeouts,
}
```
