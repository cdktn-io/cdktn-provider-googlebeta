...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleactivedirectorydomaintrust"
...
&googleactivedirectorydomaintrust.GoogleActiveDirectoryDomainTrustConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleActiveDirectoryDomainTrust.GoogleActiveDirectoryDomainTrustTimeouts,
}
```
