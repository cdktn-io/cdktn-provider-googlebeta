...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlefilestoresnapshot"
...
&googlefilestoresnapshot.GoogleFilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts,
}
```
