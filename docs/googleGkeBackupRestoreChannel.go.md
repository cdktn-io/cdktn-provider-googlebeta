...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlegkebackuprestorechannel"
...
&googlegkebackuprestorechannel.GoogleGkeBackupRestoreChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelTimeouts,
}
```
