...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegkebackuprestorechannel"
...
&googlegkebackuprestorechannel.GoogleGkeBackupRestoreChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelTimeouts,
}
```
