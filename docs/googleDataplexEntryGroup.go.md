...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googledataplexentrygroup"
...
&googledataplexentrygroup.GoogleDataplexEntryGroupConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleDataplexEntryGroup.GoogleDataplexEntryGroupTimeouts,
}
```
