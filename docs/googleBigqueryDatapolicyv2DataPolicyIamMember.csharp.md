...
new GoogleBigqueryDatapolicyv2DataPolicyIamMember(Construct Scope, string Id, GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig Config);
```
...
```csharp
private void PutCondition(GoogleBigqueryDatapolicyv2DataPolicyIamMemberCondition Value)
```
...
GoogleBigqueryDatapolicyv2DataPolicyIamMember.IsConstruct(object X);
```
...
GoogleBigqueryDatapolicyv2DataPolicyIamMember.IsTerraformElement(object X);
```
...
GoogleBigqueryDatapolicyv2DataPolicyIamMember.IsTerraformResource(object X);
```
...
GoogleBigqueryDatapolicyv2DataPolicyIamMember.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMember.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionOutputReference Condition { get; }
```
...
```csharp
public GoogleBigqueryDatapolicyv2DataPolicyIamMemberCondition ConditionInput { get; }
```
...
new GoogleBigqueryDatapolicyv2DataPolicyIamMemberCondition {
    string Expression,
    string Title,
...
new GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig {
    ...
    string Member,
    string Role,
    GoogleBigqueryDatapolicyv2DataPolicyIamMemberCondition Condition = null,
    string Id = null,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleBigqueryDatapolicyv2DataPolicyIamMemberCondition Condition { get; set; }
```
...
new GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamMember.GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionOutputReference.resolve.parameter._context"></a>
...
```csharp
public GoogleBigqueryDatapolicyv2DataPolicyIamMemberCondition InternalValue { get; }
```
