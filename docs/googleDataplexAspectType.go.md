...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googledataplexaspecttype"
...
&googledataplexaspecttype.GoogleDataplexAspectTypeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleDataplexAspectType.GoogleDataplexAspectTypeTimeouts,
}
```
