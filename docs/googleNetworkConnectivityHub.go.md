...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworkconnectivityhub"
...
&googlenetworkconnectivityhub.GoogleNetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubTimeouts,
}
```
