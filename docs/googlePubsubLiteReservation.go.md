...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlepubsublitereservation"
...
&googlepubsublitereservation.GooglePubsubLiteReservationConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googlePubsubLiteReservation.GooglePubsubLiteReservationTimeouts,
}
```
