...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputefirewallpolicy"
...
&googlecomputefirewallpolicy.GoogleComputeFirewallPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeFirewallPolicy.GoogleComputeFirewallPolicyTimeouts,
}
```
