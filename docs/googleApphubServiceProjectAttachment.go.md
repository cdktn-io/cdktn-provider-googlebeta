...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleapphubserviceprojectattachment"
...
&googleapphubserviceprojectattachment.GoogleApphubServiceProjectAttachmentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleApphubServiceProjectAttachment.GoogleApphubServiceProjectAttachmentTimeouts,
}
```
