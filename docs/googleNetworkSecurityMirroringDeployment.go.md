...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworksecuritymirroringdeployment"
...
&googlenetworksecuritymirroringdeployment.GoogleNetworkSecurityMirroringDeploymentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentTimeouts,
}
```
