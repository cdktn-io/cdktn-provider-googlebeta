...
```typescript
import { googleBiglakeHiveCatalog } from '@cdktn/provider-google-beta'

new googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog(scope: Construct, id: string, config: GoogleBiglakeHiveCatalogConfig)
```
...
```typescript
public putTimeouts(value: GoogleBiglakeHiveCatalogTimeouts): void
```
...
googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.isConstruct(x: any)
```
...
googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.isTerraformElement(x: any)
```
...
googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.isTerraformResource(x: any)
```
...
googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_biglake_hive_catalog#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalog.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly replicas: GoogleBiglakeHiveCatalogReplicasList;
```
...
```typescript
public readonly timeouts: GoogleBiglakeHiveCatalogTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | GoogleBiglakeHiveCatalogTimeouts;
```
...
const googleBiglakeHiveCatalogConfig: googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_biglake_hive_catalog#id GoogleBiglakeHiveCatalog#id}. |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogConfig.property.project">project</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_biglake_hive_catalog#project GoogleBiglakeHiveCatalog#project}. |
...
```typescript
public readonly timeouts: GoogleBiglakeHiveCatalogTimeouts;
```
...
const googleBiglakeHiveCatalogReplicas: googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicas = { ... }
```
...
const googleBiglakeHiveCatalogTimeouts: googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogTimeouts = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogTimeouts.property.create">create</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_biglake_hive_catalog#create GoogleBiglakeHiveCatalog#create}. |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogTimeouts.property.delete">delete</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_biglake_hive_catalog#delete GoogleBiglakeHiveCatalog#delete}. |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogTimeouts.property.update">update</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_biglake_hive_catalog#update GoogleBiglakeHiveCatalog#update}. |
...
new googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogReplicasOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: GoogleBiglakeHiveCatalogReplicas;
```
...
new googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveCatalog.GoogleBiglakeHiveCatalogTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | GoogleBiglakeHiveCatalogTimeouts;
```
