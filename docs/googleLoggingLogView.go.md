...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlelogginglogview"
...
&googlelogginglogview.GoogleLoggingLogViewConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleLoggingLogView.GoogleLoggingLogViewTimeouts,
}
```
