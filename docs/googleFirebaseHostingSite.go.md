...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlefirebasehostingsite"
...
&googlefirebasehostingsite.GoogleFirebaseHostingSiteConfig {
	...
	Project: *string,
	SiteId: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFirebaseHostingSite.GoogleFirebaseHostingSiteTimeouts,
}
```
