...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlefirebaseappleapp"
...
&googlefirebaseappleapp.GoogleFirebaseAppleAppConfig {
	...
	Project: *string,
	TeamId: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeouts,
}
```
