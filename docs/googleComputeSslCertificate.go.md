...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputesslcertificate"
...
&googlecomputesslcertificate.GoogleComputeSslCertificateConfig {
	...
	NamePrefix: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts,
}
```
