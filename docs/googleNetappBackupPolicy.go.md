...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetappbackuppolicy"
...
&googlenetappbackuppolicy.GoogleNetappBackupPolicyConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetappBackupPolicy.GoogleNetappBackupPolicyTimeouts,
}
```
