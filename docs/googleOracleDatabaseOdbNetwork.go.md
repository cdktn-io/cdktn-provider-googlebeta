...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleoracledatabaseodbnetwork"
...
&googleoracledatabaseodbnetwork.GoogleOracleDatabaseOdbNetworkConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkTimeouts,
}
```
