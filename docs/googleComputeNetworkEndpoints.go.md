...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputenetworkendpoints"
...
&googlecomputenetworkendpoints.GoogleComputeNetworkEndpointsConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeNetworkEndpoints.GoogleComputeNetworkEndpointsTimeouts,
	Zone: *string,
}
```
