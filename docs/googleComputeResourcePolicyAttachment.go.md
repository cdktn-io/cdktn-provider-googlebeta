...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlecomputeresourcepolicyattachment"
...
&googlecomputeresourcepolicyattachment.GoogleComputeResourcePolicyAttachmentConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleComputeResourcePolicyAttachment.GoogleComputeResourcePolicyAttachmentTimeouts,
	Zone: *string,
}
```
