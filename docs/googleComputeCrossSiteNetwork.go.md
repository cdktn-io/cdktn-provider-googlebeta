...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlecomputecrosssitenetwork"
...
&googlecomputecrosssitenetwork.GoogleComputeCrossSiteNetworkConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleComputeCrossSiteNetwork.GoogleComputeCrossSiteNetworkTimeouts,
}
```
