...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleparallelstoreinstance"
...
&googleparallelstoreinstance.GoogleParallelstoreInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleParallelstoreInstance.GoogleParallelstoreInstanceTimeouts,
}
```
