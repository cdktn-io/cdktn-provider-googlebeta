...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googleparallelstoreinstance"
...
&googleparallelstoreinstance.GoogleParallelstoreInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleParallelstoreInstance.GoogleParallelstoreInstanceTimeouts,
}
```
