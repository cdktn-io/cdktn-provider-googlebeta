...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googleparallelstoreinstance"
...
&googleparallelstoreinstance.GoogleParallelstoreInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleParallelstoreInstance.GoogleParallelstoreInstanceTimeouts,
}
```
