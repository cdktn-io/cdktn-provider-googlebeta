...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googledataprocmetastorefederation"
...
&googledataprocmetastorefederation.GoogleDataprocMetastoreFederationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleDataprocMetastoreFederation.GoogleDataprocMetastoreFederationTimeouts,
}
```
