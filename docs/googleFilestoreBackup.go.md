...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googlefilestorebackup"
...
&googlefilestorebackup.GoogleFilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleFilestoreBackup.GoogleFilestoreBackupTimeouts,
}
```
