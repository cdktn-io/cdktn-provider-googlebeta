...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googlefilestorebackup"
...
&googlefilestorebackup.GoogleFilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleFilestoreBackup.GoogleFilestoreBackupTimeouts,
}
```
