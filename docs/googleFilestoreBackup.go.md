...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlefilestorebackup"
...
&googlefilestorebackup.GoogleFilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleFilestoreBackup.GoogleFilestoreBackupTimeouts,
}
```
