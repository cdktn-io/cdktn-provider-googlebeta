...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlefilestorebackup"
...
&googlefilestorebackup.GoogleFilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleFilestoreBackup.GoogleFilestoreBackupTimeouts,
}
```
