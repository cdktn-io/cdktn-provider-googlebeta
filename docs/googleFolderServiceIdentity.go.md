...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlefolderserviceidentity"
...
&googlefolderserviceidentity.GoogleFolderServiceIdentityConfig {
	...
	Service: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleFolderServiceIdentity.GoogleFolderServiceIdentityTimeouts,
}
```
