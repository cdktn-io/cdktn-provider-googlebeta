...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetappbackup"
...
&googlenetappbackup.GoogleNetappBackupConfig {
	...
	SourceVolume: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetappBackup.GoogleNetappBackupTimeouts,
}
```
