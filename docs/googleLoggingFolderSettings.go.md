...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googleloggingfoldersettings"
...
&googleloggingfoldersettings.GoogleLoggingFolderSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleLoggingFolderSettings.GoogleLoggingFolderSettingsTimeouts,
}
```
