...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googleloggingfoldersettings"
...
&googleloggingfoldersettings.GoogleLoggingFolderSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleLoggingFolderSettings.GoogleLoggingFolderSettingsTimeouts,
}
```
