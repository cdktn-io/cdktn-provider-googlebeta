...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleloggingfoldersettings"
...
&googleloggingfoldersettings.GoogleLoggingFolderSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleLoggingFolderSettings.GoogleLoggingFolderSettingsTimeouts,
}
```
