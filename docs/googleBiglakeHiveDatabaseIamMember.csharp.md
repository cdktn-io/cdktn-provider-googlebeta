...
new GoogleBiglakeHiveDatabaseIamMember(Construct Scope, string Id, GoogleBiglakeHiveDatabaseIamMemberConfig Config);
```
...
```csharp
private void PutCondition(GoogleBiglakeHiveDatabaseIamMemberCondition Value)
```
...
GoogleBiglakeHiveDatabaseIamMember.IsConstruct(object X);
```
...
GoogleBiglakeHiveDatabaseIamMember.IsTerraformElement(object X);
```
...
GoogleBiglakeHiveDatabaseIamMember.IsTerraformResource(object X);
```
...
GoogleBiglakeHiveDatabaseIamMember.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMember.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference Condition { get; }
```
...
```csharp
public GoogleBiglakeHiveDatabaseIamMemberCondition ConditionInput { get; }
```
...
new GoogleBiglakeHiveDatabaseIamMemberCondition {
    string Expression,
    string Title,
...
new GoogleBiglakeHiveDatabaseIamMemberConfig {
    ...
    string Name,
    string Role,
    GoogleBiglakeHiveDatabaseIamMemberCondition Condition = null,
    string Id = null,
    string Project = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public GoogleBiglakeHiveDatabaseIamMemberCondition Condition { get; set; }
```
...
new GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamMember.GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference.resolve.parameter._context"></a>
...
```csharp
public GoogleBiglakeHiveDatabaseIamMemberCondition InternalValue { get; }
```
