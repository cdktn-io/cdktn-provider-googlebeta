...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleworkstationsworkstation"
...
&googleworkstationsworkstation.GoogleWorkstationsWorkstationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleWorkstationsWorkstation.GoogleWorkstationsWorkstationTimeouts,
}
```
