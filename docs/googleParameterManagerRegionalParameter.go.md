...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleparametermanagerregionalparameter"
...
&googleparametermanagerregionalparameter.GoogleParameterManagerRegionalParameterConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleParameterManagerRegionalParameter.GoogleParameterManagerRegionalParameterTimeouts,
}
```
