...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleeventarcchannel"
...
&googleeventarcchannel.GoogleEventarcChannelConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleEventarcChannel.GoogleEventarcChannelTimeouts,
}
```
