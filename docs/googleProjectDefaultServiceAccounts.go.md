...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleprojectdefaultserviceaccounts"
...
&googleprojectdefaultserviceaccounts.GoogleProjectDefaultServiceAccountsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeouts,
}
```
