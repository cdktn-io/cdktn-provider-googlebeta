...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegeminiloggingsetting"
...
&googlegeminiloggingsetting.GoogleGeminiLoggingSettingConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeouts,
}
```
