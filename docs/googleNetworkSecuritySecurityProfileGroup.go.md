...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworksecuritysecurityprofilegroup"
...
&googlenetworksecuritysecurityprofilegroup.GoogleNetworkSecuritySecurityProfileGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkSecuritySecurityProfileGroup.GoogleNetworkSecuritySecurityProfileGroupTimeouts,
}
```
