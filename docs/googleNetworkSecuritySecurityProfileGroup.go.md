...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googlenetworksecuritysecurityprofilegroup"
...
&googlenetworksecuritysecurityprofilegroup.GoogleNetworkSecuritySecurityProfileGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleNetworkSecuritySecurityProfileGroup.GoogleNetworkSecuritySecurityProfileGroupTimeouts,
}
```
