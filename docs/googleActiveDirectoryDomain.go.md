...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleactivedirectorydomain"
...
&googleactivedirectorydomain.GoogleActiveDirectoryDomainConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeouts,
}
```
