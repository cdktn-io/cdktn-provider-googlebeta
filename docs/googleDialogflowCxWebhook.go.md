...
&googledialogflowcxwebhook.GoogleDialogflowCxWebhookGenericWebService {
	...
	HttpMethod: *string,
	OauthConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDialogflowCxWebhook.GoogleDialogflowCxWebhookGenericWebServiceOauthConfig,
...
&googledialogflowcxwebhook.GoogleDialogflowCxWebhookServiceDirectoryGenericWebService {
	...
	AllowedCaCerts: *[]*string,
	HttpMethod: *string,
	OauthConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDialogflowCxWebhook.GoogleDialogflowCxWebhookServiceDirectoryGenericWebServiceOauthConfig,
	ParameterMapping: *map[string]*string,
	RequestBody: *string,
	RequestHeaders: *map[string]*string,
	SecretVersionForUsernamePassword: *string,
