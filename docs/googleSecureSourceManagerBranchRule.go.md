...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlesecuresourcemanagerbranchrule"
...
&googlesecuresourcemanagerbranchrule.GoogleSecureSourceManagerBranchRuleConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleSecureSourceManagerBranchRule.GoogleSecureSourceManagerBranchRuleTimeouts,
}
```
