...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputenetworkpeeringroutesconfig"
...
&googlecomputenetworkpeeringroutesconfig.GoogleComputeNetworkPeeringRoutesConfigConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeNetworkPeeringRoutesConfig.GoogleComputeNetworkPeeringRoutesConfigTimeouts,
}
```
