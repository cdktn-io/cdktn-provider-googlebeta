...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworkservicestlsroute"
...
&googlenetworkservicestlsroute.GoogleNetworkServicesTlsRouteConfig {
	...
	Meshes: *[]*string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesTlsRoute.GoogleNetworkServicesTlsRouteTimeouts,
}
```
...
&googlenetworkservicestlsroute.GoogleNetworkServicesTlsRouteRules {
	Action: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesTlsRoute.GoogleNetworkServicesTlsRouteRulesAction,
	Matches: interface{},
}
```
