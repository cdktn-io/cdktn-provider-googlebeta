...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlenetworkservicestlsroute"
...
&googlenetworkservicestlsroute.GoogleNetworkServicesTlsRouteConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleNetworkServicesTlsRoute.GoogleNetworkServicesTlsRouteTimeouts,
}
```
...
&googlenetworkservicestlsroute.GoogleNetworkServicesTlsRouteRules {
	Action: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleNetworkServicesTlsRoute.GoogleNetworkServicesTlsRouteRulesAction,
	Matches: interface{},
}
```
