...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlealloydbbackup"
...
&googlealloydbbackup.GoogleAlloydbBackupConfig {
	...
	Description: *string,
	DisplayName: *string,
	EncryptionConfig: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleAlloydbBackup.GoogleAlloydbBackupEncryptionConfig,
	Id: *string,
	Labels: *map[string]*string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleAlloydbBackup.GoogleAlloydbBackupTimeouts,
	Type: *string,
}
```
