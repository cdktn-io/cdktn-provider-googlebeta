...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googledataplexentrytype"
...
&googledataplexentrytype.GoogleDataplexEntryTypeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleDataplexEntryType.GoogleDataplexEntryTypeTimeouts,
	TypeAliases: *[]*string,
}
```
