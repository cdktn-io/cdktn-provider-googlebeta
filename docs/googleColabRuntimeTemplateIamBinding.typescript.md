...
```typescript
import { googleColabRuntimeTemplateIamBinding } from '@cdktn/provider-google-beta'

new googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding(scope: Construct, id: string, config: GoogleColabRuntimeTemplateIamBindingConfig)
```
...
```typescript
public putCondition(value: GoogleColabRuntimeTemplateIamBindingCondition): void
```
...
googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.isConstruct(x: any)
```
...
googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.isTerraformElement(x: any)
```
...
googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.isTerraformResource(x: any)
```
...
googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBinding.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleColabRuntimeTemplateIamBindingConditionOutputReference;
```
...
```typescript
public readonly conditionInput: GoogleColabRuntimeTemplateIamBindingCondition;
```
...
const googleColabRuntimeTemplateIamBindingCondition: googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingCondition = { ... }
```
...
const googleColabRuntimeTemplateIamBindingConfig: googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: GoogleColabRuntimeTemplateIamBindingCondition;
```
...
new googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleColabRuntimeTemplateIamBinding.GoogleColabRuntimeTemplateIamBindingConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: GoogleColabRuntimeTemplateIamBindingCondition;
```
