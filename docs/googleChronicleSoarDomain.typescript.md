...
```typescript
import { googleChronicleSoarDomain } from '@cdktn/provider-google-beta'

new googleChronicleSoarDomain.GoogleChronicleSoarDomain(scope: Construct, id: string, config: GoogleChronicleSoarDomainConfig)
```
...
```typescript
public putTimeouts(value: GoogleChronicleSoarDomainTimeouts): void
```
...
googleChronicleSoarDomain.GoogleChronicleSoarDomain.isConstruct(x: any)
```
...
googleChronicleSoarDomain.GoogleChronicleSoarDomain.isTerraformElement(x: any)
```
...
googleChronicleSoarDomain.GoogleChronicleSoarDomain.isTerraformResource(x: any)
```
...
googleChronicleSoarDomain.GoogleChronicleSoarDomain.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomain.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomain.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomain.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomain.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomain.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomain.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly soarDomainId: string;
```
...
```typescript
public readonly timeouts: GoogleChronicleSoarDomainTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | GoogleChronicleSoarDomainTimeouts;
```
...
const googleChronicleSoarDomainConfig: googleChronicleSoarDomain.GoogleChronicleSoarDomainConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomainConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomainConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomainConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomainConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly timeouts: GoogleChronicleSoarDomainTimeouts;
```
...
const googleChronicleSoarDomainTimeouts: googleChronicleSoarDomain.GoogleChronicleSoarDomainTimeouts = { ... }
```
...
new googleChronicleSoarDomain.GoogleChronicleSoarDomainTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google-beta.googleChronicleSoarDomain.GoogleChronicleSoarDomainTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | GoogleChronicleSoarDomainTimeouts;
```
