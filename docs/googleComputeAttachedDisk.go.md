...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeattacheddisk"
...
&googlecomputeattacheddisk.GoogleComputeAttachedDiskConfig {
	...
	Mode: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeouts,
	Zone: *string,
}
```
