...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworkservicesservicebinding"
...
&googlenetworkservicesservicebinding.GoogleNetworkServicesServiceBindingConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesServiceBinding.GoogleNetworkServicesServiceBindingTimeouts,
}
```
