...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetappactivedirectory"
...
&googlenetappactivedirectory.GoogleNetappActiveDirectoryConfig {
	...
	Site: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetappActiveDirectory.GoogleNetappActiveDirectoryTimeouts,
}
```
