...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleapigeecontrolplaneaccess"
...
&googleapigeecontrolplaneaccess.GoogleApigeeControlPlaneAccessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleApigeeControlPlaneAccess.GoogleApigeeControlPlaneAccessTimeouts,
}
```
