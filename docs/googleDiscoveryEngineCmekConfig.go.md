...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlediscoveryenginecmekconfig"
...
&googlediscoveryenginecmekconfig.GoogleDiscoveryEngineCmekConfigConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDiscoveryEngineCmekConfig.GoogleDiscoveryEngineCmekConfigTimeouts,
}
```
