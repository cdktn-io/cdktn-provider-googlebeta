...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlelogginglinkeddataset"
...
&googlelogginglinkeddataset.GoogleLoggingLinkedDatasetConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleLoggingLinkedDataset.GoogleLoggingLinkedDatasetTimeouts,
}
```
