...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlehealthcareconsentstore"
...
&googlehealthcareconsentstore.GoogleHealthcareConsentStoreConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleHealthcareConsentStore.GoogleHealthcareConsentStoreTimeouts,
}
```
