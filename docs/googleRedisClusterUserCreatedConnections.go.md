...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googleredisclusterusercreatedconnections"
...
&googleredisclusterusercreatedconnections.GoogleRedisClusterUserCreatedConnectionsClusterEndpointsConnections {
	PscConnection: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleRedisClusterUserCreatedConnections.GoogleRedisClusterUserCreatedConnectionsClusterEndpointsConnectionsPscConnection,
}
```
...
&googleredisclusterusercreatedconnections.GoogleRedisClusterUserCreatedConnectionsConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleRedisClusterUserCreatedConnections.GoogleRedisClusterUserCreatedConnectionsTimeouts,
}
```
