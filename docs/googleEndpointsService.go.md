...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleendpointsservice"
...
&googleendpointsservice.GoogleEndpointsServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleEndpointsService.GoogleEndpointsServiceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleEndpointsService.GoogleEndpointsServiceConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_endpoints_service#id GoogleEndpointsService#id}. |
