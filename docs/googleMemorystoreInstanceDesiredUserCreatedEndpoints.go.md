...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlememorystoreinstancedesiredusercreatedendpoints"
...
&googlememorystoreinstancedesiredusercreatedendpoints.GoogleMemorystoreInstanceDesiredUserCreatedEndpointsConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleMemorystoreInstanceDesiredUserCreatedEndpoints.GoogleMemorystoreInstanceDesiredUserCreatedEndpointsTimeouts,
}
```
...
&googlememorystoreinstancedesiredusercreatedendpoints.GoogleMemorystoreInstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointsConnections {
	PscConnection: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleMemorystoreInstanceDesiredUserCreatedEndpoints.GoogleMemorystoreInstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointsConnectionsPscConnection,
}
```
