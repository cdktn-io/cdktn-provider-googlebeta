...
```csharp
private void ResetForceUpdateAccessRestriction()
```
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrBackupVault.GoogleBackupDrBackupVault.property.forceUpdateAccessRestrictionInput">ForceUpdateAccessRestrictionInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrBackupVault.GoogleBackupDrBackupVault.property.forceUpdateAccessRestriction">ForceUpdateAccessRestriction</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public bool|IResolvable ForceUpdateAccessRestrictionInput { get; }
```
...
```csharp
public bool|IResolvable ForceUpdateAccessRestriction { get; }
```
...
new GoogleBackupDrBackupVaultConfig {
    ...
    bool|IResolvable ForceUpdateAccessRestriction = null,
    string Id = null,
...
| <code><a href="#@cdktn/provider-google-beta.googleBackupDrBackupVault.GoogleBackupDrBackupVaultConfig.property.forceUpdateAccessRestriction">ForceUpdateAccessRestriction</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | If set to true, we will force update access restriction even if some non compliant data sources are present. |
...
```csharp
public bool|IResolvable ForceUpdateAccessRestriction { get; set; }
```
