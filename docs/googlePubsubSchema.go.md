...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlepubsubschema"
...
&googlepubsubschema.GooglePubsubSchemaConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googlePubsubSchema.GooglePubsubSchemaTimeouts,
	Type: *string,
}
```
