...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleiamworkforcepooliammember"
...
&googleiamworkforcepooliammember.GoogleIamWorkforcePoolIamMemberConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleIamWorkforcePoolIamMember.GoogleIamWorkforcePoolIamMemberCondition,
	Id: *string,
	Location: *string,
}
```
