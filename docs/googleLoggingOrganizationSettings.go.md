...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googleloggingorganizationsettings"
...
&googleloggingorganizationsettings.GoogleLoggingOrganizationSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleLoggingOrganizationSettings.GoogleLoggingOrganizationSettingsTimeouts,
}
```
