...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googleapigeeappgroup"
...
&googleapigeeappgroup.GoogleApigeeAppGroupConfig {
	...
	Id: *string,
	Status: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleApigeeAppGroup.GoogleApigeeAppGroupTimeouts,
}
```
