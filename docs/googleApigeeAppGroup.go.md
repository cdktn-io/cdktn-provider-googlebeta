...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googleapigeeappgroup"
...
&googleapigeeappgroup.GoogleApigeeAppGroupConfig {
	...
	Id: *string,
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleApigeeAppGroup.GoogleApigeeAppGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google-beta.googleApigeeAppGroup.GoogleApigeeAppGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_apigee_app_group#id GoogleApigeeAppGroup#id}. |
