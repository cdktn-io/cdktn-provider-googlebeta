...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledataplexglossaryterm"
...
&googledataplexglossaryterm.GoogleDataplexGlossaryTermConfig {
	...
	Project: *string,
	TermId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexGlossaryTerm.GoogleDataplexGlossaryTermTimeouts,
}
```
