...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlenetworkservicesmesh"
...
&googlenetworkservicesmesh.GoogleNetworkServicesMeshConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleNetworkServicesMesh.GoogleNetworkServicesMeshTimeouts,
}
```
