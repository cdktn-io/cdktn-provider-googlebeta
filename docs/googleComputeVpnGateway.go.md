...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputevpngateway"
...
&googlecomputevpngateway.GoogleComputeVpnGatewayConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayTimeouts,
}
```
