...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlegeminicodetoolssettingbinding"
...
&googlegeminicodetoolssettingbinding.GoogleGeminiCodeToolsSettingBindingConfig {
	...
	Product: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleGeminiCodeToolsSettingBinding.GoogleGeminiCodeToolsSettingBindingTimeouts,
}
```
