...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlesourcereporepository"
...
&googlesourcereporepository.GoogleSourcerepoRepositoryConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleSourcerepoRepository.GoogleSourcerepoRepositoryTimeouts,
}
```
