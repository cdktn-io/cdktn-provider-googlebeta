...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputerouterinterface"
...
&googlecomputerouterinterface.GoogleComputeRouterInterfaceConfig {
	...
	Region: *string,
	Subnetwork: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeRouterInterface.GoogleComputeRouterInterfaceTimeouts,
	VpnTunnel: *string,
}
```
