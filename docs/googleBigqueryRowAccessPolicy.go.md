...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlebigqueryrowaccesspolicy"
...
&googlebigqueryrowaccesspolicy.GoogleBigqueryRowAccessPolicyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleBigqueryRowAccessPolicy.GoogleBigqueryRowAccessPolicyTimeouts,
}
```
