...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googletagstagkey"
...
&googletagstagkey.GoogleTagsTagKeyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleTagsTagKey.GoogleTagsTagKeyTimeouts,
}
```
