...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16/googletagstagkey"
...
&googletagstagkey.GoogleTagsTagKeyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v16.googleTagsTagKey.GoogleTagsTagKeyTimeouts,
}
```
