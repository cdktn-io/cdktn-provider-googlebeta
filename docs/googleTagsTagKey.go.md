...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googletagstagkey"
...
&googletagstagkey.GoogleTagsTagKeyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20.googleTagsTagKey.GoogleTagsTagKeyTimeouts,
}
```
