...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googledataplexglossary"
...
&googledataplexglossary.GoogleDataplexGlossaryConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleDataplexGlossary.GoogleDataplexGlossaryTimeouts,
}
```
