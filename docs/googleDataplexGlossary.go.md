...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledataplexglossary"
...
&googledataplexglossary.GoogleDataplexGlossaryConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexGlossary.GoogleDataplexGlossaryTimeouts,
}
```
