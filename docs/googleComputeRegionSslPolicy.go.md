...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeregionsslpolicy"
...
&googlecomputeregionsslpolicy.GoogleComputeRegionSslPolicyConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeRegionSslPolicy.GoogleComputeRegionSslPolicyTimeouts,
}
```
