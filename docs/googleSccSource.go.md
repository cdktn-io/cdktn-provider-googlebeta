...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlesccsource"
...
&googlesccsource.GoogleSccSourceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleSccSource.GoogleSccSourceTimeouts,
}
```
