...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlediscoveryenginesitemap"
...
&googlediscoveryenginesitemap.GoogleDiscoveryEngineSitemapConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeouts,
	Uri: *string,
}
```
