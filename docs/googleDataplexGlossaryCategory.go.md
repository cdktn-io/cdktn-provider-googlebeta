...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledataplexglossarycategory"
...
&googledataplexglossarycategory.GoogleDataplexGlossaryCategoryConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataplexGlossaryCategory.GoogleDataplexGlossaryCategoryTimeouts,
}
```
