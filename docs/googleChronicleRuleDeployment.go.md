...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlechronicleruledeployment"
...
&googlechronicleruledeployment.GoogleChronicleRuleDeploymentConfig {
	...
	Project: *string,
	RunFrequency: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleChronicleRuleDeployment.GoogleChronicleRuleDeploymentTimeouts,
}
```
