...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/googlechronicleruledeployment"
...
&googlechronicleruledeployment.GoogleChronicleRuleDeploymentConfig {
	...
	Project: *string,
	RunFrequency: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18.googleChronicleRuleDeployment.GoogleChronicleRuleDeploymentTimeouts,
}
```
