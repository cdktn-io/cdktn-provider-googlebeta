...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlecomputeinstancegroup"
...
&googlecomputeinstancegroup.GoogleComputeInstanceGroupConfig {
	...
	Network: *string,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleComputeInstanceGroup.GoogleComputeInstanceGroupTimeouts,
	Zone: *string,
}
```
