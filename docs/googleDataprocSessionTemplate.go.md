...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googledataprocsessiontemplate"
...
&googledataprocsessiontemplate.GoogleDataprocSessionTemplateConfig {
	...
	Name: *string,
	EnvironmentConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateEnvironmentConfig,
	Id: *string,
	JupyterSession: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateJupyterSession,
	Labels: *map[string]*string,
	Location: *string,
	Project: *string,
	RuntimeConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateRuntimeConfig,
	SparkConnectSession: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateSparkConnectSession,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateTimeouts,
}
```
...
&googledataprocsessiontemplate.GoogleDataprocSessionTemplateEnvironmentConfig {
	ExecutionConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateEnvironmentConfigExecutionConfig,
	PeripheralsConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateEnvironmentConfigPeripheralsConfig,
}
```
...
&googledataprocsessiontemplate.GoogleDataprocSessionTemplateEnvironmentConfigExecutionConfig {
	AuthenticationConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfig,
	IdleTtl: *string,
	KmsKey: *string,
	NetworkTags: *[]*string,
...
&googledataprocsessiontemplate.GoogleDataprocSessionTemplateEnvironmentConfigPeripheralsConfig {
	...
	SparkHistoryServerConfig: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleDataprocSessionTemplate.GoogleDataprocSessionTemplateEnvironmentConfigPeripheralsConfigSparkHistoryServerConfig,
}
```
