...
```go
import "github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/googlelogginglogscope"
...
&googlelogginglogscope.GoogleLoggingLogScopeConfig {
	...
	Location: *string,
	Parent: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta.googleLoggingLogScope.GoogleLoggingLogScopeTimeouts,
}
```
