...
```go
import "github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta/googlenetappvolumequotarule"
...
&googlenetappvolumequotarule.GoogleNetappVolumeQuotaRuleConfig {
	...
	Project: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googlebeta-go/googlebeta.googleNetappVolumeQuotaRule.GoogleNetappVolumeQuotaRuleTimeouts,
}
```
