...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_compute_subnetworks
...
export interface DataGoogleComputeSubnetworksConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleComputeSubnetworksSubnetworksOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeSubnetworksSubnetworksList extends cdktn.ComplexList {
...
*/
export class DataGoogleComputeSubnetworks extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeSubnetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_compute_subnetworks#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_compute_subnetworks", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_compute_subnetworks google_compute_subnetworks} Data Source
  *
  * @param scope The scope in which to define this construct
