...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_healthcare_consent_store_iam_binding
...
export class GoogleHealthcareConsentStoreIamBinding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleHealthcareConsentStoreIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_healthcare_consent_store_iam_binding#import import section} in the documentation of this resource for the id to use
