...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_iam_workforce_pool_provider_scim_token
...
export class GoogleIamWorkforcePoolProviderScimToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIamWorkforcePoolProviderScimToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_iam_workforce_pool_provider_scim_token#import import section} in the documentation of this resource for the id to use
