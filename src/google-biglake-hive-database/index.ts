...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_biglake_hive_database
...
export class GoogleBiglakeHiveDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBiglakeHiveDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_biglake_hive_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_biglake_hive_database google_biglake_hive_database} Resource
  *
  * @param scope The scope in which to define this construct
