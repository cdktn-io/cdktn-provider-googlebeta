...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_storage_managed_folder_iam_policy
...
export interface GoogleStorageManagedFolderIamPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class GoogleStorageManagedFolderIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleStorageManagedFolderIamPolicy to import
  * @param importFromId The id of the existing GoogleStorageManagedFolderIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_storage_managed_folder_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_storage_managed_folder_iam_policy google_storage_managed_folder_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleStorageManagedFolderIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleStorageManagedFolderIamPolicyConfig) {
    super(scope, id, {
