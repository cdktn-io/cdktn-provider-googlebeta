...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_parameter_manager_regional_parameter_version
...
export interface GoogleParameterManagerRegionalParameterVersionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleParameterManagerRegionalParameterVersionTimeoutsToTerraform(struct?: GoogleParameterManagerRegionalParameterVersionTimeouts | cdktf.IResolvable): any {
...
export function googleParameterManagerRegionalParameterVersionTimeoutsToHclTerraform(struct?: GoogleParameterManagerRegionalParameterVersionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleParameterManagerRegionalParameterVersionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleParameterManagerRegionalParameterVersionTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleParameterManagerRegionalParameterVersionTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleParameterManagerRegionalParameterVersion extends cdktf.TerraformResource {
