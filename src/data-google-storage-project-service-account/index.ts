...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_storage_project_service_account
...
export interface DataGoogleStorageProjectServiceAccountConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataGoogleStorageProjectServiceAccount extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleStorageProjectServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_storage_project_service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_storage_project_service_account", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_storage_project_service_account google_storage_project_service_account} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      user_project: cdktn.stringToTerraform(this._userProject),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      user_project: {
        value: cdktn.stringToHclTerraform(this._userProject),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
