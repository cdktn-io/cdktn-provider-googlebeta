...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster
...
export interface DataGoogleVmwareengineClusterConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster#id DataGoogleVmwareengineCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster#name DataGoogleVmwareengineCluster#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster#parent DataGoogleVmwareengineCluster#parent}
  */
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesConsumedMemoryThresholdsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesConsumedMemoryThresholdsList extends cdktn.ComplexList {
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesCpuThresholdsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesCpuThresholdsList extends cdktn.ComplexList {
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesStorageThresholdsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesStorageThresholdsList extends cdktn.ComplexList {
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesList extends cdktn.ComplexList {
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineClusterAutoscalingSettingsList extends cdktn.ComplexList {
...
export interface DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetwork {
}
...
export class DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetworkOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetwork | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetwork | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetworkList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetworkOutputReference {
    return new DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetworkOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataGoogleVmwareengineClusterDatastoreMountConfig {
}
...
export class DataGoogleVmwareengineClusterDatastoreMountConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleVmwareengineClusterDatastoreMountConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleVmwareengineClusterDatastoreMountConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // datastore_network - computed: true, optional: false, required: false
  private _datastoreNetwork = new DataGoogleVmwareengineClusterDatastoreMountConfigDatastoreNetworkList(this, "datastore_network", false);
  ...
  // ignore_colocation - computed: true, optional: false, required: false
  public get ignoreColocation() {
    return this.getBooleanAttribute('ignore_colocation');
  }

  // nfs_version - computed: true, optional: false, required: false
...
export class DataGoogleVmwareengineClusterDatastoreMountConfigList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGoogleVmwareengineClusterDatastoreMountConfigOutputReference {
    return new DataGoogleVmwareengineClusterDatastoreMountConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleVmwareengineClusterNodeTypeConfigsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineClusterNodeTypeConfigsList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster google_vmwareengine_cluster}
*/
export class DataGoogleVmwareengineCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_vmwareengine_cluster google_vmwareengine_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // datastore_mount_config - computed: true, optional: false, required: false
  private _datastoreMountConfig = new DataGoogleVmwareengineClusterDatastoreMountConfigList(this, "datastore_mount_config", false);
