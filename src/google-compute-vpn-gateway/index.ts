...
export function googleComputeVpnGatewayTimeoutsToTerraform(struct?: GoogleComputeVpnGatewayTimeouts | cdktf.IResolvable): any {
...
export function googleComputeVpnGatewayTimeoutsToHclTerraform(struct?: GoogleComputeVpnGatewayTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeVpnGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeVpnGatewayTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeVpnGatewayTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
