...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_compute_ha_vpn_gateway
...
export interface GoogleComputeHaVpnGatewayConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly params?: GoogleComputeHaVpnGatewayParams;
  /**
  * timeouts block
  *
...
export interface GoogleComputeHaVpnGatewayParams {
  /**
...
export function googleComputeHaVpnGatewayParamsToTerraform(struct?: GoogleComputeHaVpnGatewayParamsOutputReference | GoogleComputeHaVpnGatewayParams): any {
...
export function googleComputeHaVpnGatewayParamsToHclTerraform(struct?: GoogleComputeHaVpnGatewayParamsOutputReference | GoogleComputeHaVpnGatewayParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleComputeHaVpnGatewayParamsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeHaVpnGatewayParams | undefined {
  ...
  public set internalValue(value: GoogleComputeHaVpnGatewayParams | undefined) {
    if (value === undefined) {
...
export class GoogleComputeHaVpnGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeHaVpnGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_compute_ha_vpn_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_compute_ha_vpn_gateway google_compute_ha_vpn_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new GoogleComputeHaVpnGatewayParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: GoogleComputeHaVpnGatewayParams) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      params: googleComputeHaVpnGatewayParamsToTerraform(this._params.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      params: {
        value: googleComputeHaVpnGatewayParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHaVpnGatewayParamsList",
      },
      timeouts: {
