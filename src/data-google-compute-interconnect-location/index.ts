...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_interconnect_location
...
export class DataGoogleComputeInterconnectLocation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeInterconnectLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_interconnect_location#import import section} in the documentation of this resource for the id to use
