...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_spanner_instance_iam_member
...
export class GoogleSpannerInstanceIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSpannerInstanceIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_spanner_instance_iam_member#import import section} in the documentation of this resource for the id to use
