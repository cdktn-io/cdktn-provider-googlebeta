...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_identity_platform_default_supported_idp_config
...
export interface GoogleIdentityPlatformDefaultSupportedIdpConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * OAuth client ID
  *
...
export function googleIdentityPlatformDefaultSupportedIdpConfigTimeoutsToTerraform(struct?: GoogleIdentityPlatformDefaultSupportedIdpConfigTimeouts | cdktf.IResolvable): any {
...
export function googleIdentityPlatformDefaultSupportedIdpConfigTimeoutsToHclTerraform(struct?: GoogleIdentityPlatformDefaultSupportedIdpConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIdentityPlatformDefaultSupportedIdpConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIdentityPlatformDefaultSupportedIdpConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleIdentityPlatformDefaultSupportedIdpConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIdentityPlatformDefaultSupportedIdpConfig extends cdktf.TerraformResource {
