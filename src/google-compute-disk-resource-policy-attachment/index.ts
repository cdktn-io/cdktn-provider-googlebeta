...
export function googleComputeDiskResourcePolicyAttachmentTimeoutsToTerraform(struct?: GoogleComputeDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable): any {
...
export function googleComputeDiskResourcePolicyAttachmentTimeoutsToHclTerraform(struct?: GoogleComputeDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeDiskResourcePolicyAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeDiskResourcePolicyAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeDiskResourcePolicyAttachment extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_compute_disk_resource_policy_attachment", importId: importFromId, provider });
      }
