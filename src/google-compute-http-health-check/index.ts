...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_compute_http_health_check
...
export class GoogleComputeHttpHealthCheck extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeHttpHealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_compute_http_health_check#import import section} in the documentation of this resource for the id to use
