...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_firebase_hosting_channel
...
export class GoogleFirebaseHostingChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleFirebaseHostingChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_firebase_hosting_channel#import import section} in the documentation of this resource for the id to use
