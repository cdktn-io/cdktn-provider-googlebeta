...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_compute_ha_vpn_gateway
...
export class DataGoogleComputeHaVpnGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeHaVpnGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_compute_ha_vpn_gateway#import import section} in the documentation of this resource for the id to use
