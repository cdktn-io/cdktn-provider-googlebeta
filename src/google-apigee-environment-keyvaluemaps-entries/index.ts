...
export interface GoogleApigeeEnvironmentKeyvaluemapsEntriesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleApigeeEnvironmentKeyvaluemapsEntriesTimeoutsToTerraform(struct?: GoogleApigeeEnvironmentKeyvaluemapsEntriesTimeouts | cdktf.IResolvable): any {
...
export function googleApigeeEnvironmentKeyvaluemapsEntriesTimeoutsToHclTerraform(struct?: GoogleApigeeEnvironmentKeyvaluemapsEntriesTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApigeeEnvironmentKeyvaluemapsEntriesTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApigeeEnvironmentKeyvaluemapsEntriesTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleApigeeEnvironmentKeyvaluemapsEntriesTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleApigeeEnvironmentKeyvaluemapsEntries extends cdktf.TerraformResource {
