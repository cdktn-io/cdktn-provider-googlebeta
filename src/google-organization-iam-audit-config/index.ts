...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_organization_iam_audit_config
...
export function googleOrganizationIamAuditConfigAuditLogConfigToHclTerraform(struct?: GoogleOrganizationIamAuditConfigAuditLogConfig | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleOrganizationIamAuditConfigAuditLogConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleOrganizationIamAuditConfigAuditLogConfig | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleOrganizationIamAuditConfigAuditLogConfig | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleOrganizationIamAuditConfigAuditLogConfigList extends cdktf.ComplexList {
  public internalValue? : GoogleOrganizationIamAuditConfigAuditLogConfig[] | cdktf.IResolvable
...
export class GoogleOrganizationIamAuditConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleOrganizationIamAuditConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_organization_iam_audit_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_organization_iam_audit_config google_organization_iam_audit_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putAuditLogConfig(value: GoogleOrganizationIamAuditConfigAuditLogConfig[] | cdktf.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      audit_log_config: {
        value: cdktf.listMapperHcl(googleOrganizationIamAuditConfigAuditLogConfigToHclTerraform, true)(this._auditLogConfig.internalValue),
        isBlock: true,
        type: "set",
