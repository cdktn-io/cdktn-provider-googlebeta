...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_colab_runtime_template_iam_member
...
export interface GoogleColabRuntimeTemplateIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleColabRuntimeTemplateIamMemberConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleColabRuntimeTemplateIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleColabRuntimeTemplateIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_colab_runtime_template_iam_member#import import section} in the documentation of this resource for the id to use
