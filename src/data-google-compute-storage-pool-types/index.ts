...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_compute_storage_pool_types
...
export class DataGoogleComputeStoragePoolTypesDeprecatedOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeStoragePoolTypesDeprecatedList extends cdktn.ComplexList {
...
export class DataGoogleComputeStoragePoolTypes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeStoragePoolTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_compute_storage_pool_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_compute_storage_pool_types", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_compute_storage_pool_types google_compute_storage_pool_types} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      storage_pool_type: cdktn.stringToTerraform(this._storagePoolType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      storage_pool_type: {
        value: cdktn.stringToHclTerraform(this._storagePoolType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
