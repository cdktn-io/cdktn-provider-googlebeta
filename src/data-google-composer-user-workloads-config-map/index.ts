...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/data-sources/google_composer_user_workloads_config_map
...
export class DataGoogleComposerUserWorkloadsConfigMap extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComposerUserWorkloadsConfigMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/data-sources/google_composer_user_workloads_config_map#import import section} in the documentation of this resource for the id to use
