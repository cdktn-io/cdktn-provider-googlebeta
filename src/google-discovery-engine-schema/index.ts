...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_discovery_engine_schema
...
export interface GoogleDiscoveryEngineSchemaConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleDiscoveryEngineSchemaTimeoutsToTerraform(struct?: GoogleDiscoveryEngineSchemaTimeouts | cdktf.IResolvable): any {
...
export function googleDiscoveryEngineSchemaTimeoutsToHclTerraform(struct?: GoogleDiscoveryEngineSchemaTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleDiscoveryEngineSchemaTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDiscoveryEngineSchemaTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleDiscoveryEngineSchemaTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleDiscoveryEngineSchema extends cdktf.TerraformResource {
