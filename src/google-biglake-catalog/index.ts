...
export function googleBiglakeCatalogTimeoutsToTerraform(struct?: GoogleBiglakeCatalogTimeouts | cdktf.IResolvable): any {
...
export function googleBiglakeCatalogTimeoutsToHclTerraform(struct?: GoogleBiglakeCatalogTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBiglakeCatalogTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBiglakeCatalogTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleBiglakeCatalogTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
