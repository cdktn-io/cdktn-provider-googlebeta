...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_exadb_vm_cluster
...
export interface GoogleOracleDatabaseExadbVmClusterIdentityConnector {
}

export function googleOracleDatabaseExadbVmClusterIdentityConnectorToTerraform(struct?: GoogleOracleDatabaseExadbVmClusterIdentityConnector): any {
...
export function googleOracleDatabaseExadbVmClusterIdentityConnectorToHclTerraform(struct?: GoogleOracleDatabaseExadbVmClusterIdentityConnector): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleOracleDatabaseExadbVmClusterIdentityConnectorOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleOracleDatabaseExadbVmClusterIdentityConnector | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleOracleDatabaseExadbVmClusterIdentityConnector | undefined) {
    if (value === undefined) {
...
export class GoogleOracleDatabaseExadbVmClusterIdentityConnectorList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleOracleDatabaseExadbVmClusterIdentityConnectorOutputReference {
    return new GoogleOracleDatabaseExadbVmClusterIdentityConnectorOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleOracleDatabaseExadbVmCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleOracleDatabaseExadbVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_exadb_vm_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_exadb_vm_cluster google_oracle_database_exadb_vm_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _identityConnector = new GoogleOracleDatabaseExadbVmClusterIdentityConnectorList(this, "identity_connector", false);
