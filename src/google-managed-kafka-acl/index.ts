...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/resources/google_managed_kafka_acl
...
export class GoogleManagedKafkaAcl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleManagedKafkaAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/resources/google_managed_kafka_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/resources/google_managed_kafka_acl google_managed_kafka_acl} Resource
  *
  * @param scope The scope in which to define this construct
