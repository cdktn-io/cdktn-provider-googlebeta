...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_managed_kafka_acl
...
export interface GoogleManagedKafkaAclAclEntries {
  /**
...
export class GoogleManagedKafkaAclAclEntriesList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleManagedKafkaAclAclEntriesOutputReference {
    return new GoogleManagedKafkaAclAclEntriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleManagedKafkaAcl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleManagedKafkaAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_managed_kafka_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_managed_kafka_acl google_managed_kafka_acl} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleManagedKafkaAclConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleManagedKafkaAclConfig) {
    super(scope, id, {
  ...
  private _aclEntries = new GoogleManagedKafkaAclAclEntriesList(this, "acl_entries", true);
  ...
  private _timeouts = new GoogleManagedKafkaAclTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleManagedKafkaAclTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleManagedKafkaAclTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleManagedKafkaAclTimeouts",
      },
    };
