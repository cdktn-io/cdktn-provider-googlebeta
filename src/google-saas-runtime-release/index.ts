...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_saas_runtime_release
...
export class GoogleSaasRuntimeRelease extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSaasRuntimeRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_saas_runtime_release#import import section} in the documentation of this resource for the id to use
