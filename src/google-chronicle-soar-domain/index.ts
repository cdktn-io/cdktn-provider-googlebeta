...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_soar_domain
...
export interface GoogleChronicleSoarDomainConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleChronicleSoarDomainTimeouts;
}
export interface GoogleChronicleSoarDomainTimeouts {
  /**
...
export function googleChronicleSoarDomainTimeoutsToTerraform(struct?: GoogleChronicleSoarDomainTimeouts | cdktn.IResolvable): any {
...
export function googleChronicleSoarDomainTimeoutsToHclTerraform(struct?: GoogleChronicleSoarDomainTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleChronicleSoarDomainTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleChronicleSoarDomainTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleChronicleSoarDomainTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleChronicleSoarDomain extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_chronicle_soar_domain";
  ...
  * @param importToId The construct id used in the generated config for the GoogleChronicleSoarDomain to import
  * @param importFromId The id of the existing GoogleChronicleSoarDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_soar_domain#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleChronicleSoarDomain to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_chronicle_soar_domain", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_soar_domain google_chronicle_soar_domain} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleChronicleSoarDomainConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleChronicleSoarDomainConfig) {
    super(scope, id, {
      terraformResourceType: 'google_chronicle_soar_domain',
  ...
  // soar_domain_id - computed: true, optional: false, required: false
  public get soarDomainId() {
    return this.getStringAttribute('soar_domain_id');
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts = new GoogleChronicleSoarDomainTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleChronicleSoarDomainTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleChronicleSoarDomainTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleChronicleSoarDomainTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleChronicleSoarDomainTimeouts",
      },
    };
