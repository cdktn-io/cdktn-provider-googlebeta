...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_data_catalog_policy_tag
...
export class GoogleDataCatalogPolicyTag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataCatalogPolicyTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_data_catalog_policy_tag#import import section} in the documentation of this resource for the id to use
