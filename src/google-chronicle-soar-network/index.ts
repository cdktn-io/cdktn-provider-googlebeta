...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_chronicle_soar_network
...
export class GoogleChronicleSoarNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleChronicleSoarNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_chronicle_soar_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_chronicle_soar_network google_chronicle_soar_network} Resource
  *
  * @param scope The scope in which to define this construct
