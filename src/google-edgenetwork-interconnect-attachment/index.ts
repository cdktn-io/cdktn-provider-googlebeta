...
export interface GoogleEdgenetworkInterconnectAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleEdgenetworkInterconnectAttachmentTimeoutsToTerraform(struct?: GoogleEdgenetworkInterconnectAttachmentTimeouts | cdktf.IResolvable): any {
...
export function googleEdgenetworkInterconnectAttachmentTimeoutsToHclTerraform(struct?: GoogleEdgenetworkInterconnectAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleEdgenetworkInterconnectAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleEdgenetworkInterconnectAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleEdgenetworkInterconnectAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleEdgenetworkInterconnectAttachment extends cdktf.TerraformResource {
