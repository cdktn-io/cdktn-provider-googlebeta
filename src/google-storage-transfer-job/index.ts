...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job
...
export interface GoogleStorageTransferJobConfig extends cdktn.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#deletion_policy GoogleStorageTransferJob#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * Unique description to identify the Transfer Job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#description GoogleStorageTransferJob#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#id GoogleStorageTransferJob#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#name GoogleStorageTransferJob#name}
  */
  readonly name?: string;
  /**
  * The project in which the resource belongs. If it is not provided, the provider project is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#project GoogleStorageTransferJob#project}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#service_account GoogleStorageTransferJob#service_account}
  */
  readonly serviceAccount?: string;
  /**
  * Status of the job. Default: ENABLED. NOTE: The effect of the new job status takes place during a subsequent job run. For example, if you change the job status from ENABLED to DISABLED, and an operation spawned by the transfer is running, the status change would not affect the current operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#status GoogleStorageTransferJob#status}
  */
  readonly status?: string;
  /**
  * event_stream block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#event_stream GoogleStorageTransferJob#event_stream}
  */
  readonly eventStream?: GoogleStorageTransferJobEventStream;
  /**
  * logging_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#logging_config GoogleStorageTransferJob#logging_config}
  */
  readonly loggingConfig?: GoogleStorageTransferJobLoggingConfig;
  /**
  * notification_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#notification_config GoogleStorageTransferJob#notification_config}
  */
  readonly notificationConfig?: GoogleStorageTransferJobNotificationConfig;
  /**
  * replication_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#replication_spec GoogleStorageTransferJob#replication_spec}
  */
  readonly replicationSpec?: GoogleStorageTransferJobReplicationSpec;
  /**
  * schedule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#schedule GoogleStorageTransferJob#schedule}
  */
  readonly schedule?: GoogleStorageTransferJobSchedule;
  /**
  * transfer_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#transfer_spec GoogleStorageTransferJob#transfer_spec}
  */
...
export interface GoogleStorageTransferJobEventStream {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#event_stream_expiration_time GoogleStorageTransferJob#event_stream_expiration_time}
  */
  readonly eventStreamExpirationTime?: string;
  /**
  * Specifies the date and time that Storage Transfer Service starts listening for events from this stream. If no start time is specified or start time is in the past, Storage Transfer Service starts listening immediately
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#event_stream_start_time GoogleStorageTransferJob#event_stream_start_time}
  */
...
export interface GoogleStorageTransferJobLoggingConfig {
  /**
  * For transfers with a PosixFilesystem source, this option enables the Cloud Storage transfer logs for this transfer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#enable_on_prem_gcs_transfer_logs GoogleStorageTransferJob#enable_on_prem_gcs_transfer_logs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#log_action_states GoogleStorageTransferJob#log_action_states}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#log_actions GoogleStorageTransferJob#log_actions}
  */
...
export class GoogleStorageTransferJobLoggingConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobLoggingConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleStorageTransferJobLoggingConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleStorageTransferJobNotificationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#event_types GoogleStorageTransferJob#event_types}
  */
  readonly eventTypes?: string[];
  /**
  * The desired format of the notification message payloads. One of "NONE" or "JSON".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#payload_format GoogleStorageTransferJob#payload_format}
  */
  readonly payloadFormat: string;
  /**
  * The Topic.name of the Pub/Sub topic to which to publish notifications.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#pubsub_topic GoogleStorageTransferJob#pubsub_topic}
  */
...
export interface GoogleStorageTransferJobReplicationSpecGcsDataSink {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#bucket_name GoogleStorageTransferJob#bucket_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#path GoogleStorageTransferJob#path}
  */
...
export interface GoogleStorageTransferJobReplicationSpecObjectConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#exclude_prefixes GoogleStorageTransferJob#exclude_prefixes}
  */
  readonly excludePrefixes?: string[];
  /**
  * If include_refixes is specified, objects that satisfy the object conditions must have names that start with one of the include_prefixes and that do not start with any of the exclude_prefixes. If include_prefixes is not specified, all objects except those that have names starting with one of the exclude_prefixes must satisfy the object conditions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#include_prefixes GoogleStorageTransferJob#include_prefixes}
  */
  readonly includePrefixes?: string[];
  /**
  * If specified, only objects with a "last modification time" before this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#last_modified_before GoogleStorageTransferJob#last_modified_before}
  */
  readonly lastModifiedBefore?: string;
  /**
  * If specified, only objects with a "last modification time" on or after this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#last_modified_since GoogleStorageTransferJob#last_modified_since}
  */
  readonly lastModifiedSince?: string;
  /**
  * A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#max_time_elapsed_since_last_modification GoogleStorageTransferJob#max_time_elapsed_since_last_modification}
  */
  readonly maxTimeElapsedSinceLastModification?: string;
  /**
  * A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#min_time_elapsed_since_last_modification GoogleStorageTransferJob#min_time_elapsed_since_last_modification}
  */
...
export interface GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptions {
  /**
  * Specifies how each object's ACLs should be preserved for transfers between Google Cloud Storage buckets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#acl GoogleStorageTransferJob#acl}
  */
  readonly acl?: string;
  /**
  * Specifies how each file's POSIX group ID (GID) attribute should be handled by the transfer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#gid GoogleStorageTransferJob#gid}
  */
  readonly gid?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#kms_key GoogleStorageTransferJob#kms_key}
  */
  readonly kmsKey?: string;
  /**
  * Specifies how each file's mode attribute should be handled by the transfer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#mode GoogleStorageTransferJob#mode}
  */
  readonly mode?: string;
  /**
  * Specifies the storage class to set on objects being transferred to Google Cloud Storage buckets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#storage_class GoogleStorageTransferJob#storage_class}
  */
  readonly storageClass?: string;
  /**
  * Specifies how symlinks should be handled by the transfer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#symlink GoogleStorageTransferJob#symlink}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#temporary_hold GoogleStorageTransferJob#temporary_hold}
  */
  readonly temporaryHold?: string;
  /**
  * Specifies how each object's timeCreated metadata is preserved for transfers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#time_created GoogleStorageTransferJob#time_created}
  */
  readonly timeCreated?: string;
  /**
  * Specifies how each file's POSIX user ID (UID) attribute should be handled by the transfer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#uid GoogleStorageTransferJob#uid}
  */
  readonly uid?: string;
}
...
export class GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._acl = undefined;
      this._gid = undefined;
...
export interface GoogleStorageTransferJobReplicationSpecTransferOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#delete_objects_from_source_after_transfer GoogleStorageTransferJob#delete_objects_from_source_after_transfer}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#delete_objects_unique_in_sink GoogleStorageTransferJob#delete_objects_unique_in_sink}
  */
  readonly deleteObjectsUniqueInSink?: boolean | cdktn.IResolvable;
  /**
  * Whether overwriting objects that already exist in the sink is allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#overwrite_objects_already_existing_in_sink GoogleStorageTransferJob#overwrite_objects_already_existing_in_sink}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#overwrite_when GoogleStorageTransferJob#overwrite_when}
  */
  readonly overwriteWhen?: string;
  /**
  * metadata_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#metadata_options GoogleStorageTransferJob#metadata_options}
  */
  readonly metadataOptions?: GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptions;
}
...
export function googleStorageTransferJobReplicationSpecTransferOptionsToHclTerraform(struct?: GoogleStorageTransferJobReplicationSpecTransferOptionsOutputReference | GoogleStorageTransferJobReplicationSpecTransferOptions): any {
  ...
  const attrs = {
    ...
    metadata_options: {
      value: googleStorageTransferJobReplicationSpecTransferOptionsMetadataOptionsToHclTerraform(struct!.metadataOptions),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptionsList",
    },
  };
...
export class GoogleStorageTransferJobReplicationSpecTransferOptionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _metadataOptions = new GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptionsOutputReference(this, "metadata_options");
  public get metadataOptions() {
    return this._metadataOptions;
  }
  public putMetadataOptions(value: GoogleStorageTransferJobReplicationSpecTransferOptionsMetadataOptions) {
...
export interface GoogleStorageTransferJobReplicationSpec {
  ...
  * gcs_data_sink block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#gcs_data_sink GoogleStorageTransferJob#gcs_data_sink}
  */
  readonly gcsDataSink?: GoogleStorageTransferJobReplicationSpecGcsDataSink;
  /**
  * gcs_data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#gcs_data_source GoogleStorageTransferJob#gcs_data_source}
  */
  readonly gcsDataSource?: GoogleStorageTransferJobReplicationSpecGcsDataSource;
  /**
  * object_conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#object_conditions GoogleStorageTransferJob#object_conditions}
  */
  readonly objectConditions?: GoogleStorageTransferJobReplicationSpecObjectConditions;
  /**
  * transfer_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#transfer_options GoogleStorageTransferJob#transfer_options}
  */
...
export interface GoogleStorageTransferJobScheduleScheduleEndDate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#day GoogleStorageTransferJob#day}
  */
  readonly day: number;
  /**
  * Month of year. Must be from 1 to 12.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#month GoogleStorageTransferJob#month}
  */
  readonly month: number;
  /**
  * Year of date. Must be from 1 to 9999.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#year GoogleStorageTransferJob#year}
  */
...
export interface GoogleStorageTransferJobScheduleStartTimeOfDay {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#hours GoogleStorageTransferJob#hours}
  */
  readonly hours: number;
  /**
  * Minutes of hour of day. Must be from 0 to 59.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#minutes GoogleStorageTransferJob#minutes}
  */
  readonly minutes: number;
  /**
  * Fractions of seconds in nanoseconds. Must be from 0 to 999,999,999.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#nanos GoogleStorageTransferJob#nanos}
  */
  readonly nanos: number;
  /**
  * Seconds of minutes of the time. Must normally be from 0 to 59.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#seconds GoogleStorageTransferJob#seconds}
  */
...
export interface GoogleStorageTransferJobSchedule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#repeat_interval GoogleStorageTransferJob#repeat_interval}
  */
  readonly repeatInterval?: string;
  /**
  * schedule_end_date block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#schedule_end_date GoogleStorageTransferJob#schedule_end_date}
  */
  readonly scheduleEndDate?: GoogleStorageTransferJobScheduleScheduleEndDate;
  /**
  * schedule_start_date block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#schedule_start_date GoogleStorageTransferJob#schedule_start_date}
  */
  readonly scheduleStartDate: GoogleStorageTransferJobScheduleScheduleStartDate;
  /**
  * start_time_of_day block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#start_time_of_day GoogleStorageTransferJob#start_time_of_day}
  */
...
export interface GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#auth_method GoogleStorageTransferJob#auth_method}
  */
  readonly authMethod?: string;
  /**
  * The Listing API to use for discovering objects. When not specified, Transfer Service will attempt to determine the right API to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#list_api GoogleStorageTransferJob#list_api}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#protocol GoogleStorageTransferJob#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#request_model GoogleStorageTransferJob#request_model}
  */
  readonly requestModel?: string;
}

export function googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataToTerraform(struct?: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataOutputReference | GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    list_api: cdktn.stringToTerraform(struct!.listApi),
    protocol: cdktn.stringToTerraform(struct!.protocol),
    request_model: cdktn.stringToTerraform(struct!.requestModel),
  }
}


export function googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataToHclTerraform(struct?: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataOutputReference | GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    list_api: {
      value: cdktn.stringToHclTerraform(struct!.listApi),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    request_model: {
      value: cdktn.stringToHclTerraform(struct!.requestModel),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    ...
    if (this._listApi !== undefined) {
      hasAnyValues = true;
      internalValueResult.listApi = this._listApi;
    }
    if (this._protocol !== undefined) {
      hasAnyValues = true;
      internalValueResult.protocol = this._protocol;
    }
    if (this._requestModel !== undefined) {
      hasAnyValues = true;
      internalValueResult.requestModel = this._requestModel;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._authMethod = undefined;
      this._listApi = undefined;
      this._protocol = undefined;
      this._requestModel = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._authMethod = value.authMethod;
      this._listApi = value.listApi;
      this._protocol = value.protocol;
      this._requestModel = value.requestModel;
    }
  }
  ...
  // list_api - computed: false, optional: true, required: false
  private _listApi?: string; 
  public get listApi() {
    return this.getStringAttribute('list_api');
  }
  public set listApi(value: string) {
    this._listApi = value;
  }
  public resetListApi() {
    this._listApi = undefined;
  ...
  // request_model - computed: false, optional: true, required: false
  private _requestModel?: string; 
  public get requestModel() {
    return this.getStringAttribute('request_model');
  }
  public set requestModel(value: string) {
    this._requestModel = value;
  }
  public resetRequestModel() {
    this._requestModel = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get requestModelInput() {
    return this._requestModel;
  }
}
export interface GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource {
  /**
  * Name of the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#bucket_name GoogleStorageTransferJob#bucket_name}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#endpoint GoogleStorageTransferJob#endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#region GoogleStorageTransferJob#region}
  */
  readonly region?: string;
  /**
  * s3_metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#s3_metadata GoogleStorageTransferJob#s3_metadata}
  */
  readonly s3Metadata?: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata;
}

export function googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceToTerraform(struct?: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceOutputReference | GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    s3_metadata: googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataToTerraform(struct!.s3Metadata),
  }
}


export function googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceToHclTerraform(struct?: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceOutputReference | GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    s3_metadata: {
      value: googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataToHclTerraform(struct!.s3Metadata),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataList",
    },
  };
...
export class GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._bucketName !== undefined) {
      hasAnyValues = true;
    ...
    if (this._s3Metadata?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.s3Metadata = this._s3Metadata?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._bucketName = undefined;
      ...
      this._s3Metadata.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._bucketName = value.bucketName;
      ...
      this._s3Metadata.internalValue = value.s3Metadata;
    }
  }
  ...
  // s3_metadata - computed: false, optional: true, required: false
  private _s3Metadata = new GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3MetadataOutputReference(this, "s3_metadata");
  public get s3Metadata() {
    return this._s3Metadata;
  }
  public putS3Metadata(value: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceS3Metadata) {
    this._s3Metadata.internalValue = value;
  }
  public resetS3Metadata() {
    this._s3Metadata.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get s3MetadataInput() {
    return this._s3Metadata.internalValue;
  }
}
export interface GoogleStorageTransferJobTransferSpecAwsS3DataSourceAwsAccessKey {
  ...
  * AWS Key ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#access_key_id GoogleStorageTransferJob#access_key_id}
  */
  readonly accessKeyId: string;
  /**
  * AWS Secret Access Key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#secret_access_key GoogleStorageTransferJob#secret_access_key}
  */
...
export interface GoogleStorageTransferJobTransferSpecAwsS3DataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#cloudfront_domain GoogleStorageTransferJob#cloudfront_domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#credentials_secret GoogleStorageTransferJob#credentials_secret}
  */
  readonly credentialsSecret?: string;
  /**
  * Egress bytes over a Google-managed private network. This network is shared between other users of Storage Transfer Service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#managed_private_network GoogleStorageTransferJob#managed_private_network}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#role_arn GoogleStorageTransferJob#role_arn}
  */
  readonly roleArn?: string;
  /**
  * aws_access_key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#aws_access_key GoogleStorageTransferJob#aws_access_key}
  */
...
export class GoogleStorageTransferJobTransferSpecAwsS3DataSourceOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // cloudfront_domain - computed: false, optional: true, required: false
...
export interface GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceAzureCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#sas_token GoogleStorageTransferJob#sas_token}
  */
...
export interface GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig {
  /**
  * The client (application) ID of the application with federated credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#client_id GoogleStorageTransferJob#client_id}
  */
  readonly clientId: string;
  /**
  * The tenant (directory) ID of the application with federated credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#tenant_id GoogleStorageTransferJob#tenant_id}
  */
...
export class GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#container GoogleStorageTransferJob#container}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#private_network_service GoogleStorageTransferJob#private_network_service}
  */
  readonly privateNetworkService?: string;
  /**
  * The name of the Azure Storage account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#storage_account GoogleStorageTransferJob#storage_account}
  */
  readonly storageAccount: string;
  /**
  * azure_credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#azure_credentials GoogleStorageTransferJob#azure_credentials}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#federated_identity_config GoogleStorageTransferJob#federated_identity_config}
  */
  readonly federatedIdentityConfig?: GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig;
}
...
export function googleStorageTransferJobTransferSpecAzureBlobStorageDataSourceToTerraform(struct?: GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceOutputReference | GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSource): any {
  ...
  return {
    ...
    credentials_secret: cdktn.stringToTerraform(struct!.credentialsSecret),
    path: cdktn.stringToTerraform(struct!.path),
    private_network_service: cdktn.stringToTerraform(struct!.privateNetworkService),
...
export function googleStorageTransferJobTransferSpecAzureBlobStorageDataSourceToHclTerraform(struct?: GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceOutputReference | GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSource): any {
  ...
  const attrs = {
    ...
    private_network_service: {
      value: cdktn.stringToHclTerraform(struct!.privateNetworkService),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    federated_identity_config: {
      value: googleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfigToHclTerraform(struct!.federatedIdentityConfig),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfigList",
    },
  };
...
export class GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSource | undefined {
    ...
    if (this._privateNetworkService !== undefined) {
      hasAnyValues = true;
      internalValueResult.privateNetworkService = this._privateNetworkService;
    }
    ...
    if (this._federatedIdentityConfig?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.federatedIdentityConfig = this._federatedIdentityConfig?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  public set internalValue(value: GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSource | undefined) {
    if (value === undefined) {
      ...
      this._credentialsSecret = undefined;
      this._path = undefined;
      this._privateNetworkService = undefined;
      this._storageAccount = undefined;
      this._azureCredentials.internalValue = undefined;
      this._federatedIdentityConfig.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      ...
      this._credentialsSecret = value.credentialsSecret;
      this._path = value.path;
      this._privateNetworkService = value.privateNetworkService;
      this._storageAccount = value.storageAccount;
      this._azureCredentials.internalValue = value.azureCredentials;
      this._federatedIdentityConfig.internalValue = value.federatedIdentityConfig;
    }
  }
  ...
  // private_network_service - computed: false, optional: true, required: false
  private _privateNetworkService?: string; 
  public get privateNetworkService() {
    return this.getStringAttribute('private_network_service');
  }
  public set privateNetworkService(value: string) {
    this._privateNetworkService = value;
  }
  public resetPrivateNetworkService() {
    this._privateNetworkService = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get privateNetworkServiceInput() {
    return this._privateNetworkService;
  }
  ...
  // federated_identity_config - computed: false, optional: true, required: false
  private _federatedIdentityConfig = new GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfigOutputReference(this, "federated_identity_config");
  public get federatedIdentityConfig() {
    return this._federatedIdentityConfig;
  }
  public putFederatedIdentityConfig(value: GoogleStorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig) {
    this._federatedIdentityConfig.internalValue = value;
  }
  public resetFederatedIdentityConfig() {
    this._federatedIdentityConfig.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get federatedIdentityConfigInput() {
    return this._federatedIdentityConfig.internalValue;
  }
}
...
export interface GoogleStorageTransferJobTransferSpecHttpDataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#list_url GoogleStorageTransferJob#list_url}
  */
...
export interface GoogleStorageTransferJobTransferSpecPosixDataSink {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#root_directory GoogleStorageTransferJob#root_directory}
  */
...
export interface GoogleStorageTransferJobTransferSpecTransferManifest {
  /**
  * Cloud Storage path to the manifest CSV.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#location GoogleStorageTransferJob#location}
  */
  readonly location: string;
}

export function googleStorageTransferJobTransferSpecTransferManifestToTerraform(struct?: GoogleStorageTransferJobTransferSpecTransferManifestOutputReference | GoogleStorageTransferJobTransferSpecTransferManifest): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleStorageTransferJobTransferSpecTransferManifestToHclTerraform(struct?: GoogleStorageTransferJobTransferSpecTransferManifestOutputReference | GoogleStorageTransferJobTransferSpecTransferManifest): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleStorageTransferJobTransferSpecTransferManifestOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpecTransferManifest | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleStorageTransferJobTransferSpecTransferManifest | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptions {
  /**
  * Specifies how each object's ACLs should be preserved for transfers between Google Cloud Storage buckets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#acl GoogleStorageTransferJob#acl}
...
export class GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._acl !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._acl = undefined;
      this._gid = undefined;
...
export interface GoogleStorageTransferJobTransferSpecTransferOptions {
  ...
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#metadata_options GoogleStorageTransferJob#metadata_options}
  */
  readonly metadataOptions?: GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptions;
}
...
export function googleStorageTransferJobTransferSpecTransferOptionsToHclTerraform(struct?: GoogleStorageTransferJobTransferSpecTransferOptionsOutputReference | GoogleStorageTransferJobTransferSpecTransferOptions): any {
  ...
  const attrs = {
    ...
    metadata_options: {
      value: googleStorageTransferJobTransferSpecTransferOptionsMetadataOptionsToHclTerraform(struct!.metadataOptions),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptionsList",
    },
  };
...
export class GoogleStorageTransferJobTransferSpecTransferOptionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // metadata_options - computed: false, optional: true, required: false
  private _metadataOptions = new GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptionsOutputReference(this, "metadata_options");
  public get metadataOptions() {
    return this._metadataOptions;
  }
  public putMetadataOptions(value: GoogleStorageTransferJobTransferSpecTransferOptionsMetadataOptions) {
    this._metadataOptions.internalValue = value;
  }
  public resetMetadataOptions() {
    this._metadataOptions.internalValue = undefined;
...
export interface GoogleStorageTransferJobTransferSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#sink_agent_pool_name GoogleStorageTransferJob#sink_agent_pool_name}
  */
  readonly sinkAgentPoolName?: string;
  /**
  * Specifies the agent pool name associated with the posix data source. When unspecified, the default name is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#source_agent_pool_name GoogleStorageTransferJob#source_agent_pool_name}
  */
  readonly sourceAgentPoolName?: string;
  /**
  * aws_s3_compatible_data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#aws_s3_compatible_data_source GoogleStorageTransferJob#aws_s3_compatible_data_source}
  */
  readonly awsS3CompatibleDataSource?: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource;
  /**
  * aws_s3_data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#aws_s3_data_source GoogleStorageTransferJob#aws_s3_data_source}
  */
  readonly awsS3DataSource?: GoogleStorageTransferJobTransferSpecAwsS3DataSource;
  /**
  * azure_blob_storage_data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#azure_blob_storage_data_source GoogleStorageTransferJob#azure_blob_storage_data_source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#hdfs_data_source GoogleStorageTransferJob#hdfs_data_source}
  */
  readonly hdfsDataSource?: GoogleStorageTransferJobTransferSpecHdfsDataSource;
  /**
  * http_data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#http_data_source GoogleStorageTransferJob#http_data_source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#posix_data_sink GoogleStorageTransferJob#posix_data_sink}
  */
  readonly posixDataSink?: GoogleStorageTransferJobTransferSpecPosixDataSink;
  /**
  * posix_data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#posix_data_source GoogleStorageTransferJob#posix_data_source}
  */
  readonly posixDataSource?: GoogleStorageTransferJobTransferSpecPosixDataSource;
  /**
  * transfer_manifest block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#transfer_manifest GoogleStorageTransferJob#transfer_manifest}
  */
  readonly transferManifest?: GoogleStorageTransferJobTransferSpecTransferManifest;
  /**
  * transfer_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#transfer_options GoogleStorageTransferJob#transfer_options}
...
export function googleStorageTransferJobTransferSpecToTerraform(struct?: GoogleStorageTransferJobTransferSpecOutputReference | GoogleStorageTransferJobTransferSpec): any {
  ...
  return {
    ...
    aws_s3_compatible_data_source: googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceToTerraform(struct!.awsS3CompatibleDataSource),
    ...
    transfer_manifest: googleStorageTransferJobTransferSpecTransferManifestToTerraform(struct!.transferManifest),
...
export function googleStorageTransferJobTransferSpecToHclTerraform(struct?: GoogleStorageTransferJobTransferSpecOutputReference | GoogleStorageTransferJobTransferSpec): any {
  ...
  const attrs = {
    ...
    aws_s3_compatible_data_source: {
      value: googleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceToHclTerraform(struct!.awsS3CompatibleDataSource),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceList",
    },
    aws_s3_data_source: {
    ...
    transfer_manifest: {
      value: googleStorageTransferJobTransferSpecTransferManifestToHclTerraform(struct!.transferManifest),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleStorageTransferJobTransferSpecTransferManifestList",
    },
    transfer_options: {
...
export class GoogleStorageTransferJobTransferSpecOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageTransferJobTransferSpec | undefined {
    ...
    if (this._awsS3CompatibleDataSource?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.awsS3CompatibleDataSource = this._awsS3CompatibleDataSource?.internalValue;
    }
    ...
    if (this._transferManifest?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.transferManifest = this._transferManifest?.internalValue;
    }
    if (this._transferOptions?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.transferOptions = this._transferOptions?.internalValue;
  ...
  public set internalValue(value: GoogleStorageTransferJobTransferSpec | undefined) {
    if (value === undefined) {
      ...
      this._awsS3CompatibleDataSource.internalValue = undefined;
      ...
      this._transferManifest.internalValue = undefined;
      this._transferOptions.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      ...
      this._awsS3CompatibleDataSource.internalValue = value.awsS3CompatibleDataSource;
      ...
      this._transferManifest.internalValue = value.transferManifest;
      this._transferOptions.internalValue = value.transferOptions;
    }
  }
  ...
  // aws_s3_compatible_data_source - computed: false, optional: true, required: false
  private _awsS3CompatibleDataSource = new GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSourceOutputReference(this, "aws_s3_compatible_data_source");
  public get awsS3CompatibleDataSource() {
    return this._awsS3CompatibleDataSource;
  }
  public putAwsS3CompatibleDataSource(value: GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource) {
    this._awsS3CompatibleDataSource.internalValue = value;
  }
  public resetAwsS3CompatibleDataSource() {
    this._awsS3CompatibleDataSource.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get awsS3CompatibleDataSourceInput() {
    return this._awsS3CompatibleDataSource.internalValue;
  }
  ...
  // transfer_manifest - computed: false, optional: true, required: false
  private _transferManifest = new GoogleStorageTransferJobTransferSpecTransferManifestOutputReference(this, "transfer_manifest");
  public get transferManifest() {
    return this._transferManifest;
  }
  public putTransferManifest(value: GoogleStorageTransferJobTransferSpecTransferManifest) {
    this._transferManifest.internalValue = value;
  }
  public resetTransferManifest() {
    this._transferManifest.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get transferManifestInput() {
    return this._transferManifest.internalValue;
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job google_storage_transfer_job}
*/
export class GoogleStorageTransferJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleStorageTransferJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_storage_transfer_job google_storage_transfer_job} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _loggingConfig = new GoogleStorageTransferJobLoggingConfigOutputReference(this, "logging_config");
  public get loggingConfig() {
    return this._loggingConfig;
  }
  public putLoggingConfig(value: GoogleStorageTransferJobLoggingConfig) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      logging_config: {
        value: googleStorageTransferJobLoggingConfigToHclTerraform(this._loggingConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleStorageTransferJobLoggingConfigList",
      },
      notification_config: {
