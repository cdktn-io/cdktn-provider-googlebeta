...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_iap_web_forwarding_rule_service_iam_member
...
export class GoogleIapWebForwardingRuleServiceIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIapWebForwardingRuleServiceIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_iap_web_forwarding_rule_service_iam_member#import import section} in the documentation of this resource for the id to use
