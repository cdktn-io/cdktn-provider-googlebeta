...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_kms_project_kaj_policy_config
...
export class GoogleKmsProjectKajPolicyConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleKmsProjectKajPolicyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_kms_project_kaj_policy_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_kms_project_kaj_policy_config google_kms_project_kaj_policy_config} Resource
  *
  * @param scope The scope in which to define this construct
