...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_cloud_scheduler_job
...
export class GoogleCloudSchedulerJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudSchedulerJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_cloud_scheduler_job#import import section} in the documentation of this resource for the id to use
