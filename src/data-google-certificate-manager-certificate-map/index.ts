...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_certificate_manager_certificate_map
...
export interface DataGoogleCertificateManagerCertificateMapConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleCertificateManagerCertificateMapGclbTargetsIpConfigsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleCertificateManagerCertificateMapGclbTargetsIpConfigsList extends cdktn.ComplexList {
...
export class DataGoogleCertificateManagerCertificateMapGclbTargetsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleCertificateManagerCertificateMapGclbTargetsList extends cdktn.ComplexList {
...
*/
export class DataGoogleCertificateManagerCertificateMap extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCertificateManagerCertificateMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_certificate_manager_certificate_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_certificate_manager_certificate_map google_certificate_manager_certificate_map} Data Source
  *
  * @param scope The scope in which to define this construct
