...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_region_network_firewall_policy_with_rules
...
export function googleComputeRegionNetworkFirewallPolicyWithRulesRuleToTerraform(struct?: GoogleComputeRegionNetworkFirewallPolicyWithRulesRule | cdktn.IResolvable): any {
  ...
  return {
    ...
    target_forwarding_rules: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.targetForwardingRules),
...
export function googleComputeRegionNetworkFirewallPolicyWithRulesRuleToHclTerraform(struct?: GoogleComputeRegionNetworkFirewallPolicyWithRulesRule | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    target_forwarding_rules: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.targetForwardingRules),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionNetworkFirewallPolicyWithRulesRule | cdktn.IResolvable | undefined {
    ...
    if (this._targetForwardingRules !== undefined) {
      hasAnyValues = true;
      internalValueResult.targetForwardingRules = this._targetForwardingRules;
    }
  ...
  public set internalValue(value: GoogleComputeRegionNetworkFirewallPolicyWithRulesRule | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._targetForwardingRules = value.targetForwardingRules;
...
export class GoogleComputeRegionNetworkFirewallPolicyWithRules extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeRegionNetworkFirewallPolicyWithRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_region_network_firewall_policy_with_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_region_network_firewall_policy_with_rules google_compute_region_network_firewall_policy_with_rules} Resource
  *
  * @param scope The scope in which to define this construct
