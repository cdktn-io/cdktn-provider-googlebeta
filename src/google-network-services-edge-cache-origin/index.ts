...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_network_services_edge_cache_origin
...
export interface GoogleNetworkServicesEdgeCacheOriginConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly flexShielding?: GoogleNetworkServicesEdgeCacheOriginFlexShielding;
  /**
...
export interface GoogleNetworkServicesEdgeCacheOriginFlexShielding {
  /**
...
export class GoogleNetworkServicesEdgeCacheOriginFlexShieldingOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetworkServicesEdgeCacheOriginFlexShielding | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleNetworkServicesEdgeCacheOriginFlexShielding | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleNetworkServicesEdgeCacheOrigin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetworkServicesEdgeCacheOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_network_services_edge_cache_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_network_services_edge_cache_origin google_network_services_edge_cache_origin} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _flexShielding = new GoogleNetworkServicesEdgeCacheOriginFlexShieldingOutputReference(this, "flex_shielding");
  public get flexShielding() {
    return this._flexShielding;
  }
  public putFlexShielding(value: GoogleNetworkServicesEdgeCacheOriginFlexShielding) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      flex_shielding: {
        value: googleNetworkServicesEdgeCacheOriginFlexShieldingToHclTerraform(this._flexShielding.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleNetworkServicesEdgeCacheOriginFlexShieldingList",
      },
