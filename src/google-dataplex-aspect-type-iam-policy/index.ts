...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dataplex_aspect_type_iam_policy
...
export interface GoogleDataplexAspectTypeIamPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class GoogleDataplexAspectTypeIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleDataplexAspectTypeIamPolicy to import
  * @param importFromId The id of the existing GoogleDataplexAspectTypeIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dataplex_aspect_type_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_dataplex_aspect_type_iam_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dataplex_aspect_type_iam_policy google_dataplex_aspect_type_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleDataplexAspectTypeIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataplexAspectTypeIamPolicyConfig) {
    super(scope, id, {
