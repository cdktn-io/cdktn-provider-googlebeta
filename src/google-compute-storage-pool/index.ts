...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_compute_storage_pool
...
export interface GoogleComputeStoragePoolConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly params?: GoogleComputeStoragePoolParams;
  /**
  * timeouts block
  *
...
export class GoogleComputeStoragePoolResourceStatusOutputReference extends cdktn.ComplexObject {
...
export class GoogleComputeStoragePoolResourceStatusList extends cdktn.ComplexList {
...
export class GoogleComputeStoragePoolStatusOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleComputeStoragePoolStatusList extends cdktn.ComplexList {
...
export interface GoogleComputeStoragePoolParams {
  /**
...
export function googleComputeStoragePoolParamsToTerraform(struct?: GoogleComputeStoragePoolParamsOutputReference | GoogleComputeStoragePoolParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleComputeStoragePoolParamsToHclTerraform(struct?: GoogleComputeStoragePoolParamsOutputReference | GoogleComputeStoragePoolParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeStoragePoolParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeStoragePoolParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeStoragePoolParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function googleComputeStoragePoolTimeoutsToTerraform(struct?: GoogleComputeStoragePoolTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleComputeStoragePoolTimeoutsToHclTerraform(struct?: GoogleComputeStoragePoolTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeStoragePoolTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeStoragePoolTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeStoragePoolTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleComputeStoragePool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeStoragePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_compute_storage_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_compute_storage_pool google_compute_storage_pool} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new GoogleComputeStoragePoolParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: GoogleComputeStoragePoolParams) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      capacity_provisioning_type: cdktn.stringToTerraform(this._capacityProvisioningType),
      deletion_protection: cdktn.booleanToTerraform(this._deletionProtection),
      description: cdktn.stringToTerraform(this._description),
      labels: cdktn.hashMapper(cdktn.stringToTerraform)(this._labels),
      name: cdktn.stringToTerraform(this._name),
      performance_provisioning_type: cdktn.stringToTerraform(this._performanceProvisioningType),
      pool_provisioned_capacity_gb: cdktn.stringToTerraform(this._poolProvisionedCapacityGb),
      pool_provisioned_iops: cdktn.stringToTerraform(this._poolProvisionedIops),
      pool_provisioned_throughput: cdktn.stringToTerraform(this._poolProvisionedThroughput),
      project: cdktn.stringToTerraform(this._project),
      storage_pool_type: cdktn.stringToTerraform(this._storagePoolType),
      zone: cdktn.stringToTerraform(this._zone),
      params: googleComputeStoragePoolParamsToTerraform(this._params.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      capacity_provisioning_type: {
        value: cdktn.stringToHclTerraform(this._capacityProvisioningType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      performance_provisioning_type: {
        value: cdktn.stringToHclTerraform(this._performanceProvisioningType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      pool_provisioned_capacity_gb: {
        value: cdktn.stringToHclTerraform(this._poolProvisionedCapacityGb),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      pool_provisioned_iops: {
        value: cdktn.stringToHclTerraform(this._poolProvisionedIops),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      pool_provisioned_throughput: {
        value: cdktn.stringToHclTerraform(this._poolProvisionedThroughput),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      params: {
        value: googleComputeStoragePoolParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeStoragePoolParamsList",
      },
      timeouts: {
