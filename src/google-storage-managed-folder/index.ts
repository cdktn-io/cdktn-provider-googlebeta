...
export interface GoogleStorageManagedFolderConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleStorageManagedFolderTimeoutsToTerraform(struct?: GoogleStorageManagedFolderTimeouts | cdktf.IResolvable): any {
...
export function googleStorageManagedFolderTimeoutsToHclTerraform(struct?: GoogleStorageManagedFolderTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleStorageManagedFolderTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleStorageManagedFolderTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleStorageManagedFolderTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleStorageManagedFolder extends cdktf.TerraformResource {
