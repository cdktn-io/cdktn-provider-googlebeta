...
export interface GoogleBeyondcorpApplicationIamPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class GoogleBeyondcorpApplicationIamPolicy extends cdktn.TerraformResource {
