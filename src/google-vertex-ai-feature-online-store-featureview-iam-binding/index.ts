...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_vertex_ai_feature_online_store_featureview_iam_binding
...
export interface GoogleVertexAiFeatureOnlineStoreFeatureviewIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleVertexAiFeatureOnlineStoreFeatureviewIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleVertexAiFeatureOnlineStoreFeatureviewIamBinding extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_vertex_ai_feature_online_store_featureview_iam_binding", importId: importFromId, provider });
      }
