...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_beyondcorp_security_gateway
...
export class DataGoogleBeyondcorpSecurityGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBeyondcorpSecurityGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_beyondcorp_security_gateway#import import section} in the documentation of this resource for the id to use
