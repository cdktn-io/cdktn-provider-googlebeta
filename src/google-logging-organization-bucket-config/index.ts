...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_logging_organization_bucket_config
...
export interface GoogleLoggingOrganizationBucketConfigConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly cmekSettings?: GoogleLoggingOrganizationBucketConfigCmekSettings;
  /**
  * index_configs block
  *
...
export class GoogleLoggingOrganizationBucketConfigCmekSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleLoggingOrganizationBucketConfigCmekSettings | undefined {
  ...
  public set internalValue(value: GoogleLoggingOrganizationBucketConfigCmekSettings | undefined) {
    if (value === undefined) {
...
export interface GoogleLoggingOrganizationBucketConfigIndexConfigs {
  /**
...
export class GoogleLoggingOrganizationBucketConfigIndexConfigsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleLoggingOrganizationBucketConfigIndexConfigsOutputReference {
    return new GoogleLoggingOrganizationBucketConfigIndexConfigsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleLoggingOrganizationBucketConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleLoggingOrganizationBucketConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_logging_organization_bucket_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_logging_organization_bucket_config google_logging_organization_bucket_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _cmekSettings = new GoogleLoggingOrganizationBucketConfigCmekSettingsOutputReference(this, "cmek_settings");
  public get cmekSettings() {
    return this._cmekSettings;
  }
  public putCmekSettings(value: GoogleLoggingOrganizationBucketConfigCmekSettings) {
  ...
  private _indexConfigs = new GoogleLoggingOrganizationBucketConfigIndexConfigsList(this, "index_configs", true);
