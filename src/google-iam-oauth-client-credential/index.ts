...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_iam_oauth_client_credential
...
export class GoogleIamOauthClientCredential extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIamOauthClientCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_iam_oauth_client_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_iam_oauth_client_credential google_iam_oauth_client_credential} Resource
  *
  * @param scope The scope in which to define this construct
