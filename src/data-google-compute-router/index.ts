...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router
...
export interface DataGoogleComputeRouterConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router#id DataGoogleComputeRouter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router#name DataGoogleComputeRouter#name}
  */
  readonly name: string;
  /**
  * A reference to the network to which this router belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router#network DataGoogleComputeRouter#network}
  */
  readonly network: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router#project DataGoogleComputeRouter#project}
  */
  readonly project?: string;
  /**
  * Region where the router resides.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router#region DataGoogleComputeRouter#region}
  */
...
export class DataGoogleComputeRouterBgpAdvertisedIpRangesOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeRouterBgpAdvertisedIpRangesList extends cdktn.ComplexList {
...
export class DataGoogleComputeRouterBgpOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _advertisedIpRanges = new DataGoogleComputeRouterBgpAdvertisedIpRangesList(this, "advertised_ip_ranges", true);
...
export class DataGoogleComputeRouterBgpList extends cdktn.ComplexList {
...
export class DataGoogleComputeRouterMd5AuthenticationKeysOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeRouterMd5AuthenticationKeysList extends cdktn.ComplexList {
...
export interface DataGoogleComputeRouterParams {
}

export function dataGoogleComputeRouterParamsToTerraform(struct?: DataGoogleComputeRouterParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataGoogleComputeRouterParamsToHclTerraform(struct?: DataGoogleComputeRouterParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGoogleComputeRouterParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleComputeRouterParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleComputeRouterParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleComputeRouterParamsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleComputeRouterParamsOutputReference {
    return new DataGoogleComputeRouterParamsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router google_compute_router}
*/
export class DataGoogleComputeRouter extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataGoogleComputeRouter resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataGoogleComputeRouter to import
  * @param importFromId The id of the existing DataGoogleComputeRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_compute_router google_compute_router} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // ncc_gateway - computed: true, optional: false, required: false
  ...
  private _params = new DataGoogleComputeRouterParamsList(this, "params", false);
  public get params() {
    return this._params;
  }
