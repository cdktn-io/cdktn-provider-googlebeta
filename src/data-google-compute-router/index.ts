...
export class DataGoogleComputeRouterParamsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeRouterParamsList extends cdktf.ComplexList {
