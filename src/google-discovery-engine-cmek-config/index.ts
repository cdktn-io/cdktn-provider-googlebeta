...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_discovery_engine_cmek_config
...
export class GoogleDiscoveryEngineCmekConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDiscoveryEngineCmekConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_discovery_engine_cmek_config#import import section} in the documentation of this resource for the id to use
