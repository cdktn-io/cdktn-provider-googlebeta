...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_biglake_iceberg_table
...
export interface GoogleBiglakeIcebergTableConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly sortOrder?: GoogleBiglakeIcebergTableSortOrder;
  /**
  * timeouts block
  *
...
export interface GoogleBiglakeIcebergTableSortOrderFields {
  /**
...
export function googleBiglakeIcebergTableSortOrderFieldsToTerraform(struct?: GoogleBiglakeIcebergTableSortOrderFields | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleBiglakeIcebergTableSortOrderFieldsToHclTerraform(struct?: GoogleBiglakeIcebergTableSortOrderFields | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleBiglakeIcebergTableSortOrderFieldsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleBiglakeIcebergTableSortOrderFields | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleBiglakeIcebergTableSortOrderFields | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class GoogleBiglakeIcebergTableSortOrderFieldsList extends cdktn.ComplexList {
  public internalValue? : GoogleBiglakeIcebergTableSortOrderFields[] | cdktn.IResolvable
  ...
  */
  public get(index: number): GoogleBiglakeIcebergTableSortOrderFieldsOutputReference {
    return new GoogleBiglakeIcebergTableSortOrderFieldsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleBiglakeIcebergTableSortOrder {
  /**
  * fields block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_biglake_iceberg_table#fields GoogleBiglakeIcebergTable#fields}
  */
  readonly fields: GoogleBiglakeIcebergTableSortOrderFields[] | cdktn.IResolvable;
}

export function googleBiglakeIcebergTableSortOrderToTerraform(struct?: GoogleBiglakeIcebergTableSortOrderOutputReference | GoogleBiglakeIcebergTableSortOrder): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    fields: cdktn.listMapper(googleBiglakeIcebergTableSortOrderFieldsToTerraform, true)(struct!.fields),
  }
}


export function googleBiglakeIcebergTableSortOrderToHclTerraform(struct?: GoogleBiglakeIcebergTableSortOrderOutputReference | GoogleBiglakeIcebergTableSortOrder): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    fields: {
      value: cdktn.listMapperHcl(googleBiglakeIcebergTableSortOrderFieldsToHclTerraform, true)(struct!.fields),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleBiglakeIcebergTableSortOrderFieldsList",
    },
  };
...
export class GoogleBiglakeIcebergTableSortOrderOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleBiglakeIcebergTableSortOrder | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._fields?.internalValue !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleBiglakeIcebergTableSortOrder | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._fields.internalValue = undefined;
    }
  ...
  // fields - computed: false, optional: false, required: true
  private _fields = new GoogleBiglakeIcebergTableSortOrderFieldsList(this, "fields", false);
  public get fields() {
    return this._fields;
  }
  public putFields(value: GoogleBiglakeIcebergTableSortOrderFields[] | cdktn.IResolvable) {
    this._fields.internalValue = value;
  }
  // Temporarily expose input value. Use with caution.
  public get fieldsInput() {
...
export class GoogleBiglakeIcebergTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBiglakeIcebergTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_biglake_iceberg_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_biglake_iceberg_table google_biglake_iceberg_table} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleBiglakeIcebergTableConfig) {
    ...
    this._sortOrder.internalValue = config.sortOrder;
  ...
  private _sortOrder = new GoogleBiglakeIcebergTableSortOrderOutputReference(this, "sort_order");
  public get sortOrder() {
    return this._sortOrder;
  }
  public putSortOrder(value: GoogleBiglakeIcebergTableSortOrder) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sort_order: googleBiglakeIcebergTableSortOrderToTerraform(this._sortOrder.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sort_order: {
        value: googleBiglakeIcebergTableSortOrderToHclTerraform(this._sortOrder.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleBiglakeIcebergTableSortOrderList",
      },
      timeouts: {
