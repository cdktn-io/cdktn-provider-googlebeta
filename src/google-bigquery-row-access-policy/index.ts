...
export interface GoogleBigqueryRowAccessPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleBigqueryRowAccessPolicyTimeoutsToTerraform(struct?: GoogleBigqueryRowAccessPolicyTimeouts | cdktf.IResolvable): any {
...
export function googleBigqueryRowAccessPolicyTimeoutsToHclTerraform(struct?: GoogleBigqueryRowAccessPolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBigqueryRowAccessPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryRowAccessPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleBigqueryRowAccessPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBigqueryRowAccessPolicy extends cdktf.TerraformResource {
