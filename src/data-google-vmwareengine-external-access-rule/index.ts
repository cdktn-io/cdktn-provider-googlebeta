...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_vmwareengine_external_access_rule
...
export interface DataGoogleVmwareengineExternalAccessRuleConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleVmwareengineExternalAccessRuleDestinationIpRangesOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleVmwareengineExternalAccessRuleDestinationIpRangesList extends cdktn.ComplexList {
...
export class DataGoogleVmwareengineExternalAccessRuleSourceIpRangesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineExternalAccessRuleSourceIpRangesList extends cdktn.ComplexList {
...
*/
export class DataGoogleVmwareengineExternalAccessRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineExternalAccessRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_vmwareengine_external_access_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_vmwareengine_external_access_rule google_vmwareengine_external_access_rule} Data Source
  *
  * @param scope The scope in which to define this construct
