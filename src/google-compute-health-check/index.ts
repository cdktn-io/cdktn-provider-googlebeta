...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_health_check
...
export interface GoogleComputeHealthCheckConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly grpcTlsHealthCheck?: GoogleComputeHealthCheckGrpcTlsHealthCheck;
  /**
...
export interface GoogleComputeHealthCheckGrpcTlsHealthCheck {
  /**
  * The gRPC service name for the health check.
  * The value of grpcServiceName has the following meanings by convention:
  *   - Empty serviceName means the overall status of all services at the backend.
...
export class GoogleComputeHealthCheckGrpcTlsHealthCheckOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeHealthCheckGrpcTlsHealthCheck | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._grpcServiceName !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: GoogleComputeHealthCheckGrpcTlsHealthCheck | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._grpcServiceName = undefined;
      this._port = undefined;
...
export class GoogleComputeHealthCheck extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeHealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_health_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_health_check google_compute_health_check} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _grpcTlsHealthCheck = new GoogleComputeHealthCheckGrpcTlsHealthCheckOutputReference(this, "grpc_tls_health_check");
  public get grpcTlsHealthCheck() {
    return this._grpcTlsHealthCheck;
  }
  public putGrpcTlsHealthCheck(value: GoogleComputeHealthCheckGrpcTlsHealthCheck) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      grpc_health_check: {
        value: googleComputeHealthCheckGrpcHealthCheckToHclTerraform(this._grpcHealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckGrpcHealthCheckList",
      },
      grpc_tls_health_check: {
        value: googleComputeHealthCheckGrpcTlsHealthCheckToHclTerraform(this._grpcTlsHealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckGrpcTlsHealthCheckList",
      },
      http2_health_check: {
        value: googleComputeHealthCheckHttp2HealthCheckToHclTerraform(this._http2HealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckHttp2HealthCheckList",
      },
      http_health_check: {
        value: googleComputeHealthCheckHttpHealthCheckToHclTerraform(this._httpHealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckHttpHealthCheckList",
      },
      https_health_check: {
        value: googleComputeHealthCheckHttpsHealthCheckToHclTerraform(this._httpsHealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckHttpsHealthCheckList",
      },
      log_config: {
        value: googleComputeHealthCheckLogConfigToHclTerraform(this._logConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckLogConfigList",
      },
      ssl_health_check: {
        value: googleComputeHealthCheckSslHealthCheckToHclTerraform(this._sslHealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckSslHealthCheckList",
      },
      tcp_health_check: {
        value: googleComputeHealthCheckTcpHealthCheckToHclTerraform(this._tcpHealthCheck.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeHealthCheckTcpHealthCheckList",
      },
      timeouts: {
        value: googleComputeHealthCheckTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeHealthCheckTimeouts",
      },
    };
