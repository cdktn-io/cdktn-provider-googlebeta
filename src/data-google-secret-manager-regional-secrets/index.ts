...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets
...
export interface DataGoogleSecretManagerRegionalSecretsConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets#filter DataGoogleSecretManagerRegionalSecrets#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets#id DataGoogleSecretManagerRegionalSecrets#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets#location DataGoogleSecretManagerRegionalSecrets#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets#project DataGoogleSecretManagerRegionalSecrets#project}
  */
...
export class DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList extends cdktn.ComplexList {
...
export class DataGoogleSecretManagerRegionalSecretsSecretsRotationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleSecretManagerRegionalSecretsSecretsRotationList extends cdktn.ComplexList {
...
export class DataGoogleSecretManagerRegionalSecretsSecretsTopicsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleSecretManagerRegionalSecretsSecretsTopicsList extends cdktn.ComplexList {
...
export class DataGoogleSecretManagerRegionalSecretsSecretsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleSecretManagerRegionalSecretsSecretsList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets google_secret_manager_regional_secrets}
*/
export class DataGoogleSecretManagerRegionalSecrets extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataGoogleSecretManagerRegionalSecrets resource upon running "cdktn plan <stack-name>"
  ...
  * @param importFromId The id of the existing DataGoogleSecretManagerRegionalSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_secret_manager_regional_secrets", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_secret_manager_regional_secrets google_secret_manager_regional_secrets} Data Source
  *
  * @param scope The scope in which to define this construct
