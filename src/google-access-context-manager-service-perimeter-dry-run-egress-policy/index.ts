...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_access_context_manager_service_perimeter_dry_run_egress_policy
...
export interface GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint {
  /**
...
export function googleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointToTerraform(struct?: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointOutputReference | GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint): any {
...
export function googleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointToHclTerraform(struct?: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointOutputReference | GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint | undefined {
  ...
  public set internalValue(value: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint | undefined) {
    if (value === undefined) {
...
export interface GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSources {
  ...
  */
  readonly pscEndpoint?: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint;
}
...
export function googleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesToTerraform(struct?: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSources | cdktn.IResolvable): any {
  ...
  return {
    ...
    psc_endpoint: googleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointToTerraform(struct!.pscEndpoint),
  }
}
...
export function googleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesToHclTerraform(struct?: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSources | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    psc_endpoint: {
      value: googleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointToHclTerraform(struct!.pscEndpoint),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointList",
    },
  };
...
export class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _pscEndpoint = new GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpointOutputReference(this, "psc_endpoint");
  public get pscEndpoint() {
    return this._pscEndpoint;
  }
  public putPscEndpoint(value: GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromSourcesPscEndpoint) {
...
export class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_access_context_manager_service_perimeter_dry_run_egress_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_access_context_manager_service_perimeter_dry_run_egress_policy google_access_context_manager_service_perimeter_dry_run_egress_policy} Resource
  *
  * @param scope The scope in which to define this construct
