...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_apigee_envgroup_attachment
...
export interface GoogleApigeeEnvgroupAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function googleApigeeEnvgroupAttachmentTimeoutsToTerraform(struct?: GoogleApigeeEnvgroupAttachmentTimeouts | cdktn.IResolvable): any {
...
export function googleApigeeEnvgroupAttachmentTimeoutsToHclTerraform(struct?: GoogleApigeeEnvgroupAttachmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApigeeEnvgroupAttachmentTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApigeeEnvgroupAttachmentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleApigeeEnvgroupAttachmentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleApigeeEnvgroupAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApigeeEnvgroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_apigee_envgroup_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_apigee_envgroup_attachment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_apigee_envgroup_attachment google_apigee_envgroup_attachment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      envgroup_id: cdktn.stringToTerraform(this._envgroupId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      envgroup_id: {
        value: cdktn.stringToHclTerraform(this._envgroupId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
