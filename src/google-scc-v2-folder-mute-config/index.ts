...
export interface GoogleSccV2FolderMuteConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleSccV2FolderMuteConfigTimeoutsToTerraform(struct?: GoogleSccV2FolderMuteConfigTimeouts | cdktf.IResolvable): any {
...
export function googleSccV2FolderMuteConfigTimeoutsToHclTerraform(struct?: GoogleSccV2FolderMuteConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccV2FolderMuteConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSccV2FolderMuteConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccV2FolderMuteConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSccV2FolderMuteConfig extends cdktf.TerraformResource {
