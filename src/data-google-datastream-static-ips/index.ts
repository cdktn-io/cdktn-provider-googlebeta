...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_datastream_static_ips
...
export class DataGoogleDatastreamStaticIps extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDatastreamStaticIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/data-sources/google_datastream_static_ips#import import section} in the documentation of this resource for the id to use
