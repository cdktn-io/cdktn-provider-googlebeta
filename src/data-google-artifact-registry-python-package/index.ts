...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_artifact_registry_python_package
...
export class DataGoogleArtifactRegistryPythonPackage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleArtifactRegistryPythonPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_artifact_registry_python_package#import import section} in the documentation of this resource for the id to use
