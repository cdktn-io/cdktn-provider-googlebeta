...
export function googleParallelstoreInstanceTimeoutsToTerraform(struct?: GoogleParallelstoreInstanceTimeouts | cdktf.IResolvable): any {
...
export function googleParallelstoreInstanceTimeoutsToHclTerraform(struct?: GoogleParallelstoreInstanceTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleParallelstoreInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleParallelstoreInstanceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleParallelstoreInstanceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
