...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_environment_group
...
export interface GoogleChronicleEnvironmentGroupConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleChronicleEnvironmentGroupTimeouts;
}
export interface GoogleChronicleEnvironmentGroupTimeouts {
  /**
...
export function googleChronicleEnvironmentGroupTimeoutsToTerraform(struct?: GoogleChronicleEnvironmentGroupTimeouts | cdktn.IResolvable): any {
...
export function googleChronicleEnvironmentGroupTimeoutsToHclTerraform(struct?: GoogleChronicleEnvironmentGroupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleChronicleEnvironmentGroupTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleChronicleEnvironmentGroupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleChronicleEnvironmentGroupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleChronicleEnvironmentGroup extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleChronicleEnvironmentGroup to import
  * @param importFromId The id of the existing GoogleChronicleEnvironmentGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_environment_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleChronicleEnvironmentGroup to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_environment_group google_chronicle_environment_group} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleChronicleEnvironmentGroupConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleChronicleEnvironmentGroupConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleChronicleEnvironmentGroupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleChronicleEnvironmentGroupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleChronicleEnvironmentGroupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleChronicleEnvironmentGroupTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleChronicleEnvironmentGroupTimeouts",
      },
    };
