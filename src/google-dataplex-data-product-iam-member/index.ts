...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_dataplex_data_product_iam_member
...
export class GoogleDataplexDataProductIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataplexDataProductIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_dataplex_data_product_iam_member#import import section} in the documentation of this resource for the id to use
