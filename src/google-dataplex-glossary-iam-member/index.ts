...
export class GoogleDataplexGlossaryIamMemberConditionOutputReference extends cdktf.ComplexObject {
...
export class GoogleDataplexGlossaryIamMember extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_dataplex_glossary_iam_member", importId: importFromId, provider });
      }
