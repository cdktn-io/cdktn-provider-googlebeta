...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_bigquery_reservation
...
export interface GoogleBigqueryReservationReplicationStatusError {
}
...
export class GoogleBigqueryReservationReplicationStatusErrorOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryReservationReplicationStatusError | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleBigqueryReservationReplicationStatusError | undefined) {
    if (value === undefined) {
...
export class GoogleBigqueryReservationReplicationStatusErrorList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleBigqueryReservationReplicationStatusErrorOutputReference {
    return new GoogleBigqueryReservationReplicationStatusErrorOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleBigqueryReservationReplicationStatus {
}
...
export class GoogleBigqueryReservationReplicationStatusOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryReservationReplicationStatus | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleBigqueryReservationReplicationStatus | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _error = new GoogleBigqueryReservationReplicationStatusErrorList(this, "error", false);
  public get error() {
    return this._error;
  }
...
export class GoogleBigqueryReservationReplicationStatusList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleBigqueryReservationReplicationStatusOutputReference {
    return new GoogleBigqueryReservationReplicationStatusOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleBigqueryReservation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleBigqueryReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_bigquery_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_bigquery_reservation google_bigquery_reservation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _replicationStatus = new GoogleBigqueryReservationReplicationStatusList(this, "replication_status", false);
