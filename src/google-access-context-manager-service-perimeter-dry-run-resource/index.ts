...
export interface GoogleAccessContextManagerServicePerimeterDryRunResourceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleAccessContextManagerServicePerimeterDryRunResourceTimeoutsToTerraform(struct?: GoogleAccessContextManagerServicePerimeterDryRunResourceTimeouts | cdktf.IResolvable): any {
...
export function googleAccessContextManagerServicePerimeterDryRunResourceTimeoutsToHclTerraform(struct?: GoogleAccessContextManagerServicePerimeterDryRunResourceTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleAccessContextManagerServicePerimeterDryRunResourceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAccessContextManagerServicePerimeterDryRunResourceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleAccessContextManagerServicePerimeterDryRunResourceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleAccessContextManagerServicePerimeterDryRunResource extends cdktf.TerraformResource {
