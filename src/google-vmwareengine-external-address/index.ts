...
export interface GoogleVmwareengineExternalAddressConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleVmwareengineExternalAddressTimeoutsToTerraform(struct?: GoogleVmwareengineExternalAddressTimeouts | cdktf.IResolvable): any {
...
export function googleVmwareengineExternalAddressTimeoutsToHclTerraform(struct?: GoogleVmwareengineExternalAddressTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleVmwareengineExternalAddressTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVmwareengineExternalAddressTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleVmwareengineExternalAddressTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleVmwareengineExternalAddress extends cdktf.TerraformResource {
