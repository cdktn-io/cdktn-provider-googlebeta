...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_beyondcorp_app_gateway
...
export class DataGoogleBeyondcorpAppGatewayAllocatedConnectionsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList extends cdktn.ComplexList {
...
export class DataGoogleBeyondcorpAppGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBeyondcorpAppGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_beyondcorp_app_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_beyondcorp_app_gateway google_beyondcorp_app_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
