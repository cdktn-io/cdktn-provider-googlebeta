...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_beyondcorp_application_iam_policy
...
export interface DataGoogleBeyondcorpApplicationIamPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataGoogleBeyondcorpApplicationIamPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBeyondcorpApplicationIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_beyondcorp_application_iam_policy#import import section} in the documentation of this resource for the id to use
