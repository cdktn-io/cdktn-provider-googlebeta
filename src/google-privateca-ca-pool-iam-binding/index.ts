...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_privateca_ca_pool_iam_binding
...
export class GooglePrivatecaCaPoolIamBinding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GooglePrivatecaCaPoolIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_privateca_ca_pool_iam_binding#import import section} in the documentation of this resource for the id to use
