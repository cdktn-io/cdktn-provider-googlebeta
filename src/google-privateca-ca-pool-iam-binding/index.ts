...
export interface GooglePrivatecaCaPoolIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GooglePrivatecaCaPoolIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GooglePrivatecaCaPoolIamBinding extends cdktf.TerraformResource {
