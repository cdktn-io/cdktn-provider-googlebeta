...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_endpoints_service
...
export interface GoogleEndpointsServiceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class GoogleEndpointsServiceApisMethodsOutputReference extends cdktn.ComplexObject {
...
export class GoogleEndpointsServiceApisMethodsList extends cdktn.ComplexList {
...
export class GoogleEndpointsServiceApisOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleEndpointsServiceApisList extends cdktn.ComplexList {
...
export class GoogleEndpointsServiceEndpointsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleEndpointsServiceEndpointsList extends cdktn.ComplexList {
...
export function googleEndpointsServiceTimeoutsToTerraform(struct?: GoogleEndpointsServiceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleEndpointsServiceTimeoutsToHclTerraform(struct?: GoogleEndpointsServiceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleEndpointsServiceTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleEndpointsServiceTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleEndpointsServiceTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleEndpointsService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleEndpointsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_endpoints_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_endpoints_service google_endpoints_service} Resource
  *
  * @param scope The scope in which to define this construct
