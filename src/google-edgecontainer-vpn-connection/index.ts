...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_edgecontainer_vpn_connection
...
export class GoogleEdgecontainerVpnConnectionDetailsCloudRouterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleEdgecontainerVpnConnectionDetailsCloudRouter | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleEdgecontainerVpnConnectionDetailsCloudRouter | undefined) {
    if (value === undefined) {
...
export class GoogleEdgecontainerVpnConnectionDetailsCloudRouterList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleEdgecontainerVpnConnectionDetailsCloudRouterOutputReference {
    return new GoogleEdgecontainerVpnConnectionDetailsCloudRouterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleEdgecontainerVpnConnectionDetailsCloudVpnsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleEdgecontainerVpnConnectionDetailsCloudVpns | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleEdgecontainerVpnConnectionDetailsCloudVpns | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class GoogleEdgecontainerVpnConnectionDetailsCloudVpnsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleEdgecontainerVpnConnectionDetailsCloudVpnsOutputReference {
    return new GoogleEdgecontainerVpnConnectionDetailsCloudVpnsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleEdgecontainerVpnConnectionDetailsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleEdgecontainerVpnConnectionDetails | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleEdgecontainerVpnConnectionDetails | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _cloudRouter = new GoogleEdgecontainerVpnConnectionDetailsCloudRouterList(this, "cloud_router", false);
  public get cloudRouter() {
    return this._cloudRouter;
  }

  // cloud_vpns - computed: true, optional: false, required: false
  private _cloudVpns = new GoogleEdgecontainerVpnConnectionDetailsCloudVpnsList(this, "cloud_vpns", false);
...
export class GoogleEdgecontainerVpnConnectionDetailsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleEdgecontainerVpnConnectionDetailsOutputReference {
    return new GoogleEdgecontainerVpnConnectionDetailsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleEdgecontainerVpnConnectionVpcProjectOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleEdgecontainerVpnConnectionVpcProject | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleEdgecontainerVpnConnectionVpcProject | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleEdgecontainerVpnConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleEdgecontainerVpnConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_edgecontainer_vpn_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_edgecontainer_vpn_connection google_edgecontainer_vpn_connection} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleEdgecontainerVpnConnectionConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleEdgecontainerVpnConnectionConfig) {
    super(scope, id, {
  ...
  private _details = new GoogleEdgecontainerVpnConnectionDetailsList(this, "details", false);
  public get details() {
  ...
  private _timeouts = new GoogleEdgecontainerVpnConnectionTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleEdgecontainerVpnConnectionTimeouts) {
  ...
  private _vpcProject = new GoogleEdgecontainerVpnConnectionVpcProjectOutputReference(this, "vpc_project");
  public get vpcProject() {
    return this._vpcProject;
  }
  public putVpcProject(value: GoogleEdgecontainerVpnConnectionVpcProject) {
