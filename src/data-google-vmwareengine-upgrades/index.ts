...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_vmwareengine_upgrades
...
export class DataGoogleVmwareengineUpgrades extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineUpgrades that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_vmwareengine_upgrades#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_vmwareengine_upgrades google_vmwareengine_upgrades} Data Source
  *
  * @param scope The scope in which to define this construct
