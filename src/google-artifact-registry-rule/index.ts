...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_artifact_registry_rule
...
export class GoogleArtifactRegistryRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleArtifactRegistryRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_artifact_registry_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_artifact_registry_rule google_artifact_registry_rule} Resource
  *
  * @param scope The scope in which to define this construct
