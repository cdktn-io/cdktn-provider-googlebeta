...
export interface GoogleComputeSslCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleComputeSslCertificateTimeoutsToTerraform(struct?: GoogleComputeSslCertificateTimeouts | cdktf.IResolvable): any {
...
export function googleComputeSslCertificateTimeoutsToHclTerraform(struct?: GoogleComputeSslCertificateTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeSslCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeSslCertificateTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeSslCertificateTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeSslCertificate extends cdktf.TerraformResource {
