...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_compute_ssl_certificate
...
export interface GoogleComputeSslCertificateConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface GoogleComputeSslCertificateTimeouts {
  /**
...
export function googleComputeSslCertificateTimeoutsToTerraform(struct?: GoogleComputeSslCertificateTimeouts | cdktn.IResolvable): any {
...
export function googleComputeSslCertificateTimeoutsToHclTerraform(struct?: GoogleComputeSslCertificateTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeSslCertificateTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeSslCertificateTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeSslCertificateTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeSslCertificate extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleComputeSslCertificate to import
  * @param importFromId The id of the existing GoogleComputeSslCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_compute_ssl_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_compute_ssl_certificate google_compute_ssl_certificate} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleComputeSslCertificateConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeSslCertificateConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeSslCertificateTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeSslCertificateTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleComputeSslCertificateTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeSslCertificateTimeouts",
      },
    };
