...
export interface GoogleLoggingLogScopeConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleLoggingLogScopeTimeoutsToTerraform(struct?: GoogleLoggingLogScopeTimeouts | cdktf.IResolvable): any {
...
export function googleLoggingLogScopeTimeoutsToHclTerraform(struct?: GoogleLoggingLogScopeTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleLoggingLogScopeTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleLoggingLogScopeTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleLoggingLogScopeTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleLoggingLogScope extends cdktf.TerraformResource {
