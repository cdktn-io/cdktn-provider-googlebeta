...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_vertex_ai_cache_config
...
export interface GoogleVertexAiCacheConfigConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleVertexAiCacheConfigTimeouts;
}
export interface GoogleVertexAiCacheConfigTimeouts {
  /**
...
export function googleVertexAiCacheConfigTimeoutsToTerraform(struct?: GoogleVertexAiCacheConfigTimeouts | cdktn.IResolvable): any {
...
export function googleVertexAiCacheConfigTimeoutsToHclTerraform(struct?: GoogleVertexAiCacheConfigTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleVertexAiCacheConfigTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVertexAiCacheConfigTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleVertexAiCacheConfigTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleVertexAiCacheConfig extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleVertexAiCacheConfig to import
  * @param importFromId The id of the existing GoogleVertexAiCacheConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_vertex_ai_cache_config#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleVertexAiCacheConfig to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_vertex_ai_cache_config google_vertex_ai_cache_config} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleVertexAiCacheConfigConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleVertexAiCacheConfigConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleVertexAiCacheConfigTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleVertexAiCacheConfigTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleVertexAiCacheConfigTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleVertexAiCacheConfigTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleVertexAiCacheConfigTimeouts",
      },
    };
