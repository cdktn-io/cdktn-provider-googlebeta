...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_data_product_iam_binding
...
export interface GoogleDataplexDataProductIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleDataplexDataProductIamBindingCondition;
}
export interface GoogleDataplexDataProductIamBindingCondition {
  /**
...
export function googleDataplexDataProductIamBindingConditionToTerraform(struct?: GoogleDataplexDataProductIamBindingConditionOutputReference | GoogleDataplexDataProductIamBindingCondition): any {
...
export function googleDataplexDataProductIamBindingConditionToHclTerraform(struct?: GoogleDataplexDataProductIamBindingConditionOutputReference | GoogleDataplexDataProductIamBindingCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleDataplexDataProductIamBindingConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataplexDataProductIamBindingCondition | undefined {
  ...
  public set internalValue(value: GoogleDataplexDataProductIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleDataplexDataProductIamBinding extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_dataplex_data_product_iam_binding";
  ...
  * @param importToId The construct id used in the generated config for the GoogleDataplexDataProductIamBinding to import
  * @param importFromId The id of the existing GoogleDataplexDataProductIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_data_product_iam_binding#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleDataplexDataProductIamBinding to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_dataplex_data_product_iam_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_data_product_iam_binding google_dataplex_data_product_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleDataplexDataProductIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataplexDataProductIamBindingConfig) {
    super(scope, id, {
      terraformResourceType: 'google_dataplex_data_product_iam_binding',
  ...
  private _condition = new GoogleDataplexDataProductIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleDataplexDataProductIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleDataplexDataProductIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleDataplexDataProductIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleDataplexDataProductIamBindingConditionList",
      },
    };
