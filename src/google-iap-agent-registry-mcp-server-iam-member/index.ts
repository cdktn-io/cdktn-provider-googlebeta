...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_iap_agent_registry_mcp_server_iam_member
...
export interface GoogleIapAgentRegistryMcpServerIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleIapAgentRegistryMcpServerIamMemberCondition;
}
export interface GoogleIapAgentRegistryMcpServerIamMemberCondition {
  /**
...
export function googleIapAgentRegistryMcpServerIamMemberConditionToTerraform(struct?: GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference | GoogleIapAgentRegistryMcpServerIamMemberCondition): any {
...
export function googleIapAgentRegistryMcpServerIamMemberConditionToHclTerraform(struct?: GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference | GoogleIapAgentRegistryMcpServerIamMemberCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIapAgentRegistryMcpServerIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleIapAgentRegistryMcpServerIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIapAgentRegistryMcpServerIamMember extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleIapAgentRegistryMcpServerIamMember to import
  * @param importFromId The id of the existing GoogleIapAgentRegistryMcpServerIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_iap_agent_registry_mcp_server_iam_member#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleIapAgentRegistryMcpServerIamMember to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_iap_agent_registry_mcp_server_iam_member google_iap_agent_registry_mcp_server_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleIapAgentRegistryMcpServerIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIapAgentRegistryMcpServerIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleIapAgentRegistryMcpServerIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleIapAgentRegistryMcpServerIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleIapAgentRegistryMcpServerIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleIapAgentRegistryMcpServerIamMemberConditionList",
      },
    };
