...
export interface GoogleFirebaseAppCheckRecaptchaEnterpriseConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * The ID of an
...
export function googleFirebaseAppCheckRecaptchaEnterpriseConfigTimeoutsToTerraform(struct?: GoogleFirebaseAppCheckRecaptchaEnterpriseConfigTimeouts | cdktf.IResolvable): any {
...
export function googleFirebaseAppCheckRecaptchaEnterpriseConfigTimeoutsToHclTerraform(struct?: GoogleFirebaseAppCheckRecaptchaEnterpriseConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleFirebaseAppCheckRecaptchaEnterpriseConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFirebaseAppCheckRecaptchaEnterpriseConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleFirebaseAppCheckRecaptchaEnterpriseConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleFirebaseAppCheckRecaptchaEnterpriseConfig extends cdktf.TerraformResource {
