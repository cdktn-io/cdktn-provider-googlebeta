...
export interface GooglePubsubSchemaIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GooglePubsubSchemaIamMemberConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GooglePubsubSchemaIamMember extends cdktf.TerraformResource {
