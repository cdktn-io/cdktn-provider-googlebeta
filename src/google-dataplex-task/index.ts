...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task
...
export interface GoogleDataplexTaskConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#deletion_policy GoogleDataplexTask#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * User-provided description of the task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#description GoogleDataplexTask#description}
  */
  readonly description?: string;
  /**
  * User friendly display name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#display_name GoogleDataplexTask#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#id GoogleDataplexTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#labels GoogleDataplexTask#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The lake in which the task will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#lake GoogleDataplexTask#lake}
  */
  readonly lake?: string;
  /**
  * The location in which the task will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#location GoogleDataplexTask#location}
  */
  readonly location?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#project GoogleDataplexTask#project}
  */
  readonly project?: string;
  /**
  * The task Id of the task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#task_id GoogleDataplexTask#task_id}
  */
  readonly taskId?: string;
  /**
  * execution_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#execution_spec GoogleDataplexTask#execution_spec}
  */
  readonly executionSpec: GoogleDataplexTaskExecutionSpec;
  /**
  * notebook block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#notebook GoogleDataplexTask#notebook}
  */
  readonly notebook?: GoogleDataplexTaskNotebook;
  /**
  * spark block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#spark GoogleDataplexTask#spark}
  */
  readonly spark?: GoogleDataplexTaskSpark;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#timeouts GoogleDataplexTask#timeouts}
  */
  readonly timeouts?: GoogleDataplexTaskTimeouts;
  /**
  * trigger_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#trigger_spec GoogleDataplexTask#trigger_spec}
  */
...
export class GoogleDataplexTaskExecutionStatusLatestJobOutputReference extends cdktn.ComplexObject {
...
export class GoogleDataplexTaskExecutionStatusLatestJobList extends cdktn.ComplexList {
...
export class GoogleDataplexTaskExecutionStatusOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleDataplexTaskExecutionStatusList extends cdktn.ComplexList {
...
export interface GoogleDataplexTaskExecutionSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#args GoogleDataplexTask#args}
  */
  readonly args?: { [key: string]: string };
  /**
  * The Cloud KMS key to use for encryption, of the form: projects/{project_number}/locations/{locationId}/keyRings/{key-ring-name}/cryptoKeys/{key-name}.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#kms_key GoogleDataplexTask#kms_key}
  */
  readonly kmsKey?: string;
  /**
  * The maximum duration after which the job execution is expired. A duration in seconds with up to nine fractional digits, ending with 's'. Example: '3.5s'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#max_job_execution_lifetime GoogleDataplexTask#max_job_execution_lifetime}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#service_account GoogleDataplexTask#service_account}
  */
...
export function googleDataplexTaskExecutionSpecToTerraform(struct?: GoogleDataplexTaskExecutionSpecOutputReference | GoogleDataplexTaskExecutionSpec): any {
  ...
  return {
    ...
    max_job_execution_lifetime: cdktn.stringToTerraform(struct!.maxJobExecutionLifetime),
...
export function googleDataplexTaskExecutionSpecToHclTerraform(struct?: GoogleDataplexTaskExecutionSpecOutputReference | GoogleDataplexTaskExecutionSpec): any {
  ...
  const attrs = {
    ...
    max_job_execution_lifetime: {
      value: cdktn.stringToHclTerraform(struct!.maxJobExecutionLifetime),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GoogleDataplexTaskExecutionSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskNotebookInfrastructureSpecBatch {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#executors_count GoogleDataplexTask#executors_count}
  */
  readonly executorsCount?: number;
  /**
  * Max configurable executors. If maxExecutorsCount > executorsCount, then auto-scaling is enabled. Max Executor Count should be between 2 and 1000. [Default=1000]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#max_executors_count GoogleDataplexTask#max_executors_count}
  */
...
export function googleDataplexTaskNotebookInfrastructureSpecBatchToTerraform(struct?: GoogleDataplexTaskNotebookInfrastructureSpecBatchOutputReference | GoogleDataplexTaskNotebookInfrastructureSpecBatch): any {
  ...
  return {
    executors_count: cdktn.numberToTerraform(struct!.executorsCount),
    max_executors_count: cdktn.numberToTerraform(struct!.maxExecutorsCount),
  }
}
...
export function googleDataplexTaskNotebookInfrastructureSpecBatchToHclTerraform(struct?: GoogleDataplexTaskNotebookInfrastructureSpecBatchOutputReference | GoogleDataplexTaskNotebookInfrastructureSpecBatch): any {
  ...
  const attrs = {
    executors_count: {
      value: cdktn.numberToHclTerraform(struct!.executorsCount),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    max_executors_count: {
      value: cdktn.numberToHclTerraform(struct!.maxExecutorsCount),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class GoogleDataplexTaskNotebookInfrastructureSpecBatchOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskNotebookInfrastructureSpecContainerImage {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#image GoogleDataplexTask#image}
  */
  readonly image?: string;
  /**
  * A list of Java JARS to add to the classpath. Valid input includes Cloud Storage URIs to Jar binaries. For example, gs://bucket-name/my/path/to/file.jar
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#java_jars GoogleDataplexTask#java_jars}
  */
  readonly javaJars?: string[];
  /**
  * Override to common configuration of open source components installed on the Dataproc cluster. The properties to set on daemon config files. Property keys are specified in prefix:property format, for example core:hadoop.tmp.dir. For more information, see Cluster properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#properties GoogleDataplexTask#properties}
  */
  readonly properties?: { [key: string]: string };
  /**
  * A list of python packages to be installed. Valid formats include Cloud Storage URI to a PIP installable library. For example, gs://bucket-name/my/path/to/lib.tar.gz
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#python_packages GoogleDataplexTask#python_packages}
  */
...
export function googleDataplexTaskNotebookInfrastructureSpecContainerImageToTerraform(struct?: GoogleDataplexTaskNotebookInfrastructureSpecContainerImageOutputReference | GoogleDataplexTaskNotebookInfrastructureSpecContainerImage): any {
  ...
  return {
    ...
    java_jars: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.javaJars),
    properties: cdktn.hashMapper(cdktn.stringToTerraform)(struct!.properties),
    python_packages: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.pythonPackages),
  }
}
...
export function googleDataplexTaskNotebookInfrastructureSpecContainerImageToHclTerraform(struct?: GoogleDataplexTaskNotebookInfrastructureSpecContainerImageOutputReference | GoogleDataplexTaskNotebookInfrastructureSpecContainerImage): any {
  ...
  const attrs = {
    ...
    java_jars: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.javaJars),
      isBlock: false,
      type: "list",
    ...
    python_packages: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.pythonPackages),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class GoogleDataplexTaskNotebookInfrastructureSpecContainerImageOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskNotebookInfrastructureSpecVpcNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#network GoogleDataplexTask#network}
  */
  readonly network?: string;
  /**
  * List of network tags to apply to the job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#network_tags GoogleDataplexTask#network_tags}
  */
  readonly networkTags?: string[];
  /**
  * The Cloud VPC sub-network in which the job is run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#sub_network GoogleDataplexTask#sub_network}
  */
...
export function googleDataplexTaskNotebookInfrastructureSpecVpcNetworkToTerraform(struct?: GoogleDataplexTaskNotebookInfrastructureSpecVpcNetworkOutputReference | GoogleDataplexTaskNotebookInfrastructureSpecVpcNetwork): any {
  ...
  return {
    ...
    sub_network: cdktn.stringToTerraform(struct!.subNetwork),
  }
}
...
export class GoogleDataplexTaskNotebookInfrastructureSpecVpcNetworkOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskNotebookInfrastructureSpec {
  ...
  * batch block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#batch GoogleDataplexTask#batch}
  */
  readonly batch?: GoogleDataplexTaskNotebookInfrastructureSpecBatch;
  /**
  * container_image block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#container_image GoogleDataplexTask#container_image}
  */
  readonly containerImage?: GoogleDataplexTaskNotebookInfrastructureSpecContainerImage;
  /**
  * vpc_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#vpc_network GoogleDataplexTask#vpc_network}
  */
...
export class GoogleDataplexTaskNotebookInfrastructureSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskNotebook {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#archive_uris GoogleDataplexTask#archive_uris}
  */
  readonly archiveUris?: string[];
  /**
  * Cloud Storage URIs of files to be placed in the working directory of each executor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#file_uris GoogleDataplexTask#file_uris}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#infrastructure_spec GoogleDataplexTask#infrastructure_spec}
  */
...
export function googleDataplexTaskNotebookToTerraform(struct?: GoogleDataplexTaskNotebookOutputReference | GoogleDataplexTaskNotebook): any {
  ...
  return {
    ...
    notebook: cdktn.stringToTerraform(struct!.notebook),
...
export function googleDataplexTaskNotebookToHclTerraform(struct?: GoogleDataplexTaskNotebookOutputReference | GoogleDataplexTaskNotebook): any {
  ...
  const attrs = {
    ...
    notebook: {
      value: cdktn.stringToHclTerraform(struct!.notebook),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GoogleDataplexTaskNotebookOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleDataplexTaskSparkInfrastructureSpecBatchOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleDataplexTaskSparkInfrastructureSpecContainerImageOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleDataplexTaskSparkInfrastructureSpecVpcNetworkOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleDataplexTaskSparkInfrastructureSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskSpark {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#main_class GoogleDataplexTask#main_class}
  */
  readonly mainClass?: string;
  /**
  * The Cloud Storage URI of the jar file that contains the main class. The execution args are passed in as a sequence of named process arguments (--key=value).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#main_jar_file_uri GoogleDataplexTask#main_jar_file_uri}
  */
  readonly mainJarFileUri?: string;
  /**
  * The Gcloud Storage URI of the main Python file to use as the driver. Must be a .py file. The execution args are passed in as a sequence of named process arguments (--key=value).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#python_script_file GoogleDataplexTask#python_script_file}
  */
  readonly pythonScriptFile?: string;
  /**
  * The query text. The execution args are used to declare a set of script variables (set key='value';).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#sql_script GoogleDataplexTask#sql_script}
  */
  readonly sqlScript?: string;
  /**
  * A reference to a query file. This can be the Cloud Storage URI of the query file or it can the path to a SqlScript Content. The execution args are used to declare a set of script variables (set key='value';).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#sql_script_file GoogleDataplexTask#sql_script_file}
  */
...
export function googleDataplexTaskSparkToTerraform(struct?: GoogleDataplexTaskSparkOutputReference | GoogleDataplexTaskSpark): any {
  ...
  return {
    ...
    python_script_file: cdktn.stringToTerraform(struct!.pythonScriptFile),
    sql_script: cdktn.stringToTerraform(struct!.sqlScript),
    sql_script_file: cdktn.stringToTerraform(struct!.sqlScriptFile),
...
export function googleDataplexTaskSparkToHclTerraform(struct?: GoogleDataplexTaskSparkOutputReference | GoogleDataplexTaskSpark): any {
  ...
  const attrs = {
    ...
    python_script_file: {
      value: cdktn.stringToHclTerraform(struct!.pythonScriptFile),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    sql_script: {
      value: cdktn.stringToHclTerraform(struct!.sqlScript),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    sql_script_file: {
      value: cdktn.stringToHclTerraform(struct!.sqlScriptFile),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GoogleDataplexTaskSparkOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleDataplexTaskTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#create GoogleDataplexTask#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#delete GoogleDataplexTask#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#update GoogleDataplexTask#update}
  */
  readonly update?: string;
}

export function googleDataplexTaskTimeoutsToTerraform(struct?: GoogleDataplexTaskTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleDataplexTaskTimeoutsToHclTerraform(struct?: GoogleDataplexTaskTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleDataplexTaskTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleDataplexTaskTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleDataplexTaskTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleDataplexTaskTriggerSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#disabled GoogleDataplexTask#disabled}
  */
  readonly disabled?: boolean | cdktn.IResolvable;
  /**
  * Number of retry attempts before aborting. Set to zero to never attempt to retry a failed task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#max_retries GoogleDataplexTask#max_retries}
  */
  readonly maxRetries?: number;
  /**
  * Cron schedule (https://en.wikipedia.org/wiki/Cron) for running tasks periodically. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: 'CRON_TZ=${IANA_TIME_ZONE}' or 'TZ=${IANA_TIME_ZONE}'. The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, CRON_TZ=America/New_York 1 * * * *, or TZ=America/New_York 1 * * * *. This field is required for RECURRING tasks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#schedule GoogleDataplexTask#schedule}
  */
  readonly schedule?: string;
  /**
  * The first run of the task will be after this time. If not specified, the task will run shortly after being submitted if ON_DEMAND and based on the schedule if RECURRING.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#start_time GoogleDataplexTask#start_time}
  */
  readonly startTime?: string;
  /**
  * Trigger type of the user-specified Task Possible values: ["ON_DEMAND", "RECURRING"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#type GoogleDataplexTask#type}
  */
...
export class GoogleDataplexTaskTriggerSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task google_dataplex_task}
*/
export class GoogleDataplexTask extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a GoogleDataplexTask resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the GoogleDataplexTask to import
  * @param importFromId The id of the existing GoogleDataplexTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleDataplexTask to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_dataplex_task", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dataplex_task google_dataplex_task} Resource
  *
  * @param scope The scope in which to define this construct
