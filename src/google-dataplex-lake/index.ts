...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_dataplex_lake
...
export class GoogleDataplexLake extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataplexLake that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_dataplex_lake#import import section} in the documentation of this resource for the id to use
