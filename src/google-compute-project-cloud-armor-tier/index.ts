...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_compute_project_cloud_armor_tier
...
export class GoogleComputeProjectCloudArmorTier extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeProjectCloudArmorTier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_compute_project_cloud_armor_tier#import import section} in the documentation of this resource for the id to use
