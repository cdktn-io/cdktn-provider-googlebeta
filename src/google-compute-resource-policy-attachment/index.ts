...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_compute_resource_policy_attachment
...
export interface GoogleComputeResourcePolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleComputeResourcePolicyAttachmentTimeoutsToTerraform(struct?: GoogleComputeResourcePolicyAttachmentTimeouts | cdktf.IResolvable): any {
...
export function googleComputeResourcePolicyAttachmentTimeoutsToHclTerraform(struct?: GoogleComputeResourcePolicyAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeResourcePolicyAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeResourcePolicyAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeResourcePolicyAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeResourcePolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeResourcePolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_compute_resource_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_compute_resource_policy_attachment google_compute_resource_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
