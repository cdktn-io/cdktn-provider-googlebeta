...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_kms_crypto_keys
...
export class DataGoogleKmsCryptoKeysKeysKeyAccessJustificationsPolicyOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleKmsCryptoKeysKeysKeyAccessJustificationsPolicyList extends cdktn.ComplexList {
...
export class DataGoogleKmsCryptoKeys extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsCryptoKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_kms_crypto_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_kms_crypto_keys google_kms_crypto_keys} Data Source
  *
  * @param scope The scope in which to define this construct
