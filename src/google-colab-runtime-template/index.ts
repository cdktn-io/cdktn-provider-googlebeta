...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template
...
export interface GoogleColabRuntimeTemplateConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#deletion_policy GoogleColabRuntimeTemplate#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * The description of the Runtime Template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#description GoogleColabRuntimeTemplate#description}
  */
  readonly description?: string;
  /**
  * Required. The display name of the Runtime Template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#display_name GoogleColabRuntimeTemplate#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#id GoogleColabRuntimeTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#labels GoogleColabRuntimeTemplate#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The location for the resource: https://cloud.google.com/colab/docs/locations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#location GoogleColabRuntimeTemplate#location}
  */
  readonly location: string;
  /**
  * The resource name of the Runtime Template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#name GoogleColabRuntimeTemplate#name}
  */
  readonly name?: string;
  /**
  * Applies the given Compute Engine tags to the runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#network_tags GoogleColabRuntimeTemplate#network_tags}
  */
  readonly networkTags?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#project GoogleColabRuntimeTemplate#project}
  */
  readonly project?: string;
  /**
  * data_persistent_disk_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#data_persistent_disk_spec GoogleColabRuntimeTemplate#data_persistent_disk_spec}
  */
  readonly dataPersistentDiskSpec?: GoogleColabRuntimeTemplateDataPersistentDiskSpec;
  /**
  * encryption_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#encryption_spec GoogleColabRuntimeTemplate#encryption_spec}
  */
  readonly encryptionSpec?: GoogleColabRuntimeTemplateEncryptionSpec;
  /**
  * euc_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#euc_config GoogleColabRuntimeTemplate#euc_config}
  */
  readonly eucConfig?: GoogleColabRuntimeTemplateEucConfig;
  /**
  * idle_shutdown_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#idle_shutdown_config GoogleColabRuntimeTemplate#idle_shutdown_config}
  */
  readonly idleShutdownConfig?: GoogleColabRuntimeTemplateIdleShutdownConfig;
  /**
  * machine_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#machine_spec GoogleColabRuntimeTemplate#machine_spec}
  */
  readonly machineSpec?: GoogleColabRuntimeTemplateMachineSpec;
  /**
  * network_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#network_spec GoogleColabRuntimeTemplate#network_spec}
  */
  readonly networkSpec?: GoogleColabRuntimeTemplateNetworkSpec;
  /**
  * shielded_vm_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#shielded_vm_config GoogleColabRuntimeTemplate#shielded_vm_config}
  */
  readonly shieldedVmConfig?: GoogleColabRuntimeTemplateShieldedVmConfig;
  /**
  * software_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#software_config GoogleColabRuntimeTemplate#software_config}
  */
  readonly softwareConfig?: GoogleColabRuntimeTemplateSoftwareConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#timeouts GoogleColabRuntimeTemplate#timeouts}
  */
...
export interface GoogleColabRuntimeTemplateDataPersistentDiskSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#disk_size_gb GoogleColabRuntimeTemplate#disk_size_gb}
  */
  readonly diskSizeGb?: string;
  /**
  * The type of the persistent disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#disk_type GoogleColabRuntimeTemplate#disk_type}
  */
...
export class GoogleColabRuntimeTemplateDataPersistentDiskSpecOutputReference extends cdktn.ComplexObject {
...
export interface GoogleColabRuntimeTemplateEncryptionSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#kms_key_name GoogleColabRuntimeTemplate#kms_key_name}
  */
...
export class GoogleColabRuntimeTemplateEncryptionSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateEucConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#euc_disabled GoogleColabRuntimeTemplate#euc_disabled}
  */
...
export class GoogleColabRuntimeTemplateEucConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateIdleShutdownConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#idle_timeout GoogleColabRuntimeTemplate#idle_timeout}
  */
...
export class GoogleColabRuntimeTemplateIdleShutdownConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateMachineSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#accelerator_count GoogleColabRuntimeTemplate#accelerator_count}
  */
  readonly acceleratorCount?: number;
  /**
  * The type of hardware accelerator used by the runtime. If specified, acceleratorCount must also be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#accelerator_type GoogleColabRuntimeTemplate#accelerator_type}
  */
  readonly acceleratorType?: string;
  /**
  * The Compute Engine machine type selected for the runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#machine_type GoogleColabRuntimeTemplate#machine_type}
  */
...
export class GoogleColabRuntimeTemplateMachineSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateNetworkSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#enable_internet_access GoogleColabRuntimeTemplate#enable_internet_access}
  */
  readonly enableInternetAccess?: boolean | cdktn.IResolvable;
  /**
  * The name of the VPC that this runtime is in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#network GoogleColabRuntimeTemplate#network}
  */
  readonly network?: string;
  /**
  * The name of the subnetwork that this runtime is in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#subnetwork GoogleColabRuntimeTemplate#subnetwork}
  */
...
export class GoogleColabRuntimeTemplateNetworkSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateShieldedVmConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#enable_secure_boot GoogleColabRuntimeTemplate#enable_secure_boot}
  */
...
export class GoogleColabRuntimeTemplateShieldedVmConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateSoftwareConfigColabImage {
  /**
  * The release name of the NotebookRuntime Colab image, e.g. "py310". If not specified, detault to the latest release.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#release_name GoogleColabRuntimeTemplate#release_name}
  */
...
export function googleColabRuntimeTemplateSoftwareConfigColabImageToHclTerraform(struct?: GoogleColabRuntimeTemplateSoftwareConfigColabImageOutputReference | GoogleColabRuntimeTemplateSoftwareConfigColabImage): any {
  ...
  const attrs = {
    release_name: {
      value: cdktn.stringToHclTerraform(struct!.releaseName),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GoogleColabRuntimeTemplateSoftwareConfigColabImageOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleColabRuntimeTemplateSoftwareConfigColabImage | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleColabRuntimeTemplateSoftwareConfigColabImage | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateSoftwareConfigEnv {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#value GoogleColabRuntimeTemplate#value}
  */
...
export class GoogleColabRuntimeTemplateSoftwareConfigEnvOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleColabRuntimeTemplateSoftwareConfigEnv | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleColabRuntimeTemplateSoftwareConfigEnv | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleColabRuntimeTemplateSoftwareConfigEnvList extends cdktn.ComplexList {
  public internalValue? : GoogleColabRuntimeTemplateSoftwareConfigEnv[] | cdktn.IResolvable
...
export interface GoogleColabRuntimeTemplateSoftwareConfigPostStartupScriptConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#post_startup_script GoogleColabRuntimeTemplate#post_startup_script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#post_startup_script_behavior GoogleColabRuntimeTemplate#post_startup_script_behavior}
  */
  readonly postStartupScriptBehavior?: string;
  /**
  * Post startup script url to download. Example: https://bucket/script.sh.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#post_startup_script_url GoogleColabRuntimeTemplate#post_startup_script_url}
  */
...
export class GoogleColabRuntimeTemplateSoftwareConfigPostStartupScriptConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface GoogleColabRuntimeTemplateSoftwareConfig {
  ...
  * colab_image block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#colab_image GoogleColabRuntimeTemplate#colab_image}
  */
  readonly colabImage?: GoogleColabRuntimeTemplateSoftwareConfigColabImage;
  /**
  * env block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#env GoogleColabRuntimeTemplate#env}
  */
  readonly env?: GoogleColabRuntimeTemplateSoftwareConfigEnv[] | cdktn.IResolvable;
  /**
  * post_startup_script_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#post_startup_script_config GoogleColabRuntimeTemplate#post_startup_script_config}
  */
...
export function googleColabRuntimeTemplateSoftwareConfigToTerraform(struct?: GoogleColabRuntimeTemplateSoftwareConfigOutputReference | GoogleColabRuntimeTemplateSoftwareConfig): any {
  ...
  return {
    ...
    env: cdktn.listMapper(googleColabRuntimeTemplateSoftwareConfigEnvToTerraform, true)(struct!.env),
...
export function googleColabRuntimeTemplateSoftwareConfigToHclTerraform(struct?: GoogleColabRuntimeTemplateSoftwareConfigOutputReference | GoogleColabRuntimeTemplateSoftwareConfig): any {
  ...
  const attrs = {
    colab_image: {
      value: googleColabRuntimeTemplateSoftwareConfigColabImageToHclTerraform(struct!.colabImage),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleColabRuntimeTemplateSoftwareConfigColabImageList",
    },
    env: {
      value: cdktn.listMapperHcl(googleColabRuntimeTemplateSoftwareConfigEnvToHclTerraform, true)(struct!.env),
      isBlock: true,
      type: "list",
...
export class GoogleColabRuntimeTemplateSoftwareConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleColabRuntimeTemplateSoftwareConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._colabImage?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.colabImage = this._colabImage?.internalValue;
    }
  ...
  public set internalValue(value: GoogleColabRuntimeTemplateSoftwareConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._colabImage.internalValue = undefined;
      this._env.internalValue = undefined;
      this._postStartupScriptConfig.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._colabImage.internalValue = value.colabImage;
      this._env.internalValue = value.env;
      this._postStartupScriptConfig.internalValue = value.postStartupScriptConfig;
    }
  }

  // colab_image - computed: false, optional: true, required: false
  private _colabImage = new GoogleColabRuntimeTemplateSoftwareConfigColabImageOutputReference(this, "colab_image");
  public get colabImage() {
    return this._colabImage;
  }
  public putColabImage(value: GoogleColabRuntimeTemplateSoftwareConfigColabImage) {
    this._colabImage.internalValue = value;
  }
  public resetColabImage() {
    this._colabImage.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get colabImageInput() {
    return this._colabImage.internalValue;
  }
  ...
  public putEnv(value: GoogleColabRuntimeTemplateSoftwareConfigEnv[] | cdktn.IResolvable) {
...
export interface GoogleColabRuntimeTemplateTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#create GoogleColabRuntimeTemplate#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#delete GoogleColabRuntimeTemplate#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#update GoogleColabRuntimeTemplate#update}
  */
...
export class GoogleColabRuntimeTemplateTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleColabRuntimeTemplateTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleColabRuntimeTemplateTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template google_colab_runtime_template}
*/
export class GoogleColabRuntimeTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleColabRuntimeTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_colab_runtime_template google_colab_runtime_template} Resource
  *
  * @param scope The scope in which to define this construct
