...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_access_context_manager_service_perimeter_ingress_policy
...
export interface GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint {
  /**
...
export function googleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointToTerraform(struct?: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointOutputReference | GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint): any {
...
export function googleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointToHclTerraform(struct?: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointOutputReference | GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint | undefined {
  ...
  public set internalValue(value: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint | undefined) {
    if (value === undefined) {
...
export interface GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSources {
  ...
  */
  readonly pscEndpoint?: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint;
}
...
export function googleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesToTerraform(struct?: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSources | cdktn.IResolvable): any {
  ...
  return {
    ...
    psc_endpoint: googleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointToTerraform(struct!.pscEndpoint),
  }
}
...
export function googleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesToHclTerraform(struct?: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSources | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    psc_endpoint: {
      value: googleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointToHclTerraform(struct!.pscEndpoint),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointList",
    },
  };
...
export class GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _pscEndpoint = new GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpointOutputReference(this, "psc_endpoint");
  public get pscEndpoint() {
    return this._pscEndpoint;
  }
  public putPscEndpoint(value: GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromSourcesPscEndpoint) {
...
export class GoogleAccessContextManagerServicePerimeterIngressPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleAccessContextManagerServicePerimeterIngressPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_access_context_manager_service_perimeter_ingress_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_access_context_manager_service_perimeter_ingress_policy google_access_context_manager_service_perimeter_ingress_policy} Resource
  *
  * @param scope The scope in which to define this construct
