...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_scc_v2_project_notification_config
...
export interface GoogleSccV2ProjectNotificationConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleSccV2ProjectNotificationConfigStreamingConfigOutputReference extends cdktf.ComplexObject {
...
export function googleSccV2ProjectNotificationConfigTimeoutsToTerraform(struct?: GoogleSccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleSccV2ProjectNotificationConfigTimeoutsToHclTerraform(struct?: GoogleSccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccV2ProjectNotificationConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleSccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleSccV2ProjectNotificationConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSccV2ProjectNotificationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_scc_v2_project_notification_config#import import section} in the documentation of this resource for the id to use
