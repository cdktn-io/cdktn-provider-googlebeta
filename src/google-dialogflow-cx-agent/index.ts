...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dialogflow_cx_agent
...
export class GoogleDialogflowCxAgentGenAppBuilderSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDialogflowCxAgentGenAppBuilderSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleDialogflowCxAgentGenAppBuilderSettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleDialogflowCxAgent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDialogflowCxAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dialogflow_cx_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_dialogflow_cx_agent google_dialogflow_cx_agent} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putGenAppBuilderSettings(value: GoogleDialogflowCxAgentGenAppBuilderSettings) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      gen_app_builder_settings: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "GoogleDialogflowCxAgentGenAppBuilderSettingsList",
      },
