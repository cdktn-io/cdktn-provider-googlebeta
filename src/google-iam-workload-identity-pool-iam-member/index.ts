...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_iam_workload_identity_pool_iam_member
...
export interface GoogleIamWorkloadIdentityPoolIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleIamWorkloadIdentityPoolIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIamWorkloadIdentityPoolIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleIamWorkloadIdentityPoolIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIamWorkloadIdentityPoolIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIamWorkloadIdentityPoolIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_iam_workload_identity_pool_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_iam_workload_identity_pool_iam_member", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_iam_workload_identity_pool_iam_member google_iam_workload_identity_pool_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleIamWorkloadIdentityPoolIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIamWorkloadIdentityPoolIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleIamWorkloadIdentityPoolIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleIamWorkloadIdentityPoolIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleIamWorkloadIdentityPoolIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleIamWorkloadIdentityPoolIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleIamWorkloadIdentityPoolIamMemberConditionList",
      },
    };
