...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_compute_target_https_proxy
...
export class DataGoogleComputeTargetHttpsProxy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeTargetHttpsProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_compute_target_https_proxy#import import section} in the documentation of this resource for the id to use
