...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_kms_crypto_key
...
export interface DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicy {
}

export function dataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyToTerraform(struct?: DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicy): any {
...
export function dataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyToHclTerraform(struct?: DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicy | undefined) {
    if (value === undefined) {
  ...
  // allowed_access_reasons - computed: true, optional: false, required: false
  public get allowedAccessReasons() {
    return this.getListAttribute('allowed_access_reasons');
  }
}

export class DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyOutputReference {
    return new DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleKmsCryptoKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsCryptoKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_kms_crypto_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_kms_crypto_key google_kms_crypto_key} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // key_access_justifications_policy - computed: true, optional: false, required: false
  private _keyAccessJustificationsPolicy = new DataGoogleKmsCryptoKeyKeyAccessJustificationsPolicyList(this, "key_access_justifications_policy", false);
