...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_iap_agent_registry_mcp_server_iam_policy
...
export interface GoogleIapAgentRegistryMcpServerIamPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class GoogleIapAgentRegistryMcpServerIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleIapAgentRegistryMcpServerIamPolicy to import
  * @param importFromId The id of the existing GoogleIapAgentRegistryMcpServerIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_iap_agent_registry_mcp_server_iam_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleIapAgentRegistryMcpServerIamPolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_iap_agent_registry_mcp_server_iam_policy google_iap_agent_registry_mcp_server_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleIapAgentRegistryMcpServerIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIapAgentRegistryMcpServerIamPolicyConfig) {
    super(scope, id, {
