...
export function googleComputeNetworkPeeringRoutesConfigTimeoutsToTerraform(struct?: GoogleComputeNetworkPeeringRoutesConfigTimeouts | cdktf.IResolvable): any {
...
export function googleComputeNetworkPeeringRoutesConfigTimeoutsToHclTerraform(struct?: GoogleComputeNetworkPeeringRoutesConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeNetworkPeeringRoutesConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeNetworkPeeringRoutesConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeNetworkPeeringRoutesConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
