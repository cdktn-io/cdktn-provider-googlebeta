...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs
...
export class GoogleBetaProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing GoogleBetaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs#import import section} in the documentation of this resource for the id to use
