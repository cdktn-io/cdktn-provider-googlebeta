...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_gemini_repository_group_iam_binding
...
export interface GoogleGeminiRepositoryGroupIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleGeminiRepositoryGroupIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleGeminiRepositoryGroupIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleGeminiRepositoryGroupIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_gemini_repository_group_iam_binding#import import section} in the documentation of this resource for the id to use
