...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_bigquery_routine_iam_binding
...
export interface GoogleBigqueryRoutineIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleBigqueryRoutineIamBindingCondition;
}
export interface GoogleBigqueryRoutineIamBindingCondition {
  /**
...
export function googleBigqueryRoutineIamBindingConditionToTerraform(struct?: GoogleBigqueryRoutineIamBindingConditionOutputReference | GoogleBigqueryRoutineIamBindingCondition): any {
...
export function googleBigqueryRoutineIamBindingConditionToHclTerraform(struct?: GoogleBigqueryRoutineIamBindingConditionOutputReference | GoogleBigqueryRoutineIamBindingCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleBigqueryRoutineIamBindingConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryRoutineIamBindingCondition | undefined {
  ...
  public set internalValue(value: GoogleBigqueryRoutineIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBigqueryRoutineIamBinding extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_bigquery_routine_iam_binding";
  ...
  * @param importToId The construct id used in the generated config for the GoogleBigqueryRoutineIamBinding to import
  * @param importFromId The id of the existing GoogleBigqueryRoutineIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_bigquery_routine_iam_binding#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleBigqueryRoutineIamBinding to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_bigquery_routine_iam_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.36.0/docs/resources/google_bigquery_routine_iam_binding google_bigquery_routine_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleBigqueryRoutineIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBigqueryRoutineIamBindingConfig) {
    super(scope, id, {
      terraformResourceType: 'google_bigquery_routine_iam_binding',
  ...
  private _condition = new GoogleBigqueryRoutineIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleBigqueryRoutineIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleBigqueryRoutineIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleBigqueryRoutineIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleBigqueryRoutineIamBindingConditionList",
      },
    };
