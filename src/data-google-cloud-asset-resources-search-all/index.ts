...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_cloud_asset_resources_search_all
...
export interface DataGoogleCloudAssetResourcesSearchAllConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleCloudAssetResourcesSearchAllResultsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleCloudAssetResourcesSearchAllResultsList extends cdktn.ComplexList {
...
*/
export class DataGoogleCloudAssetResourcesSearchAll extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudAssetResourcesSearchAll that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_cloud_asset_resources_search_all#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_cloud_asset_resources_search_all", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_cloud_asset_resources_search_all google_cloud_asset_resources_search_all} Data Source
  *
  * @param scope The scope in which to define this construct
