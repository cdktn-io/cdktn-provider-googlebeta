...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_scc_source_iam_binding
...
export interface GoogleSccSourceIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleSccSourceIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleSccSourceIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSccSourceIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_scc_source_iam_binding#import import section} in the documentation of this resource for the id to use
