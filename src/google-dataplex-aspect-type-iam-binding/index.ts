...
export interface GoogleDataplexAspectTypeIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleDataplexAspectTypeIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleDataplexAspectTypeIamBinding extends cdktf.TerraformResource {
