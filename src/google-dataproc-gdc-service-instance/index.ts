...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_dataproc_gdc_service_instance
...
export interface GoogleDataprocGdcServiceInstanceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class GoogleDataprocGdcServiceInstanceGdceClusterOutputReference extends cdktn.ComplexObject {
...
export class GoogleDataprocGdcServiceInstanceSparkServiceInstanceConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function googleDataprocGdcServiceInstanceTimeoutsToTerraform(struct?: GoogleDataprocGdcServiceInstanceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleDataprocGdcServiceInstanceTimeoutsToHclTerraform(struct?: GoogleDataprocGdcServiceInstanceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleDataprocGdcServiceInstanceTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleDataprocGdcServiceInstanceTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleDataprocGdcServiceInstanceTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleDataprocGdcServiceInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataprocGdcServiceInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_dataproc_gdc_service_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_dataproc_gdc_service_instance google_dataproc_gdc_service_instance} Resource
  *
  * @param scope The scope in which to define this construct
