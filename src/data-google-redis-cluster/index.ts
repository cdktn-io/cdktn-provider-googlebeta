...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_redis_cluster
...
export class DataGoogleRedisCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleRedisCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_redis_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/data-sources/google_redis_cluster google_redis_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // acl_policy - computed: true, optional: false, required: false
  public get aclPolicy() {
    return this.getStringAttribute('acl_policy');
  }
  ...
  // is_acl_policy_in_sync - computed: true, optional: false, required: false
  public get isAclPolicyInSync() {
    return this.getBooleanAttribute('is_acl_policy_in_sync');
  }
