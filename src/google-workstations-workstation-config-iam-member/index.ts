...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_workstations_workstation_config_iam_member
...
export interface GoogleWorkstationsWorkstationConfigIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleWorkstationsWorkstationConfigIamMemberConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleWorkstationsWorkstationConfigIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleWorkstationsWorkstationConfigIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_workstations_workstation_config_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_workstations_workstation_config_iam_member", importId: importFromId, provider });
      }
