...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_project_service_identity
...
export class GoogleProjectServiceIdentity extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleProjectServiceIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_project_service_identity#import import section} in the documentation of this resource for the id to use
