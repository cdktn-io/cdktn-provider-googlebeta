...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_compute_backend_bucket
...
export class DataGoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList extends cdktn.ComplexList {
...
export class DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList extends cdktn.ComplexList {
...
export class DataGoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList extends cdktn.ComplexList {
...
export class DataGoogleComputeBackendBucketCdnPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeBackendBucketCdnPolicyList extends cdktn.ComplexList {
...
export interface DataGoogleComputeBackendBucketParams {
}
...
export class DataGoogleComputeBackendBucketParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleComputeBackendBucketParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleComputeBackendBucketParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleComputeBackendBucketParamsList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGoogleComputeBackendBucketParamsOutputReference {
    return new DataGoogleComputeBackendBucketParamsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleComputeBackendBucket extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeBackendBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_compute_backend_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_compute_backend_bucket google_compute_backend_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new DataGoogleComputeBackendBucketParamsList(this, "params", false);
  public get params() {
    return this._params;
  }
