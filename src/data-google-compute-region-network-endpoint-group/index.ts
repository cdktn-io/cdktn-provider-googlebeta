...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_region_network_endpoint_group
...
export class DataGoogleComputeRegionNetworkEndpointGroupAppEngineOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeRegionNetworkEndpointGroupAppEngineList extends cdktn.ComplexList {
...
export class DataGoogleComputeRegionNetworkEndpointGroupCloudFunctionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeRegionNetworkEndpointGroupCloudFunctionList extends cdktn.ComplexList {
...
export class DataGoogleComputeRegionNetworkEndpointGroupCloudRunOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeRegionNetworkEndpointGroupCloudRunList extends cdktn.ComplexList {
...
export class DataGoogleComputeRegionNetworkEndpointGroupPscDataOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeRegionNetworkEndpointGroupPscDataList extends cdktn.ComplexList {
...
export class DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleComputeRegionNetworkEndpointGroupServerlessDeployment | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleComputeRegionNetworkEndpointGroupServerlessDeployment | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentOutputReference {
    return new DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleComputeRegionNetworkEndpointGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeRegionNetworkEndpointGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_region_network_endpoint_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_region_network_endpoint_group google_compute_region_network_endpoint_group} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // serverless_deployment - computed: true, optional: false, required: false
  private _serverlessDeployment = new DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList(this, "serverless_deployment", false);
