...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances
...
export interface DataGoogleSqlDatabaseInstancesConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#database_version DataGoogleSqlDatabaseInstances#database_version}
  */
  readonly databaseVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#id DataGoogleSqlDatabaseInstances#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#project DataGoogleSqlDatabaseInstances#project}
  */
  readonly project?: string;
  /**
  * To filter out the database instances which are located in this specified region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#region DataGoogleSqlDatabaseInstances#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#state DataGoogleSqlDatabaseInstances#state}
  */
  readonly state?: string;
  /**
  * To filter out the database instances based on the machine type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#tier DataGoogleSqlDatabaseInstances#tier}
  */
  readonly tier?: string;
  /**
  * To filter out the database instances which are located in this specified zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#zone DataGoogleSqlDatabaseInstances#zone}
  */
...
export interface DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfig {
}

export function dataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigToTerraform(struct?: DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigToHclTerraform(struct?: DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigOutputReference {
    return new DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _performanceCaptureConfig = new DataGoogleSqlDatabaseInstancesInstancesSettingsPerformanceCaptureConfigList(this, "performance_capture_config", false);
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances google_sql_database_instances}
*/
export class DataGoogleSqlDatabaseInstances extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSqlDatabaseInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_sql_database_instances google_sql_database_instances} Data Source
  *
  * @param scope The scope in which to define this construct
