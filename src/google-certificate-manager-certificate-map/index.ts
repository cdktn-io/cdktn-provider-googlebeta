...
export class GoogleCertificateManagerCertificateMapGclbTargetsIpConfigsOutputReference extends cdktf.ComplexObject {
...
export class GoogleCertificateManagerCertificateMapGclbTargetsIpConfigsList extends cdktf.ComplexList {
...
export class GoogleCertificateManagerCertificateMapGclbTargetsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleCertificateManagerCertificateMapGclbTargetsList extends cdktf.ComplexList {
...
export function googleCertificateManagerCertificateMapTimeoutsToTerraform(struct?: GoogleCertificateManagerCertificateMapTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleCertificateManagerCertificateMapTimeoutsToHclTerraform(struct?: GoogleCertificateManagerCertificateMapTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleCertificateManagerCertificateMapTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleCertificateManagerCertificateMapTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleCertificateManagerCertificateMapTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleCertificateManagerCertificateMap extends cdktf.TerraformResource {
