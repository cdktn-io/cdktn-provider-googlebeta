...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_resource_manager_lien
...
export function googleResourceManagerLienTimeoutsToTerraform(struct?: GoogleResourceManagerLienTimeouts | cdktf.IResolvable): any {
...
export function googleResourceManagerLienTimeoutsToHclTerraform(struct?: GoogleResourceManagerLienTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleResourceManagerLienTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleResourceManagerLienTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleResourceManagerLienTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleResourceManagerLien extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleResourceManagerLien that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_resource_manager_lien#import import section} in the documentation of this resource for the id to use
