...
export interface GoogleSccV2OrganizationSccBigQueryExportsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleSccV2OrganizationSccBigQueryExportsTimeoutsToTerraform(struct?: GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktf.IResolvable): any {
...
export function googleSccV2OrganizationSccBigQueryExportsTimeoutsToHclTerraform(struct?: GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccV2OrganizationSccBigQueryExportsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSccV2OrganizationSccBigQueryExports extends cdktf.TerraformResource {
