...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_scc_v2_organization_scc_big_query_exports
...
export interface GoogleSccV2OrganizationSccBigQueryExportsConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GoogleSccV2OrganizationSccBigQueryExportsTimeouts;
}
export interface GoogleSccV2OrganizationSccBigQueryExportsTimeouts {
  /**
...
export function googleSccV2OrganizationSccBigQueryExportsTimeoutsToTerraform(struct?: GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktn.IResolvable): any {
...
export function googleSccV2OrganizationSccBigQueryExportsTimeoutsToHclTerraform(struct?: GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccV2OrganizationSccBigQueryExportsTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccV2OrganizationSccBigQueryExportsTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleSccV2OrganizationSccBigQueryExports extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleSccV2OrganizationSccBigQueryExports to import
  * @param importFromId The id of the existing GoogleSccV2OrganizationSccBigQueryExports that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_scc_v2_organization_scc_big_query_exports#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_scc_v2_organization_scc_big_query_exports", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_scc_v2_organization_scc_big_query_exports google_scc_v2_organization_scc_big_query_exports} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleSccV2OrganizationSccBigQueryExportsConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleSccV2OrganizationSccBigQueryExportsConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleSccV2OrganizationSccBigQueryExportsTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleSccV2OrganizationSccBigQueryExportsTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleSccV2OrganizationSccBigQueryExportsTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleSccV2OrganizationSccBigQueryExportsTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleSccV2OrganizationSccBigQueryExportsTimeouts",
      },
    };
