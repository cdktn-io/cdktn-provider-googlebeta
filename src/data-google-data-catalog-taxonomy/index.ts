...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/data-sources/google_data_catalog_taxonomy
...
export interface DataGoogleDataCatalogTaxonomyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataGoogleDataCatalogTaxonomy extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataGoogleDataCatalogTaxonomy to import
  * @param importFromId The id of the existing DataGoogleDataCatalogTaxonomy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/data-sources/google_data_catalog_taxonomy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataGoogleDataCatalogTaxonomy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/data-sources/google_data_catalog_taxonomy google_data_catalog_taxonomy} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataGoogleDataCatalogTaxonomyConfig
  */
  public constructor(scope: Construct, id: string, config: DataGoogleDataCatalogTaxonomyConfig) {
    super(scope, id, {
  ...
  // activated_policy_types - computed: true, optional: false, required: false
