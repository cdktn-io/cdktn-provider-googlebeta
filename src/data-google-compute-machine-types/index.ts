...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_compute_machine_types
...
export class DataGoogleComputeMachineTypesMachineTypesBundledLocalSsdsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGoogleComputeMachineTypesMachineTypesBundledLocalSsds | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleComputeMachineTypesMachineTypesBundledLocalSsds | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // default_interface - computed: true, optional: false, required: false
  public get defaultInterface() {
    return this.getStringAttribute('default_interface');
  }
...
export class DataGoogleComputeMachineTypesMachineTypesBundledLocalSsdsList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGoogleComputeMachineTypesMachineTypesBundledLocalSsdsOutputReference {
    return new DataGoogleComputeMachineTypesMachineTypesBundledLocalSsdsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleComputeMachineTypesMachineTypesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // bundled_local_ssds - computed: true, optional: false, required: false
  private _bundledLocalSsds = new DataGoogleComputeMachineTypesMachineTypesBundledLocalSsdsList(this, "bundled_local_ssds", true);
  public get bundledLocalSsds() {
    return this._bundledLocalSsds;
  }
...
export class DataGoogleComputeMachineTypes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeMachineTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_compute_machine_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/data-sources/google_compute_machine_types google_compute_machine_types} Data Source
  *
  * @param scope The scope in which to define this construct
