...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_privateca_certificate_authority
...
export class DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyIdOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyId | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyId | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyIdList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyIdOutputReference {
    return new DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyIdOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGooglePrivatecaCertificateAuthorityConfigAOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _subjectKeyId = new DataGooglePrivatecaCertificateAuthorityConfigSubjectKeyIdList(this, "subject_key_id", false);
...
export class DataGooglePrivatecaCertificateAuthority extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGooglePrivatecaCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_privateca_certificate_authority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_privateca_certificate_authority google_privateca_certificate_authority} Data Source
  *
  * @param scope The scope in which to define this construct
