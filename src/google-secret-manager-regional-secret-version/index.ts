...
export interface GoogleSecretManagerRegionalSecretVersionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleSecretManagerRegionalSecretVersionCustomerManagedEncryptionOutputReference extends cdktf.ComplexObject {
...
export class GoogleSecretManagerRegionalSecretVersionCustomerManagedEncryptionList extends cdktf.ComplexList {
...
export function googleSecretManagerRegionalSecretVersionTimeoutsToTerraform(struct?: GoogleSecretManagerRegionalSecretVersionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleSecretManagerRegionalSecretVersionTimeoutsToHclTerraform(struct?: GoogleSecretManagerRegionalSecretVersionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSecretManagerRegionalSecretVersionTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleSecretManagerRegionalSecretVersionTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSecretManagerRegionalSecretVersionTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleSecretManagerRegionalSecretVersion extends cdktf.TerraformResource {
