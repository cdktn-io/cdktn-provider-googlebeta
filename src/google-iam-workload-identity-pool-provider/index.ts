...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_iam_workload_identity_pool_provider
...
export interface GoogleIamWorkloadIdentityPoolProviderSaml {
  /**
...
export class GoogleIamWorkloadIdentityPoolProviderSamlOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIamWorkloadIdentityPoolProviderSaml | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleIamWorkloadIdentityPoolProviderSaml | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleIamWorkloadIdentityPoolProvider extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIamWorkloadIdentityPoolProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_iam_workload_identity_pool_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_iam_workload_identity_pool_provider google_iam_workload_identity_pool_provider} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _saml = new GoogleIamWorkloadIdentityPoolProviderSamlOutputReference(this, "saml");
  public get saml() {
    return this._saml;
  }
  public putSaml(value: GoogleIamWorkloadIdentityPoolProviderSaml) {
