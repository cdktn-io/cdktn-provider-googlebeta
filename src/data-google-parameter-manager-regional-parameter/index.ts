...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_parameter_manager_regional_parameter
...
export interface DataGoogleParameterManagerRegionalParameterConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleParameterManagerRegionalParameterPolicyMemberOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleParameterManagerRegionalParameterPolicyMemberList extends cdktn.ComplexList {
...
*/
export class DataGoogleParameterManagerRegionalParameter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleParameterManagerRegionalParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_parameter_manager_regional_parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_parameter_manager_regional_parameter google_parameter_manager_regional_parameter} Data Source
  *
  * @param scope The scope in which to define this construct
