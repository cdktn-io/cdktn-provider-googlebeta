...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_site_verification_owner
...
export class GoogleSiteVerificationOwner extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSiteVerificationOwner that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_site_verification_owner#import import section} in the documentation of this resource for the id to use
