...
export interface GoogleApigeeApiConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleApigeeApiMetaDataOutputReference extends cdktf.ComplexObject {
...
export class GoogleApigeeApiMetaDataList extends cdktf.ComplexList {
...
export function googleApigeeApiTimeoutsToTerraform(struct?: GoogleApigeeApiTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleApigeeApiTimeoutsToHclTerraform(struct?: GoogleApigeeApiTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApigeeApiTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleApigeeApiTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleApigeeApiTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleApigeeApi extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_apigee_api", importId: importFromId, provider });
      }
