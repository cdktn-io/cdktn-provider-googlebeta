...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_clouddeploy_target_iam_member
...
export interface GoogleClouddeployTargetIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleClouddeployTargetIamMemberConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleClouddeployTargetIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleClouddeployTargetIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_clouddeploy_target_iam_member#import import section} in the documentation of this resource for the id to use
