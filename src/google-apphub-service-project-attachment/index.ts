...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_apphub_service_project_attachment
...
export function googleApphubServiceProjectAttachmentTimeoutsToTerraform(struct?: GoogleApphubServiceProjectAttachmentTimeouts | cdktf.IResolvable): any {
...
export function googleApphubServiceProjectAttachmentTimeoutsToHclTerraform(struct?: GoogleApphubServiceProjectAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApphubServiceProjectAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApphubServiceProjectAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleApphubServiceProjectAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleApphubServiceProjectAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApphubServiceProjectAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_apphub_service_project_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleApphubServiceProjectAttachmentConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleApphubServiceProjectAttachmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleApphubServiceProjectAttachmentTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleApphubServiceProjectAttachmentTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleApphubServiceProjectAttachmentTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleApphubServiceProjectAttachmentTimeouts",
      },
    };
