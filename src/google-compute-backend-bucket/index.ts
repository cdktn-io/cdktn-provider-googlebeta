...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket
...
export interface GoogleComputeBackendBucketConfig extends cdktn.TerraformMetaArguments {
  /**
  * Cloud Storage bucket name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#bucket_name GoogleComputeBackendBucket#bucket_name}
  */
  readonly bucketName: string;
  /**
  * Compress text responses using Brotli or gzip compression, based on the client's Accept-Encoding header. Possible values: ["AUTOMATIC", "DISABLED"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#compression_mode GoogleComputeBackendBucket#compression_mode}
  */
  readonly compressionMode?: string;
  /**
  * Headers that the HTTP/S load balancer should add to proxied responses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#custom_response_headers GoogleComputeBackendBucket#custom_response_headers}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#deletion_policy GoogleComputeBackendBucket#deletion_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#description GoogleComputeBackendBucket#description}
  */
  readonly description?: string;
  /**
  * The security policy associated with this backend bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#edge_security_policy GoogleComputeBackendBucket#edge_security_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#enable_cdn GoogleComputeBackendBucket#enable_cdn}
  */
  readonly enableCdn?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#id GoogleComputeBackendBucket#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#load_balancing_scheme GoogleComputeBackendBucket#load_balancing_scheme}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#name GoogleComputeBackendBucket#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#project GoogleComputeBackendBucket#project}
  */
  readonly project?: string;
  /**
  * cdn_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#cdn_policy GoogleComputeBackendBucket#cdn_policy}
  */
  readonly cdnPolicy?: GoogleComputeBackendBucketCdnPolicy;
  /**
  * params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#params GoogleComputeBackendBucket#params}
  */
  readonly params?: GoogleComputeBackendBucketParams;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#timeouts GoogleComputeBackendBucket#timeouts}
  */
  readonly timeouts?: GoogleComputeBackendBucketTimeouts;
}
export interface GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders {
  /**
  * The header field name to match on when bypassing cache. Values are case-insensitive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#header_name GoogleComputeBackendBucket#header_name}
  */
  readonly headerName?: string;
}

export function googleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersToTerraform(struct?: GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders | cdktn.IResolvable): any {
...
export function googleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersToHclTerraform(struct?: GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList extends cdktn.ComplexList {
  public internalValue? : GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders[] | cdktn.IResolvable
  ...
  */
  public get(index: number): GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersOutputReference {
    return new GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy {
  /**
  * Allows HTTP request headers (by name) to be used in the
  * cache key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#include_http_headers GoogleComputeBackendBucket#include_http_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#query_string_whitelist GoogleComputeBackendBucket#query_string_whitelist}
  */
  readonly queryStringWhitelist?: string[];
}

export function googleComputeBackendBucketCdnPolicyCacheKeyPolicyToTerraform(struct?: GoogleComputeBackendBucketCdnPolicyCacheKeyPolicyOutputReference | GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    query_string_whitelist: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.queryStringWhitelist),
  }
}


export function googleComputeBackendBucketCdnPolicyCacheKeyPolicyToHclTerraform(struct?: GoogleComputeBackendBucketCdnPolicyCacheKeyPolicyOutputReference | GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    include_http_headers: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.includeHttpHeaders),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    query_string_whitelist: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.queryStringWhitelist),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class GoogleComputeBackendBucketCdnPolicyCacheKeyPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#code GoogleComputeBackendBucket#code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#ttl GoogleComputeBackendBucket#ttl}
  */
  readonly ttl?: number;
}

export function googleComputeBackendBucketCdnPolicyNegativeCachingPolicyToTerraform(struct?: GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleComputeBackendBucketCdnPolicyNegativeCachingPolicyToHclTerraform(struct?: GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList extends cdktn.ComplexList {
  public internalValue? : GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy[] | cdktn.IResolvable
...
export interface GoogleComputeBackendBucketCdnPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#cache_mode GoogleComputeBackendBucket#cache_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#client_ttl GoogleComputeBackendBucket#client_ttl}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#default_ttl GoogleComputeBackendBucket#default_ttl}
  */
  ...
  * 'cache_mode' is set to "USE_ORIGIN_HEADERS", you must omit this field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#max_ttl GoogleComputeBackendBucket#max_ttl}
  */
  readonly maxTtl?: number;
  /**
  * Negative caching allows per-status code TTLs to be set, in order to apply fine-grained caching for common errors or redirects.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#negative_caching GoogleComputeBackendBucket#negative_caching}
  */
  readonly negativeCaching?: boolean | cdktn.IResolvable;
  /**
  * If true then Cloud CDN will combine multiple concurrent cache fill requests into a small number of requests to the origin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#request_coalescing GoogleComputeBackendBucket#request_coalescing}
  */
  readonly requestCoalescing?: boolean | cdktn.IResolvable;
  /**
  * Serve existing content from the cache (if available) when revalidating content with the origin, or when an error is encountered when refreshing the cache.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#serve_while_stale GoogleComputeBackendBucket#serve_while_stale}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#signed_url_cache_max_age_sec GoogleComputeBackendBucket#signed_url_cache_max_age_sec}
  */
  readonly signedUrlCacheMaxAgeSec?: number;
  /**
  * bypass_cache_on_request_headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#bypass_cache_on_request_headers GoogleComputeBackendBucket#bypass_cache_on_request_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#cache_key_policy GoogleComputeBackendBucket#cache_key_policy}
  */
  readonly cacheKeyPolicy?: GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy;
  /**
  * negative_caching_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#negative_caching_policy GoogleComputeBackendBucket#negative_caching_policy}
  */
...
export function googleComputeBackendBucketCdnPolicyToTerraform(struct?: GoogleComputeBackendBucketCdnPolicyOutputReference | GoogleComputeBackendBucketCdnPolicy): any {
  ...
  return {
    ...
    client_ttl: cdktn.numberToTerraform(struct!.clientTtl),
    ...
    serve_while_stale: cdktn.numberToTerraform(struct!.serveWhileStale),
    signed_url_cache_max_age_sec: cdktn.numberToTerraform(struct!.signedUrlCacheMaxAgeSec),
    bypass_cache_on_request_headers: cdktn.listMapper(googleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersToTerraform, true)(struct!.bypassCacheOnRequestHeaders),
    cache_key_policy: googleComputeBackendBucketCdnPolicyCacheKeyPolicyToTerraform(struct!.cacheKeyPolicy),
    negative_caching_policy: cdktn.listMapper(googleComputeBackendBucketCdnPolicyNegativeCachingPolicyToTerraform, true)(struct!.negativeCachingPolicy),
  }
}


export function googleComputeBackendBucketCdnPolicyToHclTerraform(struct?: GoogleComputeBackendBucketCdnPolicyOutputReference | GoogleComputeBackendBucketCdnPolicy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    client_ttl: {
      value: cdktn.numberToHclTerraform(struct!.clientTtl),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    serve_while_stale: {
      value: cdktn.numberToHclTerraform(struct!.serveWhileStale),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    signed_url_cache_max_age_sec: {
      value: cdktn.numberToHclTerraform(struct!.signedUrlCacheMaxAgeSec),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    bypass_cache_on_request_headers: {
      value: cdktn.listMapperHcl(googleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersToHclTerraform, true)(struct!.bypassCacheOnRequestHeaders),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList",
    },
    cache_key_policy: {
      value: googleComputeBackendBucketCdnPolicyCacheKeyPolicyToHclTerraform(struct!.cacheKeyPolicy),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList",
    },
    negative_caching_policy: {
      value: cdktn.listMapperHcl(googleComputeBackendBucketCdnPolicyNegativeCachingPolicyToHclTerraform, true)(struct!.negativeCachingPolicy),
      isBlock: true,
      type: "list",
      storageClassType: "GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList",
    },
  };
...
export class GoogleComputeBackendBucketCdnPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _bypassCacheOnRequestHeaders = new GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList(this, "bypass_cache_on_request_headers", false);
  public get bypassCacheOnRequestHeaders() {
    return this._bypassCacheOnRequestHeaders;
  }
  public putBypassCacheOnRequestHeaders(value: GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeaders[] | cdktn.IResolvable) {
  ...
  private _cacheKeyPolicy = new GoogleComputeBackendBucketCdnPolicyCacheKeyPolicyOutputReference(this, "cache_key_policy");
  public get cacheKeyPolicy() {
    return this._cacheKeyPolicy;
  }
  public putCacheKeyPolicy(value: GoogleComputeBackendBucketCdnPolicyCacheKeyPolicy) {
  ...
  public putNegativeCachingPolicy(value: GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicy[] | cdktn.IResolvable) {
...
export interface GoogleComputeBackendBucketParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#resource_manager_tags GoogleComputeBackendBucket#resource_manager_tags}
  */
...
export interface GoogleComputeBackendBucketTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#create GoogleComputeBackendBucket#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#delete GoogleComputeBackendBucket#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#update GoogleComputeBackendBucket#update}
  */
  readonly update?: string;
}

export function googleComputeBackendBucketTimeoutsToTerraform(struct?: GoogleComputeBackendBucketTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleComputeBackendBucketTimeoutsToHclTerraform(struct?: GoogleComputeBackendBucketTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleComputeBackendBucketTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): GoogleComputeBackendBucketTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleComputeBackendBucketTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket google_compute_backend_bucket}
*/
export class GoogleComputeBackendBucket extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeBackendBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_compute_backend_bucket", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.38.0/docs/resources/google_compute_backend_bucket google_compute_backend_bucket} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _enableCdn?: boolean | cdktn.IResolvable; 
  public get enableCdn() {
    return this.getBooleanAttribute('enable_cdn');
  }
  public set enableCdn(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      compression_mode: cdktn.stringToTerraform(this._compressionMode),
      custom_response_headers: cdktn.listMapper(cdktn.stringToTerraform, false)(this._customResponseHeaders),
      deletion_policy: cdktn.stringToTerraform(this._deletionPolicy),
      description: cdktn.stringToTerraform(this._description),
      edge_security_policy: cdktn.stringToTerraform(this._edgeSecurityPolicy),
      enable_cdn: cdktn.booleanToTerraform(this._enableCdn),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      compression_mode: {
        value: cdktn.stringToHclTerraform(this._compressionMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      custom_response_headers: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._customResponseHeaders),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      ...
      enable_cdn: {
        value: cdktn.booleanToHclTerraform(this._enableCdn),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      cdn_policy: {
        value: googleComputeBackendBucketCdnPolicyToHclTerraform(this._cdnPolicy.internalValue),
        isBlock: true,
        type: "list",
      ...
      timeouts: {
        ...
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeBackendBucketTimeouts",
      },
    };
