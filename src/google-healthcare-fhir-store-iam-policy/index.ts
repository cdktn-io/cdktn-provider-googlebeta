...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_healthcare_fhir_store_iam_policy
...
export class GoogleHealthcareFhirStoreIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleHealthcareFhirStoreIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_healthcare_fhir_store_iam_policy#import import section} in the documentation of this resource for the id to use
