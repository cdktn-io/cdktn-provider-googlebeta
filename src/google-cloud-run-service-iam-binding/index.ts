...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_cloud_run_service_iam_binding
...
export interface GoogleCloudRunServiceIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleCloudRunServiceIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleCloudRunServiceIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleCloudRunServiceIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_cloud_run_service_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_cloud_run_service_iam_binding", importId: importFromId, provider });
      }
