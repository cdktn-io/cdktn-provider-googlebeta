...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_compute_region_commitment
...
export interface GoogleComputeRegionCommitmentConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly params?: GoogleComputeRegionCommitmentParams;
  /**
  * resources block
  *
...
export class GoogleComputeRegionCommitmentLicenseResourceOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionCommitmentLicenseResource | undefined {
  ...
  public set internalValue(value: GoogleComputeRegionCommitmentLicenseResource | undefined) {
    if (value === undefined) {
...
export interface GoogleComputeRegionCommitmentParams {
  /**
...
export function googleComputeRegionCommitmentParamsToTerraform(struct?: GoogleComputeRegionCommitmentParamsOutputReference | GoogleComputeRegionCommitmentParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleComputeRegionCommitmentParamsToHclTerraform(struct?: GoogleComputeRegionCommitmentParamsOutputReference | GoogleComputeRegionCommitmentParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleComputeRegionCommitmentParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionCommitmentParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeRegionCommitmentParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleComputeRegionCommitmentResourcesList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleComputeRegionCommitmentResourcesOutputReference {
    return new GoogleComputeRegionCommitmentResourcesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleComputeRegionCommitment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeRegionCommitment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_compute_region_commitment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_compute_region_commitment google_compute_region_commitment} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleComputeRegionCommitmentConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeRegionCommitmentConfig) {
    super(scope, id, {
  ...
  // existing_reservations - computed: false, optional: true, required: false
  ...
  private _licenseResource = new GoogleComputeRegionCommitmentLicenseResourceOutputReference(this, "license_resource");
  public get licenseResource() {
    return this._licenseResource;
  }
  public putLicenseResource(value: GoogleComputeRegionCommitmentLicenseResource) {
  ...
  private _params = new GoogleComputeRegionCommitmentParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: GoogleComputeRegionCommitmentParams) {
  ...
  private _resources = new GoogleComputeRegionCommitmentResourcesList(this, "resources", false);
  ...
  private _timeouts = new GoogleComputeRegionCommitmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeRegionCommitmentTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      params: googleComputeRegionCommitmentParamsToTerraform(this._params.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      license_resource: {
        value: googleComputeRegionCommitmentLicenseResourceToHclTerraform(this._licenseResource.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeRegionCommitmentLicenseResourceList",
      },
      params: {
        value: googleComputeRegionCommitmentParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeRegionCommitmentParamsList",
      },
      resources: {
      ...
      timeouts: {
        value: googleComputeRegionCommitmentTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeRegionCommitmentTimeouts",
      },
    };
