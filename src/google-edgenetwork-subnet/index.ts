...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_edgenetwork_subnet
...
export function googleEdgenetworkSubnetTimeoutsToTerraform(struct?: GoogleEdgenetworkSubnetTimeouts | cdktf.IResolvable): any {
...
export function googleEdgenetworkSubnetTimeoutsToHclTerraform(struct?: GoogleEdgenetworkSubnetTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleEdgenetworkSubnetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleEdgenetworkSubnetTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleEdgenetworkSubnetTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleEdgenetworkSubnet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleEdgenetworkSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_edgenetwork_subnet#import import section} in the documentation of this resource for the id to use
