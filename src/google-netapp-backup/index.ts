...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_netapp_backup
...
export interface GoogleNetappBackupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleNetappBackupTimeoutsToTerraform(struct?: GoogleNetappBackupTimeouts | cdktf.IResolvable): any {
...
export function googleNetappBackupTimeoutsToHclTerraform(struct?: GoogleNetappBackupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetappBackupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetappBackupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetappBackupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleNetappBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetappBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_netapp_backup#import import section} in the documentation of this resource for the id to use
