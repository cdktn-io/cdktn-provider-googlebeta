...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_netapp_backup
...
export function googleNetappBackupTimeoutsToTerraform(struct?: GoogleNetappBackupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleNetappBackupTimeoutsToHclTerraform(struct?: GoogleNetappBackupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleNetappBackupTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleNetappBackupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetappBackupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleNetappBackup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetappBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_netapp_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_netapp_backup google_netapp_backup} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleNetappBackupConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleNetappBackupConfig) {
    super(scope, id, {
  ...
  public putTimeouts(value: GoogleNetappBackupTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        ...
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleNetappBackupTimeouts",
      },
    };
