...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_compute_network_attachment
...
export interface DataGoogleComputeNetworkAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleComputeNetworkAttachmentConnectionEndpointsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeNetworkAttachmentConnectionEndpointsList extends cdktn.ComplexList {
...
*/
export class DataGoogleComputeNetworkAttachment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeNetworkAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_compute_network_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_compute_network_attachment google_compute_network_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
