...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_tpu_node
...
export interface GoogleTpuNodeConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function googleTpuNodeNetworkEndpointsToHclTerraform(struct?: GoogleTpuNodeNetworkEndpoints): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleTpuNodeNetworkEndpointsOutputReference extends cdktn.ComplexObject {
...
export class GoogleTpuNodeNetworkEndpointsList extends cdktn.ComplexList {
...
export function googleTpuNodeSchedulingConfigToHclTerraform(struct?: GoogleTpuNodeSchedulingConfigOutputReference | GoogleTpuNodeSchedulingConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleTpuNodeSchedulingConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function googleTpuNodeTimeoutsToTerraform(struct?: GoogleTpuNodeTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleTpuNodeTimeoutsToHclTerraform(struct?: GoogleTpuNodeTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleTpuNodeTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleTpuNodeTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleTpuNodeTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleTpuNode extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleTpuNode to import
  * @param importFromId The id of the existing GoogleTpuNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_tpu_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scheduling_config: {
        value: googleTpuNodeSchedulingConfigToHclTerraform(this._schedulingConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleTpuNodeSchedulingConfigList",
      },
      timeouts: {
        value: googleTpuNodeTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleTpuNodeTimeouts",
      },
    };
