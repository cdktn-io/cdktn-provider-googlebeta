...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_migration_center_report_config
...
export interface GoogleMigrationCenterReportConfigConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class GoogleMigrationCenterReportConfig extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GoogleMigrationCenterReportConfig to import
  * @param importFromId The id of the existing GoogleMigrationCenterReportConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_migration_center_report_config#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleMigrationCenterReportConfig to import is found
  */
  ...
  * @param options GoogleMigrationCenterReportConfigConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleMigrationCenterReportConfigConfig) {
    super(scope, id, {
