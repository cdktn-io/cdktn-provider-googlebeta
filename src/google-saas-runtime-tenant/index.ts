...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_saas_runtime_tenant
...
export class GoogleSaasRuntimeTenant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSaasRuntimeTenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_saas_runtime_tenant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_saas_runtime_tenant google_saas_runtime_tenant} Resource
  *
  * @param scope The scope in which to define this construct
