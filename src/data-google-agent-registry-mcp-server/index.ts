...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/data-sources/google_agent_registry_mcp_server
...
export class DataGoogleAgentRegistryMcpServer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleAgentRegistryMcpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/data-sources/google_agent_registry_mcp_server#import import section} in the documentation of this resource for the id to use
