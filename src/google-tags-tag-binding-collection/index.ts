...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_tags_tag_binding_collection
...
export class GoogleTagsTagBindingCollection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleTagsTagBindingCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_tags_tag_binding_collection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_tags_tag_binding_collection google_tags_tag_binding_collection} Resource
  *
  * @param scope The scope in which to define this construct
