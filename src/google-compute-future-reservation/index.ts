...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_future_reservation
...
export interface GoogleComputeFutureReservationParams {
  /**
...
export class GoogleComputeFutureReservationParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeFutureReservationParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeFutureReservationParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleComputeFutureReservation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeFutureReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_future_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_future_reservation google_compute_future_reservation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new GoogleComputeFutureReservationParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: GoogleComputeFutureReservationParams) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      params: googleComputeFutureReservationParamsToTerraform(this._params.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      params: {
        value: googleComputeFutureReservationParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeFutureReservationParamsList",
      },
      share_settings: {
