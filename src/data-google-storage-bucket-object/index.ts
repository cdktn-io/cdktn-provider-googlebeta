...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_storage_bucket_object
...
export interface DataGoogleStorageBucketObjectConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DataGoogleStorageBucketObjectContextsCustom {
}

export function dataGoogleStorageBucketObjectContextsCustomToTerraform(struct?: DataGoogleStorageBucketObjectContextsCustom): any {
...
export function dataGoogleStorageBucketObjectContextsCustomToHclTerraform(struct?: DataGoogleStorageBucketObjectContextsCustom): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGoogleStorageBucketObjectContextsCustomOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGoogleStorageBucketObjectContextsCustom | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleStorageBucketObjectContextsCustom | undefined) {
    if (value === undefined) {
...
export class DataGoogleStorageBucketObjectContextsCustomList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleStorageBucketObjectContextsCustomOutputReference {
    return new DataGoogleStorageBucketObjectContextsCustomOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataGoogleStorageBucketObjectContexts {
}

export function dataGoogleStorageBucketObjectContextsToTerraform(struct?: DataGoogleStorageBucketObjectContexts): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataGoogleStorageBucketObjectContextsToHclTerraform(struct?: DataGoogleStorageBucketObjectContexts): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGoogleStorageBucketObjectContextsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleStorageBucketObjectContexts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleStorageBucketObjectContexts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _custom = new DataGoogleStorageBucketObjectContextsCustomList(this, "custom", false);
  public get custom() {
    return this._custom;
  }
}

export class DataGoogleStorageBucketObjectContextsList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGoogleStorageBucketObjectContextsOutputReference {
    return new DataGoogleStorageBucketObjectContextsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleStorageBucketObjectCustomerEncryptionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleStorageBucketObjectCustomerEncryptionList extends cdktn.ComplexList {
...
export class DataGoogleStorageBucketObjectRetentionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleStorageBucketObjectRetentionList extends cdktn.ComplexList {
...
*/
export class DataGoogleStorageBucketObject extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleStorageBucketObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_storage_bucket_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_storage_bucket_object google_storage_bucket_object} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _contexts = new DataGoogleStorageBucketObjectContextsList(this, "contexts", false);
  public get contexts() {
