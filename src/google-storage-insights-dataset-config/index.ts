...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_storage_insights_dataset_config
...
export class GoogleStorageInsightsDatasetConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleStorageInsightsDatasetConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_storage_insights_dataset_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_storage_insights_dataset_config google_storage_insights_dataset_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // activity_data_retention_period_days - computed: true, optional: true, required: false
  private _activityDataRetentionPeriodDays?: number; 
  public get activityDataRetentionPeriodDays() {
    return this.getNumberAttribute('activity_data_retention_period_days');
  }
  public set activityDataRetentionPeriodDays(value: number) {
    this._activityDataRetentionPeriodDays = value;
  }
  public resetActivityDataRetentionPeriodDays() {
    this._activityDataRetentionPeriodDays = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get activityDataRetentionPeriodDaysInput() {
    return this._activityDataRetentionPeriodDays;
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      activity_data_retention_period_days: {
        value: cdktn.numberToHclTerraform(this._activityDataRetentionPeriodDays),
        isBlock: false,
        type: "simple",
