...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_organization_iam_custom_role
...
export class DataGoogleOrganizationIamCustomRole extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOrganizationIamCustomRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_organization_iam_custom_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_organization_iam_custom_role google_organization_iam_custom_role} Data Source
  *
  * @param scope The scope in which to define this construct
