...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_container_azure_client
...
export interface GoogleContainerAzureClientConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function googleContainerAzureClientTimeoutsToTerraform(struct?: GoogleContainerAzureClientTimeouts | cdktn.IResolvable): any {
...
export function googleContainerAzureClientTimeoutsToHclTerraform(struct?: GoogleContainerAzureClientTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleContainerAzureClientTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleContainerAzureClientTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleContainerAzureClientTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleContainerAzureClient extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleContainerAzureClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_container_azure_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_container_azure_client", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/resources/google_container_azure_client google_container_azure_client} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleContainerAzureClientTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleContainerAzureClientTimeouts",
      },
    };
