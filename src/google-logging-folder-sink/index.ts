...
export class GoogleLoggingFolderSinkExclusionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleLoggingFolderSinkExclusions | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleLoggingFolderSinkExclusions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleLoggingFolderSinkExclusionsList extends cdktf.ComplexList {
  public internalValue? : GoogleLoggingFolderSinkExclusions[] | cdktf.IResolvable
...
export class GoogleLoggingFolderSink extends cdktf.TerraformResource {
  ...
  */
  ...
  public putExclusions(value: GoogleLoggingFolderSinkExclusions[] | cdktf.IResolvable) {
