...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_apigee_api_deployment
...
export class GoogleApigeeApiDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApigeeApiDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_apigee_api_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_apigee_api_deployment google_apigee_api_deployment} Resource
  *
  * @param scope The scope in which to define this construct
