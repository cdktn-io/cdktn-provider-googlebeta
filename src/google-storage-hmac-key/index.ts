...
export function googleStorageHmacKeyTimeoutsToHclTerraform(struct?: GoogleStorageHmacKeyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleStorageHmacKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: GoogleStorageHmacKeyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleStorageHmacKey extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_storage_hmac_key", importId: importFromId, provider });
      }
