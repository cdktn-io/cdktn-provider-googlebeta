...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_dataplex_data_product_iam_policy
...
export class GoogleDataplexDataProductIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataplexDataProductIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_dataplex_data_product_iam_policy#import import section} in the documentation of this resource for the id to use
