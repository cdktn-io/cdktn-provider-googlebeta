...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_iap_web_backend_service_iam_policy
...
export class DataGoogleIapWebBackendServiceIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleIapWebBackendServiceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/data-sources/google_iap_web_backend_service_iam_policy#import import section} in the documentation of this resource for the id to use
