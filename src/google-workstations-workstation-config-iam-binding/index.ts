...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_workstations_workstation_config_iam_binding
...
export interface GoogleWorkstationsWorkstationConfigIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleWorkstationsWorkstationConfigIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleWorkstationsWorkstationConfigIamBinding extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_workstations_workstation_config_iam_binding", importId: importFromId, provider });
      }
