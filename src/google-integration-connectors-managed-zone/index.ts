...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_integration_connectors_managed_zone
...
export interface GoogleIntegrationConnectorsManagedZoneConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleIntegrationConnectorsManagedZoneTimeoutsToTerraform(struct?: GoogleIntegrationConnectorsManagedZoneTimeouts | cdktf.IResolvable): any {
...
export function googleIntegrationConnectorsManagedZoneTimeoutsToHclTerraform(struct?: GoogleIntegrationConnectorsManagedZoneTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIntegrationConnectorsManagedZoneTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIntegrationConnectorsManagedZoneTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleIntegrationConnectorsManagedZoneTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIntegrationConnectorsManagedZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIntegrationConnectorsManagedZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_integration_connectors_managed_zone#import import section} in the documentation of this resource for the id to use
