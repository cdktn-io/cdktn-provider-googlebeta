...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_compute_snapshot
...
export class DataGoogleComputeSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_compute_snapshot#import import section} in the documentation of this resource for the id to use
