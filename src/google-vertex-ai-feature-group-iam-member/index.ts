...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_vertex_ai_feature_group_iam_member
...
export interface GoogleVertexAiFeatureGroupIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleVertexAiFeatureGroupIamMemberCondition;
}
export interface GoogleVertexAiFeatureGroupIamMemberCondition {
  /**
...
export function googleVertexAiFeatureGroupIamMemberConditionToTerraform(struct?: GoogleVertexAiFeatureGroupIamMemberConditionOutputReference | GoogleVertexAiFeatureGroupIamMemberCondition): any {
...
export function googleVertexAiFeatureGroupIamMemberConditionToHclTerraform(struct?: GoogleVertexAiFeatureGroupIamMemberConditionOutputReference | GoogleVertexAiFeatureGroupIamMemberCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleVertexAiFeatureGroupIamMemberConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVertexAiFeatureGroupIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleVertexAiFeatureGroupIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleVertexAiFeatureGroupIamMember extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_vertex_ai_feature_group_iam_member";
  ...
  * @param importToId The construct id used in the generated config for the GoogleVertexAiFeatureGroupIamMember to import
  * @param importFromId The id of the existing GoogleVertexAiFeatureGroupIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_vertex_ai_feature_group_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_vertex_ai_feature_group_iam_member", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/resources/google_vertex_ai_feature_group_iam_member google_vertex_ai_feature_group_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleVertexAiFeatureGroupIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleVertexAiFeatureGroupIamMemberConfig) {
    super(scope, id, {
      terraformResourceType: 'google_vertex_ai_feature_group_iam_member',
  ...
  private _condition = new GoogleVertexAiFeatureGroupIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleVertexAiFeatureGroupIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      feature_group: cdktn.stringToTerraform(this._featureGroup),
      id: cdktn.stringToTerraform(this._id),
      member: cdktn.stringToTerraform(this._member),
      project: cdktn.stringToTerraform(this._project),
      region: cdktn.stringToTerraform(this._region),
      role: cdktn.stringToTerraform(this._role),
      condition: googleVertexAiFeatureGroupIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      feature_group: {
        value: cdktn.stringToHclTerraform(this._featureGroup),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      condition: {
        value: googleVertexAiFeatureGroupIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleVertexAiFeatureGroupIamMemberConditionList",
      },
    };
