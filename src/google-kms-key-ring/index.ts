...
export function googleKmsKeyRingTimeoutsToTerraform(struct?: GoogleKmsKeyRingTimeouts | cdktf.IResolvable): any {
...
export function googleKmsKeyRingTimeoutsToHclTerraform(struct?: GoogleKmsKeyRingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleKmsKeyRingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleKmsKeyRingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleKmsKeyRingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
