...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_biglake_hive_database_iam_member
...
export interface GoogleBiglakeHiveDatabaseIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleBiglakeHiveDatabaseIamMemberCondition;
}
export interface GoogleBiglakeHiveDatabaseIamMemberCondition {
  /**
...
export function googleBiglakeHiveDatabaseIamMemberConditionToTerraform(struct?: GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference | GoogleBiglakeHiveDatabaseIamMemberCondition): any {
...
export function googleBiglakeHiveDatabaseIamMemberConditionToHclTerraform(struct?: GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference | GoogleBiglakeHiveDatabaseIamMemberCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBiglakeHiveDatabaseIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleBiglakeHiveDatabaseIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBiglakeHiveDatabaseIamMember extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_biglake_hive_database_iam_member";
  ...
  * @param importToId The construct id used in the generated config for the GoogleBiglakeHiveDatabaseIamMember to import
  * @param importFromId The id of the existing GoogleBiglakeHiveDatabaseIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_biglake_hive_database_iam_member#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleBiglakeHiveDatabaseIamMember to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_biglake_hive_database_iam_member", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_biglake_hive_database_iam_member google_biglake_hive_database_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleBiglakeHiveDatabaseIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBiglakeHiveDatabaseIamMemberConfig) {
    super(scope, id, {
      terraformResourceType: 'google_biglake_hive_database_iam_member',
  ...
  private _condition = new GoogleBiglakeHiveDatabaseIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleBiglakeHiveDatabaseIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleBiglakeHiveDatabaseIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleBiglakeHiveDatabaseIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleBiglakeHiveDatabaseIamMemberConditionList",
      },
    };
