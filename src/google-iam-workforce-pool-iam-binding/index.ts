...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_iam_workforce_pool_iam_binding
...
export interface GoogleIamWorkforcePoolIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleIamWorkforcePoolIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleIamWorkforcePoolIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleIamWorkforcePoolIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_iam_workforce_pool_iam_binding#import import section} in the documentation of this resource for the id to use
