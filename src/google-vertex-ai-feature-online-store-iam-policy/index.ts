...
export interface GoogleVertexAiFeatureOnlineStoreIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleVertexAiFeatureOnlineStoreIamPolicy extends cdktf.TerraformResource {
