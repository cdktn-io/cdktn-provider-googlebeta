...
export interface GoogleEventarcMessageBusConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleEventarcMessageBusLoggingConfigOutputReference extends cdktf.ComplexObject {
...
export function googleEventarcMessageBusTimeoutsToTerraform(struct?: GoogleEventarcMessageBusTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleEventarcMessageBusTimeoutsToHclTerraform(struct?: GoogleEventarcMessageBusTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleEventarcMessageBusTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleEventarcMessageBusTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleEventarcMessageBusTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleEventarcMessageBus extends cdktf.TerraformResource {
