...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_vertex_ai_feature_group_feature
...
export interface GoogleVertexAiFeatureGroupFeatureConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function googleVertexAiFeatureGroupFeatureTimeoutsToTerraform(struct?: GoogleVertexAiFeatureGroupFeatureTimeouts | cdktn.IResolvable): any {
...
export function googleVertexAiFeatureGroupFeatureTimeoutsToHclTerraform(struct?: GoogleVertexAiFeatureGroupFeatureTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleVertexAiFeatureGroupFeatureTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleVertexAiFeatureGroupFeatureTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleVertexAiFeatureGroupFeatureTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleVertexAiFeatureGroupFeature extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleVertexAiFeatureGroupFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_vertex_ai_feature_group_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_vertex_ai_feature_group_feature google_vertex_ai_feature_group_feature} Resource
  *
  * @param scope The scope in which to define this construct
