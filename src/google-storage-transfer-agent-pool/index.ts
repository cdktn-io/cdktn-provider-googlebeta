...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_storage_transfer_agent_pool
...
export class GoogleStorageTransferAgentPool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleStorageTransferAgentPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_storage_transfer_agent_pool#import import section} in the documentation of this resource for the id to use
