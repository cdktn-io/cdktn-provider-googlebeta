...
export class GoogleBeyondcorpApplicationIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
export class GoogleBeyondcorpApplicationIamBinding extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_beyondcorp_application_iam_binding", importId: importFromId, provider });
      }
