...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_beyondcorp_application_iam_binding
...
export interface GoogleBeyondcorpApplicationIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function googleBeyondcorpApplicationIamBindingConditionToTerraform(struct?: GoogleBeyondcorpApplicationIamBindingConditionOutputReference | GoogleBeyondcorpApplicationIamBindingCondition): any {
...
export function googleBeyondcorpApplicationIamBindingConditionToHclTerraform(struct?: GoogleBeyondcorpApplicationIamBindingConditionOutputReference | GoogleBeyondcorpApplicationIamBindingCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBeyondcorpApplicationIamBindingConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBeyondcorpApplicationIamBindingCondition | undefined {
  ...
  public set internalValue(value: GoogleBeyondcorpApplicationIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleBeyondcorpApplicationIamBinding extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_beyondcorp_application_iam_binding";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_beyondcorp_application_iam_binding", importId: importFromId, provider });
      }
  ...
  * @param options GoogleBeyondcorpApplicationIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleBeyondcorpApplicationIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleBeyondcorpApplicationIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleBeyondcorpApplicationIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleBeyondcorpApplicationIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleBeyondcorpApplicationIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleBeyondcorpApplicationIamBindingConditionList",
      },
    };
