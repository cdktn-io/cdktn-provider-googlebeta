...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_parameter_manager_parameter
...
export interface GoogleParameterManagerParameterConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleParameterManagerParameterPolicyMemberOutputReference extends cdktf.ComplexObject {
...
export class GoogleParameterManagerParameterPolicyMemberList extends cdktf.ComplexList {
...
export function googleParameterManagerParameterTimeoutsToTerraform(struct?: GoogleParameterManagerParameterTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleParameterManagerParameterTimeoutsToHclTerraform(struct?: GoogleParameterManagerParameterTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleParameterManagerParameterTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleParameterManagerParameterTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleParameterManagerParameterTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleParameterManagerParameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleParameterManagerParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_parameter_manager_parameter#import import section} in the documentation of this resource for the id to use
