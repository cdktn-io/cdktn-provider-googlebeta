...
export * as googleApigeeApiDeployment from './google-apigee-api-deployment';
export * as googleApigeeApiProduct from './google-apigee-api-product';
...
export * as googleApigeeDeveloperApp from './google-apigee-developer-app';
...
export * as googleApigeeEnvironmentApiRevisionDeployment from './google-apigee-environment-api-revision-deployment';
...
export * as googleApigeeSecurityAction from './google-apigee-security-action';
export * as googleApigeeSecurityFeedback from './google-apigee-security-feedback';
export * as googleApigeeSecurityMonitoringCondition from './google-apigee-security-monitoring-condition';
...
export * as googleApigeeSpace from './google-apigee-space';
...
export * as googleApihubPlugin from './google-apihub-plugin';
export * as googleApihubPluginInstance from './google-apihub-plugin-instance';
...
export * as googleApphubBoundary from './google-apphub-boundary';
...
export * as googleArtifactRegistryRule from './google-artifact-registry-rule';
...
export * as googleBackupDrRestoreWorkload from './google-backup-dr-restore-workload';
...
export * as googleBeyondcorpSecurityGatewayApplication from './google-beyondcorp-security-gateway-application';
export * as googleBeyondcorpSecurityGatewayApplicationIamBinding from './google-beyondcorp-security-gateway-application-iam-binding';
export * as googleBeyondcorpSecurityGatewayApplicationIamMember from './google-beyondcorp-security-gateway-application-iam-member';
export * as googleBeyondcorpSecurityGatewayApplicationIamPolicy from './google-beyondcorp-security-gateway-application-iam-policy';
...
export * as googleBiglakeIcebergCatalog from './google-biglake-iceberg-catalog';
export * as googleBiglakeIcebergCatalogIamBinding from './google-biglake-iceberg-catalog-iam-binding';
export * as googleBiglakeIcebergCatalogIamMember from './google-biglake-iceberg-catalog-iam-member';
export * as googleBiglakeIcebergCatalogIamPolicy from './google-biglake-iceberg-catalog-iam-policy';
export * as googleBiglakeIcebergNamespace from './google-biglake-iceberg-namespace';
export * as googleBiglakeIcebergNamespaceIamBinding from './google-biglake-iceberg-namespace-iam-binding';
export * as googleBiglakeIcebergNamespaceIamMember from './google-biglake-iceberg-namespace-iam-member';
export * as googleBiglakeIcebergNamespaceIamPolicy from './google-biglake-iceberg-namespace-iam-policy';
export * as googleBiglakeIcebergTable from './google-biglake-iceberg-table';
export * as googleBiglakeIcebergTableIamBinding from './google-biglake-iceberg-table-iam-binding';
export * as googleBiglakeIcebergTableIamMember from './google-biglake-iceberg-table-iam-member';
export * as googleBiglakeIcebergTableIamPolicy from './google-biglake-iceberg-table-iam-policy';
...
export * as googleBigqueryDatapolicyv2DataPolicy from './google-bigquery-datapolicyv2-data-policy';
export * as googleBigqueryDatapolicyv2DataPolicyIamBinding from './google-bigquery-datapolicyv2-data-policy-iam-binding';
export * as googleBigqueryDatapolicyv2DataPolicyIamMember from './google-bigquery-datapolicyv2-data-policy-iam-member';
export * as googleBigqueryDatapolicyv2DataPolicyIamPolicy from './google-bigquery-datapolicyv2-data-policy-iam-policy';
...
export * as googleBigqueryReservationGroup from './google-bigquery-reservation-group';
export * as googleBigqueryRoutine from './google-bigquery-routine';
export * as googleBigqueryRowAccessPolicy from './google-bigquery-row-access-policy';
...
export * as googleCesAgent from './google-ces-agent';
export * as googleCesApp from './google-ces-app';
export * as googleCesAppRootAgentAssociation from './google-ces-app-root-agent-association';
export * as googleCesAppVersion from './google-ces-app-version';
export * as googleCesDeployment from './google-ces-deployment';
export * as googleCesEvaluation from './google-ces-evaluation';
export * as googleCesExample from './google-ces-example';
export * as googleCesGuardrail from './google-ces-guardrail';
export * as googleCesTool from './google-ces-tool';
export * as googleCesToolset from './google-ces-toolset';
export * as googleChronicleDashboardChart from './google-chronicle-dashboard-chart';
...
export * as googleChronicleDataTable from './google-chronicle-data-table';
export * as googleChronicleDataTableRow from './google-chronicle-data-table-row';
export * as googleChronicleFeed from './google-chronicle-feed';
export * as googleChronicleNativeDashboard from './google-chronicle-native-dashboard';
...
export * as googleCloudIdentityPolicy from './google-cloud-identity-policy';
...
export * as googleCloudRunV2WorkerPool from './google-cloud-run-v2-worker-pool';
export * as googleCloudRunV2WorkerPoolIamBinding from './google-cloud-run-v2-worker-pool-iam-binding';
export * as googleCloudRunV2WorkerPoolIamMember from './google-cloud-run-v2-worker-pool-iam-member';
export * as googleCloudRunV2WorkerPoolIamPolicy from './google-cloud-run-v2-worker-pool-iam-policy';
export * as googleCloudSchedulerJob from './google-cloud-scheduler-job';
export * as googleCloudSecurityComplianceCloudControl from './google-cloud-security-compliance-cloud-control';
export * as googleCloudSecurityComplianceFramework from './google-cloud-security-compliance-framework';
export * as googleCloudSecurityComplianceFrameworkDeployment from './google-cloud-security-compliance-framework-deployment';
...
export * as googleComputeFutureReservation from './google-compute-future-reservation';
...
export * as googleComputeRegionBackendBucket from './google-compute-region-backend-bucket';
export * as googleComputeRegionBackendBucketIamBinding from './google-compute-region-backend-bucket-iam-binding';
export * as googleComputeRegionBackendBucketIamMember from './google-compute-region-backend-bucket-iam-member';
export * as googleComputeRegionBackendBucketIamPolicy from './google-compute-region-backend-bucket-iam-policy';
...
export * as googleComputeRegionCompositeHealthCheck from './google-compute-region-composite-health-check';
...
export * as googleComputeRegionHealthAggregationPolicy from './google-compute-region-health-aggregation-policy';
...
export * as googleComputeResourcePolicyAttachment from './google-compute-resource-policy-attachment';
export * as googleComputeRolloutPlan from './google-compute-rollout-plan';
...
export * as googleComputeRouterNamedSet from './google-compute-router-named-set';
...
export * as googleComputeStoragePoolIamBinding from './google-compute-storage-pool-iam-binding';
export * as googleComputeStoragePoolIamMember from './google-compute-storage-pool-iam-member';
export * as googleComputeStoragePoolIamPolicy from './google-compute-storage-pool-iam-policy';
...
export * as googleContactCenterInsightsAssessmentRule from './google-contact-center-insights-assessment-rule';
export * as googleContactCenterInsightsAutoLabelingRule from './google-contact-center-insights-auto-labeling-rule';
export * as googleContactCenterInsightsQaQuestion from './google-contact-center-insights-qa-question';
export * as googleContactCenterInsightsQaScorecard from './google-contact-center-insights-qa-scorecard';
export * as googleContactCenterInsightsQaScorecardRevision from './google-contact-center-insights-qa-scorecard-revision';
...
export * as googleDataLineageConfig from './google-data-lineage-config';
...
export * as googleDataformConfig from './google-dataform-config';
export * as googleDataformFolder from './google-dataform-folder';
...
export * as googleDataformTeamFolder from './google-dataform-team-folder';
...
export * as googleDataplexDataAsset from './google-dataplex-data-asset';
export * as googleDataplexDataProduct from './google-dataplex-data-product';
export * as googleDataplexDataProductDataAsset from './google-dataplex-data-product-data-asset';
...
export * as googleDataplexEntryLink from './google-dataplex-entry-link';
...
export * as googleDataplexGlossary from './google-dataplex-glossary';
export * as googleDataplexGlossaryCategory from './google-dataplex-glossary-category';
export * as googleDataplexGlossaryIamBinding from './google-dataplex-glossary-iam-binding';
export * as googleDataplexGlossaryIamMember from './google-dataplex-glossary-iam-member';
export * as googleDataplexGlossaryIamPolicy from './google-dataplex-glossary-iam-policy';
export * as googleDataplexGlossaryTerm from './google-dataplex-glossary-term';
...
export * as googleDataprocMetastoreDatabaseIamBinding from './google-dataproc-metastore-database-iam-binding';
export * as googleDataprocMetastoreDatabaseIamMember from './google-dataproc-metastore-database-iam-member';
export * as googleDataprocMetastoreDatabaseIamPolicy from './google-dataproc-metastore-database-iam-policy';
...
export * as googleDataprocMetastoreTableIamBinding from './google-dataproc-metastore-table-iam-binding';
export * as googleDataprocMetastoreTableIamMember from './google-dataproc-metastore-table-iam-member';
export * as googleDataprocMetastoreTableIamPolicy from './google-dataproc-metastore-table-iam-policy';
export * as googleDataprocSessionTemplate from './google-dataproc-session-template';
...
export * as googleDialogflowCxToolVersion from './google-dialogflow-cx-tool-version';
...
export * as googleDialogflowEncryptionSpec from './google-dialogflow-encryption-spec';
export * as googleDialogflowEntityType from './google-dialogflow-entity-type';
export * as googleDialogflowEnvironment from './google-dialogflow-environment';
export * as googleDialogflowFulfillment from './google-dialogflow-fulfillment';
export * as googleDialogflowGenerator from './google-dialogflow-generator';
export * as googleDialogflowIntent from './google-dialogflow-intent';
export * as googleDialogflowVersion from './google-dialogflow-version';
export * as googleDiscoveryEngineAclConfig from './google-discovery-engine-acl-config';
export * as googleDiscoveryEngineAssistant from './google-discovery-engine-assistant';
export * as googleDiscoveryEngineChatEngine from './google-discovery-engine-chat-engine';
export * as googleDiscoveryEngineCmekConfig from './google-discovery-engine-cmek-config';
export * as googleDiscoveryEngineControl from './google-discovery-engine-control';
export * as googleDiscoveryEngineDataConnector from './google-discovery-engine-data-connector';
export * as googleDiscoveryEngineDataStore from './google-discovery-engine-data-store';
export * as googleDiscoveryEngineLicenseConfig from './google-discovery-engine-license-config';
export * as googleDiscoveryEngineRecommendationEngine from './google-discovery-engine-recommendation-engine';
...
export * as googleDiscoveryEngineServingConfig from './google-discovery-engine-serving-config';
export * as googleDiscoveryEngineSitemap from './google-discovery-engine-sitemap';
export * as googleDiscoveryEngineTargetSite from './google-discovery-engine-target-site';
export * as googleDiscoveryEngineUserStore from './google-discovery-engine-user-store';
export * as googleDiscoveryEngineWidgetConfig from './google-discovery-engine-widget-config';
...
export * as googleDocumentAiSchema from './google-document-ai-schema';
...
export * as googleEventarcEnrollment from './google-eventarc-enrollment';
...
export * as googleFirebaseAiLogicConfig from './google-firebase-ai-logic-config';
export * as googleFirebaseAiLogicPromptTemplate from './google-firebase-ai-logic-prompt-template';
export * as googleFirebaseAiLogicPromptTemplateLock from './google-firebase-ai-logic-prompt-template-lock';
...
export * as googleFirebaseAppCheckResourcePolicy from './google-firebase-app-check-resource-policy';
...
export * as googleFirebaseAppHostingBuild from './google-firebase-app-hosting-build';
export * as googleFirebaseAppHostingDefaultDomain from './google-firebase-app-hosting-default-domain';
export * as googleFirebaseAppHostingDomain from './google-firebase-app-hosting-domain';
export * as googleFirebaseAppHostingTraffic from './google-firebase-app-hosting-traffic';
...
export * as googleFirebaseRemoteConfigRemoteConfig from './google-firebase-remote-config-remote-config';
export * as googleFirebaseStorageBucket from './google-firebase-storage-bucket';
export * as googleFirebaseStorageDefaultBucket from './google-firebase-storage-default-bucket';
...
export * as googleFirestoreUserCreds from './google-firestore-user-creds';
...
export * as googleGkeBackupBackupChannel from './google-gke-backup-backup-channel';
...
export * as googleGkeBackupRestoreChannel from './google-gke-backup-restore-channel';
...
export * as googleGkeHubRolloutSequence from './google-gke-hub-rollout-sequence';
...
export * as googleHypercomputeclusterCluster from './google-hypercomputecluster-cluster';
...
export * as googleIamOauthClient from './google-iam-oauth-client';
export * as googleIamOauthClientCredential from './google-iam-oauth-client-credential';
...
export * as googleIamWorkforcePoolIamBinding from './google-iam-workforce-pool-iam-binding';
export * as googleIamWorkforcePoolIamMember from './google-iam-workforce-pool-iam-member';
export * as googleIamWorkforcePoolIamPolicy from './google-iam-workforce-pool-iam-policy';
export * as googleIamWorkforcePoolProvider from './google-iam-workforce-pool-provider';
export * as googleIamWorkforcePoolProviderKey from './google-iam-workforce-pool-provider-key';
export * as googleIamWorkforcePoolProviderScimTenant from './google-iam-workforce-pool-provider-scim-tenant';
export * as googleIamWorkforcePoolProviderScimToken from './google-iam-workforce-pool-provider-scim-token';
export * as googleIamWorkloadIdentityPool from './google-iam-workload-identity-pool';
export * as googleIamWorkloadIdentityPoolIamBinding from './google-iam-workload-identity-pool-iam-binding';
export * as googleIamWorkloadIdentityPoolIamMember from './google-iam-workload-identity-pool-iam-member';
export * as googleIamWorkloadIdentityPoolIamPolicy from './google-iam-workload-identity-pool-iam-policy';
export * as googleIamWorkloadIdentityPoolManagedIdentity from './google-iam-workload-identity-pool-managed-identity';
export * as googleIamWorkloadIdentityPoolNamespace from './google-iam-workload-identity-pool-namespace';
export * as googleIamWorkloadIdentityPoolProvider from './google-iam-workload-identity-pool-provider';
export * as googleIapAgentRegistryIamBinding from './google-iap-agent-registry-iam-binding';
export * as googleIapAgentRegistryIamMember from './google-iap-agent-registry-iam-member';
export * as googleIapAgentRegistryIamPolicy from './google-iap-agent-registry-iam-policy';
...
export * as googleIapLocationWebIamBinding from './google-iap-location-web-iam-binding';
export * as googleIapLocationWebIamMember from './google-iap-location-web-iam-member';
export * as googleIapLocationWebIamPolicy from './google-iap-location-web-iam-policy';
...
export * as googleIapWebCloudRunServiceIamBinding from './google-iap-web-cloud-run-service-iam-binding';
export * as googleIapWebCloudRunServiceIamMember from './google-iap-web-cloud-run-service-iam-member';
export * as googleIapWebCloudRunServiceIamPolicy from './google-iap-web-cloud-run-service-iam-policy';
export * as googleIapWebForwardingRuleServiceIamBinding from './google-iap-web-forwarding-rule-service-iam-binding';
export * as googleIapWebForwardingRuleServiceIamMember from './google-iap-web-forwarding-rule-service-iam-member';
export * as googleIapWebForwardingRuleServiceIamPolicy from './google-iap-web-forwarding-rule-service-iam-policy';
...
export * as googleIapWebRegionForwardingRuleServiceIamBinding from './google-iap-web-region-forwarding-rule-service-iam-binding';
export * as googleIapWebRegionForwardingRuleServiceIamMember from './google-iap-web-region-forwarding-rule-service-iam-member';
export * as googleIapWebRegionForwardingRuleServiceIamPolicy from './google-iap-web-region-forwarding-rule-service-iam-policy';
...
export * as googleKmsFolderKajPolicyConfig from './google-kms-folder-kaj-policy-config';
...
export * as googleKmsOrganizationKajPolicyConfig from './google-kms-organization-kaj-policy-config';
export * as googleKmsProjectAutokeyConfig from './google-kms-project-autokey-config';
export * as googleKmsProjectKajPolicyConfig from './google-kms-project-kaj-policy-config';
...
export * as googleLoggingSavedQuery from './google-logging-saved-query';
export * as googleLookerInstance from './google-looker-instance';
export * as googleLustreInstance from './google-lustre-instance';
export * as googleManagedKafkaAcl from './google-managed-kafka-acl';
...
export * as googleMemorystoreInstanceDesiredUserCreatedEndpoints from './google-memorystore-instance-desired-user-created-endpoints';
...
export * as googleNetappHostGroup from './google-netapp-host-group';
...
export * as googleNetworkConnectivityDestination from './google-network-connectivity-destination';
export * as googleNetworkConnectivityGatewayAdvertisedRoute from './google-network-connectivity-gateway-advertised-route';
...
export * as googleNetworkConnectivityHubIamBinding from './google-network-connectivity-hub-iam-binding';
export * as googleNetworkConnectivityHubIamMember from './google-network-connectivity-hub-iam-member';
export * as googleNetworkConnectivityHubIamPolicy from './google-network-connectivity-hub-iam-policy';
export * as googleNetworkConnectivityInternalRange from './google-network-connectivity-internal-range';
export * as googleNetworkConnectivityMulticloudDataTransferConfig from './google-network-connectivity-multicloud-data-transfer-config';
...
export * as googleNetworkConnectivityTransport from './google-network-connectivity-transport';
export * as googleNetworkManagementConnectivityTest from './google-network-management-connectivity-test';
export * as googleNetworkManagementOrganizationVpcFlowLogsConfig from './google-network-management-organization-vpc-flow-logs-config';
...
export * as googleNetworkSecurityBackendAuthenticationConfig from './google-network-security-backend-authentication-config';
export * as googleNetworkSecurityClientTlsPolicy from './google-network-security-client-tls-policy';
export * as googleNetworkSecurityDnsThreatDetector from './google-network-security-dns-threat-detector';
...
export * as googleNetworkSecurityMirroringEndpoint from './google-network-security-mirroring-endpoint';
...
export * as googleNetworkSecuritySacAttachment from './google-network-security-sac-attachment';
export * as googleNetworkSecuritySacRealm from './google-network-security-sac-realm';
...
export * as googleNetworkSecurityUllMirroringCollector from './google-network-security-ull-mirroring-collector';
export * as googleNetworkSecurityUllMirroringCollectorRule from './google-network-security-ull-mirroring-collector-rule';
export * as googleNetworkSecurityUllMirroringEngine from './google-network-security-ull-mirroring-engine';
export * as googleNetworkSecurityUrlLists from './google-network-security-url-lists';
export * as googleNetworkServicesAgentGateway from './google-network-services-agent-gateway';
...
export * as googleNetworkServicesLbEdgeExtension from './google-network-services-lb-edge-extension';
...
export * as googleNetworkServicesMulticastConsumerAssociation from './google-network-services-multicast-consumer-association';
export * as googleNetworkServicesMulticastDomain from './google-network-services-multicast-domain';
export * as googleNetworkServicesMulticastDomainActivation from './google-network-services-multicast-domain-activation';
export * as googleNetworkServicesMulticastDomainGroup from './google-network-services-multicast-domain-group';
export * as googleNetworkServicesMulticastGroupConsumerActivation from './google-network-services-multicast-group-consumer-activation';
export * as googleNetworkServicesMulticastGroupProducerActivation from './google-network-services-multicast-group-producer-activation';
export * as googleNetworkServicesMulticastGroupRange from './google-network-services-multicast-group-range';
export * as googleNetworkServicesMulticastGroupRangeActivation from './google-network-services-multicast-group-range-activation';
export * as googleNetworkServicesMulticastProducerAssociation from './google-network-services-multicast-producer-association';
...
export * as googleNetworkServicesWasmPlugin from './google-network-services-wasm-plugin';
...
export * as googleObservabilityFolderSettings from './google-observability-folder-settings';
export * as googleObservabilityOrganizationSettings from './google-observability-organization-settings';
export * as googleObservabilityProjectSettings from './google-observability-project-settings';
export * as googleObservabilityTraceScope from './google-observability-trace-scope';
...
export * as googleOracleDatabaseDbSystem from './google-oracle-database-db-system';
export * as googleOracleDatabaseExadbVmCluster from './google-oracle-database-exadb-vm-cluster';
export * as googleOracleDatabaseExascaleDbStorageVault from './google-oracle-database-exascale-db-storage-vault';
export * as googleOracleDatabaseOdbNetwork from './google-oracle-database-odb-network';
export * as googleOracleDatabaseOdbSubnet from './google-oracle-database-odb-subnet';
...
export * as googleOrganizationServiceIdentity from './google-organization-service-identity';
...
export * as googlePrivilegedAccessManagerSettings from './google-privileged-access-manager-settings';
...
export * as googleSaasRuntimeRelease from './google-saas-runtime-release';
export * as googleSaasRuntimeRolloutKind from './google-saas-runtime-rollout-kind';
export * as googleSaasRuntimeSaas from './google-saas-runtime-saas';
export * as googleSaasRuntimeTenant from './google-saas-runtime-tenant';
export * as googleSaasRuntimeUnit from './google-saas-runtime-unit';
export * as googleSaasRuntimeUnitKind from './google-saas-runtime-unit-kind';
export * as googleSaasRuntimeUnitOperation from './google-saas-runtime-unit-operation';
...
export * as googleSecureSourceManagerHook from './google-secure-source-manager-hook';
...
export * as googleSqlProvisionScript from './google-sql-provision-script';
...
export * as googleStorageBatchOperationsJob from './google-storage-batch-operations-job';
...
export * as googleStorageControlFolderIntelligenceConfig from './google-storage-control-folder-intelligence-config';
export * as googleStorageControlOrganizationIntelligenceConfig from './google-storage-control-organization-intelligence-config';
export * as googleStorageControlProjectIntelligenceConfig from './google-storage-control-project-intelligence-config';
...
export * as googleStorageInsightsDatasetConfig from './google-storage-insights-dataset-config';
...
export * as googleVectorSearchCollection from './google-vector-search-collection';
export * as googleVertexAiCacheConfig from './google-vertex-ai-cache-config';
...
export * as googleVertexAiReasoningEngine from './google-vertex-ai-reasoning-engine';
export * as googleVertexAiReasoningEngineIamBinding from './google-vertex-ai-reasoning-engine-iam-binding';
export * as googleVertexAiReasoningEngineIamMember from './google-vertex-ai-reasoning-engine-iam-member';
export * as googleVertexAiReasoningEngineIamPolicy from './google-vertex-ai-reasoning-engine-iam-policy';
...
export * as googleVmwareengineDatastore from './google-vmwareengine-datastore';
...
export * as googleWorkloadIdentityServiceAgent from './google-workload-identity-service-agent';
...
export * as dataGoogleAccessContextManagerSupportedService from './data-google-access-context-manager-supported-service';
export * as dataGoogleAccessContextManagerSupportedServices from './data-google-access-context-manager-supported-services';
...
export * as dataGoogleArtifactRegistryFile from './data-google-artifact-registry-file';
export * as dataGoogleArtifactRegistryLocations from './data-google-artifact-registry-locations';
export * as dataGoogleArtifactRegistryMavenArtifact from './data-google-artifact-registry-maven-artifact';
export * as dataGoogleArtifactRegistryMavenArtifacts from './data-google-artifact-registry-maven-artifacts';
export * as dataGoogleArtifactRegistryNpmPackage from './data-google-artifact-registry-npm-package';
export * as dataGoogleArtifactRegistryNpmPackages from './data-google-artifact-registry-npm-packages';
export * as dataGoogleArtifactRegistryPackage from './data-google-artifact-registry-package';
export * as dataGoogleArtifactRegistryPackages from './data-google-artifact-registry-packages';
export * as dataGoogleArtifactRegistryPythonPackage from './data-google-artifact-registry-python-package';
export * as dataGoogleArtifactRegistryPythonPackages from './data-google-artifact-registry-python-packages';
...
export * as dataGoogleArtifactRegistryVersions from './data-google-artifact-registry-versions';
...
export * as dataGoogleBackupDrBackupPlanAssociations from './data-google-backup-dr-backup-plan-associations';
...
export * as dataGoogleBackupDrDataSourceReference from './data-google-backup-dr-data-source-reference';
export * as dataGoogleBackupDrDataSourceReferences from './data-google-backup-dr-data-source-references';
export * as dataGoogleBackupDrDataSources from './data-google-backup-dr-data-sources';
...
export * as dataGoogleBeyondcorpSecurityGateway from './data-google-beyondcorp-security-gateway';
export * as dataGoogleBeyondcorpSecurityGatewayApplicationIamPolicy from './data-google-beyondcorp-security-gateway-application-iam-policy';
export * as dataGoogleBeyondcorpSecurityGatewayIamPolicy from './data-google-beyondcorp-security-gateway-iam-policy';
export * as dataGoogleBiglakeIcebergCatalogIamPolicy from './data-google-biglake-iceberg-catalog-iam-policy';
export * as dataGoogleBiglakeIcebergNamespaceIamPolicy from './data-google-biglake-iceberg-namespace-iam-policy';
export * as dataGoogleBiglakeIcebergTableIamPolicy from './data-google-biglake-iceberg-table-iam-policy';
...
export * as dataGoogleBigqueryDatapolicyv2DataPolicyIamPolicy from './data-google-bigquery-datapolicyv2-data-policy-iam-policy';
...
export * as dataGoogleCertificateManagerDnsAuthorization from './data-google-certificate-manager-dns-authorization';
...
export * as dataGoogleCloudIdentityPolicies from './data-google-cloud-identity-policies';
export * as dataGoogleCloudIdentityPolicy from './data-google-cloud-identity-policy';
...
export * as dataGoogleCloudRunV2WorkerPool from './data-google-cloud-run-v2-worker-pool';
export * as dataGoogleCloudRunV2WorkerPoolIamPolicy from './data-google-cloud-run-v2-worker-pool-iam-policy';
...
export * as dataGoogleComputeImages from './data-google-compute-images';
...
export * as dataGoogleComputeInterconnectLocation from './data-google-compute-interconnect-location';
export * as dataGoogleComputeInterconnectLocations from './data-google-compute-interconnect-locations';
...
export * as dataGoogleComputeNetworkEndpointGroups from './data-google-compute-network-endpoint-groups';
...
export * as dataGoogleComputeRegionBackendBucketIamPolicy from './data-google-compute-region-backend-bucket-iam-policy';
export * as dataGoogleComputeRegionBackendService from './data-google-compute-region-backend-service';
...
export * as dataGoogleComputeRegionSslPolicy from './data-google-compute-region-ssl-policy';
...
export * as dataGoogleComputeReservationBlock from './data-google-compute-reservation-block';
export * as dataGoogleComputeReservationSubBlock from './data-google-compute-reservation-sub-block';
...
export * as dataGoogleComputeRouters from './data-google-compute-routers';
...
export * as dataGoogleComputeStoragePool from './data-google-compute-storage-pool';
export * as dataGoogleComputeStoragePoolIamPolicy from './data-google-compute-storage-pool-iam-policy';
export * as dataGoogleComputeStoragePoolTypes from './data-google-compute-storage-pool-types';
...
export * as dataGoogleDataLineageConfig from './data-google-data-lineage-config';
...
export * as dataGoogleDataplexGlossaryIamPolicy from './data-google-dataplex-glossary-iam-policy';
...
export * as dataGoogleDataprocMetastoreDatabaseIamPolicy from './data-google-dataproc-metastore-database-iam-policy';
...
export * as dataGoogleDataprocMetastoreTableIamPolicy from './data-google-dataproc-metastore-table-iam-policy';
export * as dataGoogleDatastreamStaticIps from './data-google-datastream-static-ips';
export * as dataGoogleDiscoveryEngineDataStore from './data-google-discovery-engine-data-store';
export * as dataGoogleDiscoveryEngineDataStores from './data-google-discovery-engine-data-stores';
...
export * as dataGoogleDnsRecordSets from './data-google-dns-record-sets';
...
export * as dataGoogleFirebaseAdminSdkConfig from './data-google-firebase-admin-sdk-config';
...
export * as dataGoogleGkeHubMembership from './data-google-gke-hub-membership';
...
export * as dataGoogleIamWorkforcePoolIamPolicy from './data-google-iam-workforce-pool-iam-policy';
export * as dataGoogleIamWorkloadIdentityPool from './data-google-iam-workload-identity-pool';
export * as dataGoogleIamWorkloadIdentityPoolIamPolicy from './data-google-iam-workload-identity-pool-iam-policy';
export * as dataGoogleIamWorkloadIdentityPoolProvider from './data-google-iam-workload-identity-pool-provider';
export * as dataGoogleIapAgentRegistryIamPolicy from './data-google-iap-agent-registry-iam-policy';
...
export * as dataGoogleIapLocationWebIamPolicy from './data-google-iap-location-web-iam-policy';
...
export * as dataGoogleIapWebCloudRunServiceIamPolicy from './data-google-iap-web-cloud-run-service-iam-policy';
export * as dataGoogleIapWebForwardingRuleServiceIamPolicy from './data-google-iap-web-forwarding-rule-service-iam-policy';
...
export * as dataGoogleIapWebRegionForwardingRuleServiceIamPolicy from './data-google-iap-web-region-forwarding-rule-service-iam-policy';
...
export * as dataGoogleLustreInstance from './data-google-lustre-instance';
...
export * as dataGoogleNetworkConnectivityHubIamPolicy from './data-google-network-connectivity-hub-iam-policy';
export * as dataGoogleNetworkManagementConnectivityTestRun from './data-google-network-management-connectivity-test-run';
export * as dataGoogleNetworkManagementConnectivityTests from './data-google-network-management-connectivity-tests';
export * as dataGoogleNetworkSecurityAddressGroupIamPolicy from './data-google-network-security-address-group-iam-policy';
export * as dataGoogleNetworkSecurityAddressGroups from './data-google-network-security-address-groups';
...
export * as dataGoogleObservabilityFolderSettings from './data-google-observability-folder-settings';
export * as dataGoogleObservabilityOrganizationSettings from './data-google-observability-organization-settings';
export * as dataGoogleObservabilityProjectSettings from './data-google-observability-project-settings';
...
export * as dataGoogleOracleDatabaseOdbNetwork from './data-google-oracle-database-odb-network';
export * as dataGoogleOracleDatabaseOdbSubnet from './data-google-oracle-database-odb-subnet';
export * as dataGoogleOrganization from './data-google-organization';
export * as dataGoogleOrganizationIamCustomRole from './data-google-organization-iam-custom-role';
export * as dataGoogleOrganizationIamCustomRoles from './data-google-organization-iam-custom-roles';
...
export * as dataGoogleStorageBucketObjectContents from './data-google-storage-bucket-object-contents';
...
export * as dataGoogleStorageControlFolderIntelligenceConfig from './data-google-storage-control-folder-intelligence-config';
export * as dataGoogleStorageControlOrganizationIntelligenceConfig from './data-google-storage-control-organization-intelligence-config';
export * as dataGoogleStorageControlProjectIntelligenceConfig from './data-google-storage-control-project-intelligence-config';
export * as dataGoogleStorageInsightsDatasetConfig from './data-google-storage-insights-dataset-config';
...
export * as dataGoogleVertexAiReasoningEngineIamPolicy from './data-google-vertex-ai-reasoning-engine-iam-policy';
export * as dataGoogleVertexAiReasoningEngineQuery from './data-google-vertex-ai-reasoning-engine-query';
export * as dataGoogleVmwareengineAnnouncements from './data-google-vmwareengine-announcements';
export * as dataGoogleVmwareengineCluster from './data-google-vmwareengine-cluster';
export * as dataGoogleVmwareengineDatastore from './data-google-vmwareengine-datastore';
...
export * as dataGoogleVmwareengineUpgrades from './data-google-vmwareengine-upgrades';
