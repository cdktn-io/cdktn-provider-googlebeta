...
export interface GoogleLoggingLogViewIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleLoggingLogViewIamPolicy extends cdktf.TerraformResource {
