...
export interface GoogleGeminiLoggingSettingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleGeminiLoggingSettingTimeoutsToTerraform(struct?: GoogleGeminiLoggingSettingTimeouts | cdktf.IResolvable): any {
...
export function googleGeminiLoggingSettingTimeoutsToHclTerraform(struct?: GoogleGeminiLoggingSettingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGeminiLoggingSettingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGeminiLoggingSettingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGeminiLoggingSettingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleGeminiLoggingSetting extends cdktf.TerraformResource {
