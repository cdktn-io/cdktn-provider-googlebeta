...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_iap_agent_registry_agent_iam_member
...
export interface GoogleIapAgentRegistryAgentIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleIapAgentRegistryAgentIamMemberCondition;
}
export interface GoogleIapAgentRegistryAgentIamMemberCondition {
  /**
...
export function googleIapAgentRegistryAgentIamMemberConditionToTerraform(struct?: GoogleIapAgentRegistryAgentIamMemberConditionOutputReference | GoogleIapAgentRegistryAgentIamMemberCondition): any {
...
export function googleIapAgentRegistryAgentIamMemberConditionToHclTerraform(struct?: GoogleIapAgentRegistryAgentIamMemberConditionOutputReference | GoogleIapAgentRegistryAgentIamMemberCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleIapAgentRegistryAgentIamMemberConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleIapAgentRegistryAgentIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleIapAgentRegistryAgentIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleIapAgentRegistryAgentIamMember extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_iap_agent_registry_agent_iam_member";
  ...
  * @param importToId The construct id used in the generated config for the GoogleIapAgentRegistryAgentIamMember to import
  * @param importFromId The id of the existing GoogleIapAgentRegistryAgentIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_iap_agent_registry_agent_iam_member#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleIapAgentRegistryAgentIamMember to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_iap_agent_registry_agent_iam_member", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_iap_agent_registry_agent_iam_member google_iap_agent_registry_agent_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleIapAgentRegistryAgentIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleIapAgentRegistryAgentIamMemberConfig) {
    super(scope, id, {
      terraformResourceType: 'google_iap_agent_registry_agent_iam_member',
  ...
  private _condition = new GoogleIapAgentRegistryAgentIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleIapAgentRegistryAgentIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleIapAgentRegistryAgentIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: googleIapAgentRegistryAgentIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleIapAgentRegistryAgentIamMemberConditionList",
      },
    };
