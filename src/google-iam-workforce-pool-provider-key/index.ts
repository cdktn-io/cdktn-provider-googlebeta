...
export interface GoogleIamWorkforcePoolProviderKeyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleIamWorkforcePoolProviderKeyKeyDataOutputReference extends cdktf.ComplexObject {
...
export function googleIamWorkforcePoolProviderKeyTimeoutsToTerraform(struct?: GoogleIamWorkforcePoolProviderKeyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleIamWorkforcePoolProviderKeyTimeoutsToHclTerraform(struct?: GoogleIamWorkforcePoolProviderKeyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleIamWorkforcePoolProviderKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleIamWorkforcePoolProviderKeyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleIamWorkforcePoolProviderKeyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleIamWorkforcePoolProviderKey extends cdktf.TerraformResource {
