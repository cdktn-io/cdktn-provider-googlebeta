...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule
...
export interface GoogleChronicleRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#deletion_policy GoogleChronicleRule#deletion_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#etag GoogleChronicleRule#etag}
  */
  readonly etag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#id GoogleChronicleRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#instance GoogleChronicleRule#instance}
  */
  readonly instance: string;
  /**
  * The location of the resource. This is the geographical region where the Chronicle instance resides, such as "us" or "europe-west2".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#location GoogleChronicleRule#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#project GoogleChronicleRule#project}
  */
  readonly project?: string;
  /**
  * Rule Id is the ID of the Rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#rule_id GoogleChronicleRule#rule_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#scope GoogleChronicleRule#scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#text GoogleChronicleRule#text}
  */
  readonly text?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#timeouts GoogleChronicleRule#timeouts}
  */
...
export class GoogleChronicleRuleCompilationDiagnosticsPositionOutputReference extends cdktn.ComplexObject {
...
export class GoogleChronicleRuleCompilationDiagnosticsPositionList extends cdktn.ComplexList {
...
export class GoogleChronicleRuleCompilationDiagnosticsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleChronicleRuleCompilationDiagnosticsList extends cdktn.ComplexList {
...
export class GoogleChronicleRuleSeverityOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleChronicleRuleSeverityList extends cdktn.ComplexList {
...
export interface GoogleChronicleRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#create GoogleChronicleRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#delete GoogleChronicleRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#update GoogleChronicleRule#update}
  */
  readonly update?: string;
}

export function googleChronicleRuleTimeoutsToTerraform(struct?: GoogleChronicleRuleTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleChronicleRuleTimeoutsToHclTerraform(struct?: GoogleChronicleRuleTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleChronicleRuleTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleChronicleRuleTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleChronicleRuleTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule google_chronicle_rule}
*/
export class GoogleChronicleRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleChronicleRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_chronicle_rule google_chronicle_rule} Resource
  *
  * @param scope The scope in which to define this construct
