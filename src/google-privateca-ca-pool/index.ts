...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_privateca_ca_pool
...
export function googlePrivatecaCaPoolIssuancePolicyToTerraform(struct?: GooglePrivatecaCaPoolIssuancePolicyOutputReference | GooglePrivatecaCaPoolIssuancePolicy): any {
  ...
  return {
    backdate_duration: cdktf.stringToTerraform(struct!.backdateDuration),
...
export function googlePrivatecaCaPoolIssuancePolicyToHclTerraform(struct?: GooglePrivatecaCaPoolIssuancePolicyOutputReference | GooglePrivatecaCaPoolIssuancePolicy): any {
  ...
  const attrs = {
    backdate_duration: {
      value: cdktf.stringToHclTerraform(struct!.backdateDuration),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class GooglePrivatecaCaPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GooglePrivatecaCaPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_privateca_ca_pool#import import section} in the documentation of this resource for the id to use
