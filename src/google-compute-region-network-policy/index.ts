...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_compute_region_network_policy
...
export class GoogleComputeRegionNetworkPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeRegionNetworkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_compute_region_network_policy#import import section} in the documentation of this resource for the id to use
