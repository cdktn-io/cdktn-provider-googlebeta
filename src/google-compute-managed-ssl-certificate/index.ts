...
export class GoogleComputeManagedSslCertificateManagedOutputReference extends cdktf.ComplexObject {
...
export function googleComputeManagedSslCertificateTimeoutsToTerraform(struct?: GoogleComputeManagedSslCertificateTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleComputeManagedSslCertificateTimeoutsToHclTerraform(struct?: GoogleComputeManagedSslCertificateTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeManagedSslCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleComputeManagedSslCertificateTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeManagedSslCertificateTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleComputeManagedSslCertificate extends cdktf.TerraformResource {
