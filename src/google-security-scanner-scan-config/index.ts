...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_security_scanner_scan_config
...
export interface GoogleSecurityScannerScanConfigConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly staticIpScan?: boolean | cdktn.IResolvable;
  /**
...
export class GoogleSecurityScannerScanConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleSecurityScannerScanConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_security_scanner_scan_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_security_scanner_scan_config google_security_scanner_scan_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleSecurityScannerScanConfigConfig) {
    ...
    this._staticIpScan = config.staticIpScan;
  ...
  // static_ip_scan - computed: false, optional: true, required: false
  private _staticIpScan?: boolean | cdktn.IResolvable; 
  public get staticIpScan() {
    return this.getBooleanAttribute('static_ip_scan');
  }
  public set staticIpScan(value: boolean | cdktn.IResolvable) {
    this._staticIpScan = value;
  }
  public resetStaticIpScan() {
    this._staticIpScan = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get staticIpScanInput() {
    return this._staticIpScan;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      static_ip_scan: cdktn.booleanToTerraform(this._staticIpScan),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      static_ip_scan: {
        value: cdktn.booleanToHclTerraform(this._staticIpScan),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
