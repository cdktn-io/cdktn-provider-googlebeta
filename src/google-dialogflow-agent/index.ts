...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dialogflow_agent
...
export interface GoogleDialogflowAgentConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dialogflow_agent#match_mode GoogleDialogflowAgent#match_mode}
  */
...
export function googleDialogflowAgentTimeoutsToTerraform(struct?: GoogleDialogflowAgentTimeouts | cdktn.IResolvable): any {
...
export function googleDialogflowAgentTimeoutsToHclTerraform(struct?: GoogleDialogflowAgentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleDialogflowAgentTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDialogflowAgentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleDialogflowAgentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleDialogflowAgent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDialogflowAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dialogflow_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_dialogflow_agent google_dialogflow_agent} Resource
  *
  * @param scope The scope in which to define this construct
