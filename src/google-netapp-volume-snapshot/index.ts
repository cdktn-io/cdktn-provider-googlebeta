...
export interface GoogleNetappVolumeSnapshotConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleNetappVolumeSnapshotTimeoutsToTerraform(struct?: GoogleNetappVolumeSnapshotTimeouts | cdktf.IResolvable): any {
...
export function googleNetappVolumeSnapshotTimeoutsToHclTerraform(struct?: GoogleNetappVolumeSnapshotTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetappVolumeSnapshotTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetappVolumeSnapshotTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetappVolumeSnapshotTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleNetappVolumeSnapshot extends cdktf.TerraformResource {
