...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_netapp_volume_snapshot
...
export class GoogleNetappVolumeSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetappVolumeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_netapp_volume_snapshot#import import section} in the documentation of this resource for the id to use
