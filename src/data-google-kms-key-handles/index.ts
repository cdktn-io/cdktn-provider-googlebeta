...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/data-sources/google_kms_key_handles
...
export class DataGoogleKmsKeyHandles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsKeyHandles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/data-sources/google_kms_key_handles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/data-sources/google_kms_key_handles google_kms_key_handles} Data Source
  *
  * @param scope The scope in which to define this construct
