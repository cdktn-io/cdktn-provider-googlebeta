...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range
...
export interface GoogleNetworkConnectivityInternalRangeConfig extends cdktn.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#deletion_policy GoogleNetworkConnectivityInternalRange#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * An optional description of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#description GoogleNetworkConnectivityInternalRange#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#exclude_cidr_ranges GoogleNetworkConnectivityInternalRange#exclude_cidr_ranges}
  */
  readonly excludeCidrRanges?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#id GoogleNetworkConnectivityInternalRange#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#immutable GoogleNetworkConnectivityInternalRange#immutable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#ip_cidr_range GoogleNetworkConnectivityInternalRange#ip_cidr_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#labels GoogleNetworkConnectivityInternalRange#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the policy based route.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#name GoogleNetworkConnectivityInternalRange#name}
  */
  readonly name: string;
  /**
  * Fully-qualified URL of the network that this route applies to, for example: projects/my-project/global/networks/my-network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#network GoogleNetworkConnectivityInternalRange#network}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#overlaps GoogleNetworkConnectivityInternalRange#overlaps}
  */
  readonly overlaps?: string[];
  /**
  * The type of peering set for this internal range. Possible values: ["FOR_SELF", "FOR_PEER", "NOT_SHARED"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#peering GoogleNetworkConnectivityInternalRange#peering}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#prefix_length GoogleNetworkConnectivityInternalRange#prefix_length}
  */
  readonly prefixLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#project GoogleNetworkConnectivityInternalRange#project}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#target_cidr_range GoogleNetworkConnectivityInternalRange#target_cidr_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#usage GoogleNetworkConnectivityInternalRange#usage}
  */
  readonly usage: string;
  /**
  * allocation_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#allocation_options GoogleNetworkConnectivityInternalRange#allocation_options}
  */
  readonly allocationOptions?: GoogleNetworkConnectivityInternalRangeAllocationOptions;
  /**
  * migration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#migration GoogleNetworkConnectivityInternalRange#migration}
  */
  readonly migration?: GoogleNetworkConnectivityInternalRangeMigration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#timeouts GoogleNetworkConnectivityInternalRange#timeouts}
  */
  readonly timeouts?: GoogleNetworkConnectivityInternalRangeTimeouts;
}
export interface GoogleNetworkConnectivityInternalRangeAllocationOptions {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#allocation_strategy GoogleNetworkConnectivityInternalRange#allocation_strategy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#first_available_ranges_lookup_size GoogleNetworkConnectivityInternalRange#first_available_ranges_lookup_size}
  */
  readonly firstAvailableRangesLookupSize?: number;
}
...
export class GoogleNetworkConnectivityInternalRangeAllocationOptionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetworkConnectivityInternalRangeAllocationOptions | undefined {
    ...
    if (this._firstAvailableRangesLookupSize !== undefined) {
      hasAnyValues = true;
      internalValueResult.firstAvailableRangesLookupSize = this._firstAvailableRangesLookupSize;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleNetworkConnectivityInternalRangeAllocationOptions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._allocationStrategy = undefined;
      this._firstAvailableRangesLookupSize = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._allocationStrategy = value.allocationStrategy;
      this._firstAvailableRangesLookupSize = value.firstAvailableRangesLookupSize;
    }
  }
  ...
  // first_available_ranges_lookup_size - computed: false, optional: true, required: false
  private _firstAvailableRangesLookupSize?: number; 
  public get firstAvailableRangesLookupSize() {
    return this.getNumberAttribute('first_available_ranges_lookup_size');
  }
  public set firstAvailableRangesLookupSize(value: number) {
    this._firstAvailableRangesLookupSize = value;
  }
  public resetFirstAvailableRangesLookupSize() {
    this._firstAvailableRangesLookupSize = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get firstAvailableRangesLookupSizeInput() {
    return this._firstAvailableRangesLookupSize;
  }
}
export interface GoogleNetworkConnectivityInternalRangeMigration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#source GoogleNetworkConnectivityInternalRange#source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#target GoogleNetworkConnectivityInternalRange#target}
  */
...
export interface GoogleNetworkConnectivityInternalRangeTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#create GoogleNetworkConnectivityInternalRange#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#delete GoogleNetworkConnectivityInternalRange#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#update GoogleNetworkConnectivityInternalRange#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range google_network_connectivity_internal_range}
*/
export class GoogleNetworkConnectivityInternalRange extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleNetworkConnectivityInternalRange that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/resources/google_network_connectivity_internal_range google_network_connectivity_internal_range} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleNetworkConnectivityInternalRangeConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleNetworkConnectivityInternalRangeConfig) {
    super(scope, id, {
    ...
    this._excludeCidrRanges = config.excludeCidrRanges;
    this._id = config.id;
    ...
    this._allocationOptions.internalValue = config.allocationOptions;
  ...
  // exclude_cidr_ranges - computed: false, optional: true, required: false
  private _excludeCidrRanges?: string[]; 
  public get excludeCidrRanges() {
    return this.getListAttribute('exclude_cidr_ranges');
  }
  public set excludeCidrRanges(value: string[]) {
    this._excludeCidrRanges = value;
  }
  public resetExcludeCidrRanges() {
    this._excludeCidrRanges = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get excludeCidrRangesInput() {
    return this._excludeCidrRanges;
  }
  ...
  // allocation_options - computed: false, optional: true, required: false
  private _allocationOptions = new GoogleNetworkConnectivityInternalRangeAllocationOptionsOutputReference(this, "allocation_options");
  public get allocationOptions() {
    return this._allocationOptions;
  }
  public putAllocationOptions(value: GoogleNetworkConnectivityInternalRangeAllocationOptions) {
    this._allocationOptions.internalValue = value;
  }
  public resetAllocationOptions() {
    this._allocationOptions.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get allocationOptionsInput() {
    return this._allocationOptions.internalValue;
  }
  ...
  public putTimeouts(value: GoogleNetworkConnectivityInternalRangeTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      allocation_options: {
        value: googleNetworkConnectivityInternalRangeAllocationOptionsToHclTerraform(this._allocationOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleNetworkConnectivityInternalRangeAllocationOptionsList",
      },
      migration: {
      ...
      timeouts: {
        ...
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleNetworkConnectivityInternalRangeTimeouts",
      },
    };
