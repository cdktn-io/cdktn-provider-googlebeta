...
export interface GoogleBeyondcorpApplicationIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class GoogleBeyondcorpApplicationIamMemberConditionOutputReference extends cdktn.ComplexObject {
...
*/
export class GoogleBeyondcorpApplicationIamMember extends cdktn.TerraformResource {
