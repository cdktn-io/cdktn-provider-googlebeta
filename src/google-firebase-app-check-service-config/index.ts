...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_firebase_app_check_service_config
...
export interface GoogleFirebaseAppCheckServiceConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleFirebaseAppCheckServiceConfigTimeoutsToTerraform(struct?: GoogleFirebaseAppCheckServiceConfigTimeouts | cdktf.IResolvable): any {
...
export function googleFirebaseAppCheckServiceConfigTimeoutsToHclTerraform(struct?: GoogleFirebaseAppCheckServiceConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleFirebaseAppCheckServiceConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFirebaseAppCheckServiceConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleFirebaseAppCheckServiceConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleFirebaseAppCheckServiceConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleFirebaseAppCheckServiceConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_firebase_app_check_service_config#import import section} in the documentation of this resource for the id to use
