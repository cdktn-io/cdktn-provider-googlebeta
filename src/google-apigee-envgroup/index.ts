...
export function googleApigeeEnvgroupTimeoutsToHclTerraform(struct?: GoogleApigeeEnvgroupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApigeeEnvgroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: GoogleApigeeEnvgroupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
