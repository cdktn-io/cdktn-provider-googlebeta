...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_apigee_envgroup
...
export function googleApigeeEnvgroupTimeoutsToTerraform(struct?: GoogleApigeeEnvgroupTimeouts | cdktn.IResolvable): any {
...
export function googleApigeeEnvgroupTimeoutsToHclTerraform(struct?: GoogleApigeeEnvgroupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleApigeeEnvgroupTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleApigeeEnvgroupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleApigeeEnvgroupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleApigeeEnvgroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleApigeeEnvgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_apigee_envgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_apigee_envgroup", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_apigee_envgroup google_apigee_envgroup} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GoogleApigeeEnvgroupConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleApigeeEnvgroupConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleApigeeEnvgroupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleApigeeEnvgroupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleApigeeEnvgroupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: googleApigeeEnvgroupTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleApigeeEnvgroupTimeouts",
      },
    };
