...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_vertex_ai_featurestore
...
export interface GoogleVertexAiFeaturestoreConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class GoogleVertexAiFeaturestoreEncryptionSpecOutputReference extends cdktn.ComplexObject {
...
export class GoogleVertexAiFeaturestoreOnlineServingConfigScalingOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleVertexAiFeaturestoreOnlineServingConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleVertexAiFeaturestoreTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleVertexAiFeaturestoreTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleVertexAiFeaturestoreTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleVertexAiFeaturestore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleVertexAiFeaturestore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_vertex_ai_featurestore#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.33.0/docs/resources/google_vertex_ai_featurestore google_vertex_ai_featurestore} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      online_storage_ttl_days: cdktn.numberToTerraform(this._onlineStorageTtlDays),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      online_storage_ttl_days: {
        value: cdktn.numberToHclTerraform(this._onlineStorageTtlDays),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
