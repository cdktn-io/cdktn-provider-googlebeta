...
export interface GoogleBigqueryAnalyticsHubListingIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleBigqueryAnalyticsHubListingIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class GoogleBigqueryAnalyticsHubListingIamBinding extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_bigquery_analytics_hub_listing_iam_binding", importId: importFromId, provider });
      }
