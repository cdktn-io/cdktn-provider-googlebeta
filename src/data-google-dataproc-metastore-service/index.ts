...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_dataproc_metastore_service
...
export class DataGoogleDataprocMetastoreServiceEncryptionConfigOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleDataprocMetastoreServiceEncryptionConfigList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _configOverrides = new cdktn.StringMap(this, "config_overrides");
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersionsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersionsOutputReference {
    return new DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigKerberosConfigKeytabOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigKerberosConfigKeytabList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigKerberosConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigKerberosConfigList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  // auxiliary_versions - computed: true, optional: false, required: false
  private _auxiliaryVersions = new DataGoogleDataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersionsList(this, "auxiliary_versions", true);
...
export class DataGoogleDataprocMetastoreServiceHiveMetastoreConfigList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceMaintenanceWindowOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleDataprocMetastoreServiceMaintenanceWindowList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfigList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfigOutputReference {
    return new DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleDataprocMetastoreServiceMetadataIntegrationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleDataprocMetastoreServiceMetadataIntegration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleDataprocMetastoreServiceMetadataIntegration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _dataCatalogConfig = new DataGoogleDataprocMetastoreServiceMetadataIntegrationDataCatalogConfigList(this, "data_catalog_config", false);
  public get dataCatalogConfig() {
    return this._dataCatalogConfig;
  }
}

export class DataGoogleDataprocMetastoreServiceMetadataIntegrationList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleDataprocMetastoreServiceMetadataIntegrationOutputReference {
    return new DataGoogleDataprocMetastoreServiceMetadataIntegrationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleDataprocMetastoreServiceNetworkConfigConsumersOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleDataprocMetastoreServiceNetworkConfigConsumersList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceNetworkConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  // custom_routes_enabled - computed: true, optional: false, required: false
  public get customRoutesEnabled() {
    return this.getBooleanAttribute('custom_routes_enabled');
  }
}

export class DataGoogleDataprocMetastoreServiceNetworkConfigList extends cdktn.ComplexList {
...
export interface DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfig {
}
...
export class DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // max_scaling_factor - computed: true, optional: false, required: false
  public get maxScalingFactor() {
    return this.getNumberAttribute('max_scaling_factor');
  }

  // min_scaling_factor - computed: true, optional: false, required: false
  public get minScalingFactor() {
    return this.getNumberAttribute('min_scaling_factor');
  }
}

export class DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfigList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfigOutputReference {
    return new DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfig {
}
...
export class DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // limit_config - computed: true, optional: false, required: false
  private _limitConfig = new DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigLimitConfigList(this, "limit_config", false);
  public get limitConfig() {
    return this._limitConfig;
  }
}

export class DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigOutputReference {
    return new DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleDataprocMetastoreServiceScalingConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _autoscalingConfig = new DataGoogleDataprocMetastoreServiceScalingConfigAutoscalingConfigList(this, "autoscaling_config", false);
...
export class DataGoogleDataprocMetastoreServiceScalingConfigList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceScheduledBackupOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleDataprocMetastoreServiceScheduledBackupList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreServiceTelemetryConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleDataprocMetastoreServiceTelemetryConfigList extends cdktn.ComplexList {
...
export class DataGoogleDataprocMetastoreService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDataprocMetastoreService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_dataproc_metastore_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_dataproc_metastore_service google_dataproc_metastore_service} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // metadata_integration - computed: true, optional: false, required: false
  private _metadataIntegration = new DataGoogleDataprocMetastoreServiceMetadataIntegrationList(this, "metadata_integration", false);
