...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_composer_image_versions
...
export class DataGoogleComposerImageVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComposerImageVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/data-sources/google_composer_image_versions#import import section} in the documentation of this resource for the id to use
