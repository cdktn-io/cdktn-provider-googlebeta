...
export interface GoogleGeminiGeminiGcpEnablementSettingBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleGeminiGeminiGcpEnablementSettingBindingTimeoutsToTerraform(struct?: GoogleGeminiGeminiGcpEnablementSettingBindingTimeouts | cdktf.IResolvable): any {
...
export function googleGeminiGeminiGcpEnablementSettingBindingTimeoutsToHclTerraform(struct?: GoogleGeminiGeminiGcpEnablementSettingBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleGeminiGeminiGcpEnablementSettingBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGeminiGeminiGcpEnablementSettingBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleGeminiGeminiGcpEnablementSettingBinding extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_gemini_gemini_gcp_enablement_setting_binding", importId: importFromId, provider });
      }
