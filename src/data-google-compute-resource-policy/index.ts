...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_resource_policy
...
export class DataGoogleComputeResourcePolicyWorkloadPolicyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // accelerator_topology_mode - computed: true, optional: false, required: false
  public get acceleratorTopologyMode() {
    return this.getStringAttribute('accelerator_topology_mode');
  }
...
export class DataGoogleComputeResourcePolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.34.0/docs/data-sources/google_compute_resource_policy google_compute_resource_policy} Data Source
  *
  * @param scope The scope in which to define this construct
