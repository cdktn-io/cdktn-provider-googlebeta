...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_global_forwarding_rule
...
export interface GoogleComputeGlobalForwardingRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  * @pattern: \d+(?:-\d+)?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_global_forwarding_rule#port_range GoogleComputeGlobalForwardingRule#port_range}
  */
...
export class GoogleComputeGlobalForwardingRuleMetadataFiltersFilterLabelsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleComputeGlobalForwardingRuleMetadataFiltersFilterLabelsOutputReference {
    return new GoogleComputeGlobalForwardingRuleMetadataFiltersFilterLabelsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _filterLabels = new GoogleComputeGlobalForwardingRuleMetadataFiltersFilterLabelsList(this, "filter_labels", false);
...
export class GoogleComputeGlobalForwardingRuleMetadataFiltersList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference {
    return new GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class GoogleComputeGlobalForwardingRuleServiceDirectoryRegistrationsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeGlobalForwardingRuleServiceDirectoryRegistrations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleComputeGlobalForwardingRuleServiceDirectoryRegistrations | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleComputeGlobalForwardingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleComputeGlobalForwardingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_global_forwarding_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_compute_global_forwarding_rule google_compute_global_forwarding_rule} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _metadataFilters = new GoogleComputeGlobalForwardingRuleMetadataFiltersList(this, "metadata_filters", false);
  ...
  private _serviceDirectoryRegistrations = new GoogleComputeGlobalForwardingRuleServiceDirectoryRegistrationsOutputReference(this, "service_directory_registrations");
  public get serviceDirectoryRegistrations() {
    return this._serviceDirectoryRegistrations;
  }
  public putServiceDirectoryRegistrations(value: GoogleComputeGlobalForwardingRuleServiceDirectoryRegistrations) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      service_directory_registrations: {
        value: googleComputeGlobalForwardingRuleServiceDirectoryRegistrationsToHclTerraform(this._serviceDirectoryRegistrations.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleComputeGlobalForwardingRuleServiceDirectoryRegistrationsList",
      },
      timeouts: {
        value: googleComputeGlobalForwardingRuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GoogleComputeGlobalForwardingRuleTimeouts",
      },
    };
