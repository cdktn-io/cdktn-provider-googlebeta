...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_firebase_app_check_debug_token
...
export interface GoogleFirebaseAppCheckDebugTokenConfig extends cdktn.TerraformMetaArguments {
  /**
  * The ID of a
...
export function googleFirebaseAppCheckDebugTokenTimeoutsToTerraform(struct?: GoogleFirebaseAppCheckDebugTokenTimeouts | cdktn.IResolvable): any {
...
export function googleFirebaseAppCheckDebugTokenTimeoutsToHclTerraform(struct?: GoogleFirebaseAppCheckDebugTokenTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleFirebaseAppCheckDebugTokenTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFirebaseAppCheckDebugTokenTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleFirebaseAppCheckDebugTokenTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleFirebaseAppCheckDebugToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleFirebaseAppCheckDebugToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_firebase_app_check_debug_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_firebase_app_check_debug_token", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.31.0/docs/resources/google_firebase_app_check_debug_token google_firebase_app_check_debug_token} Resource
  *
  * @param scope The scope in which to define this construct
