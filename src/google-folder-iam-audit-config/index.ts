...
export function googleFolderIamAuditConfigAuditLogConfigToHclTerraform(struct?: GoogleFolderIamAuditConfigAuditLogConfig | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleFolderIamAuditConfigAuditLogConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFolderIamAuditConfigAuditLogConfig | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleFolderIamAuditConfigAuditLogConfig | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GoogleFolderIamAuditConfigAuditLogConfigList extends cdktf.ComplexList {
  public internalValue? : GoogleFolderIamAuditConfigAuditLogConfig[] | cdktf.IResolvable
...
export class GoogleFolderIamAuditConfig extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_folder_iam_audit_config", importId: importFromId, provider });
      }
  ...
  */
  ...
  public putAuditLogConfig(value: GoogleFolderIamAuditConfigAuditLogConfig[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      audit_log_config: cdktf.listMapper(googleFolderIamAuditConfigAuditLogConfigToTerraform, true)(this._auditLogConfig.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      audit_log_config: {
        value: cdktf.listMapperHcl(googleFolderIamAuditConfigAuditLogConfigToHclTerraform, true)(this._auditLogConfig.internalValue),
        isBlock: true,
        type: "set",
