...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_compute_subnetwork
...
export class DataGoogleComputeSubnetwork extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeSubnetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_compute_subnetwork#import import section} in the documentation of this resource for the id to use
