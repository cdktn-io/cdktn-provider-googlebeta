...
export class GoogleBigqueryDatasetAccessOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryDatasetAccess | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleBigqueryDatasetAccess | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleBigqueryDatasetAccessList extends cdktf.ComplexList {
  public internalValue? : GoogleBigqueryDatasetAccess[] | cdktf.IResolvable
...
export class GoogleBigqueryDatasetExternalCatalogDatasetOptionsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export function googleBigqueryDatasetTimeoutsToTerraform(struct?: GoogleBigqueryDatasetTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleBigqueryDatasetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleBigqueryDatasetTimeouts | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: GoogleBigqueryDatasetTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class GoogleBigqueryDataset extends cdktf.TerraformResource {
  ...
  */
  ...
  public putAccess(value: GoogleBigqueryDatasetAccess[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      access: cdktf.listMapper(googleBigqueryDatasetAccessToTerraform, true)(this._access.internalValue),
