...
// https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_chronicle_data_access_label
...
export interface GoogleChronicleDataAccessLabelConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleChronicleDataAccessLabelTimeoutsToTerraform(struct?: GoogleChronicleDataAccessLabelTimeouts | cdktf.IResolvable): any {
...
export function googleChronicleDataAccessLabelTimeoutsToHclTerraform(struct?: GoogleChronicleDataAccessLabelTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleChronicleDataAccessLabelTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleChronicleDataAccessLabelTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleChronicleDataAccessLabelTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleChronicleDataAccessLabel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleChronicleDataAccessLabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.50.0/docs/resources/google_chronicle_data_access_label#import import section} in the documentation of this resource for the id to use
