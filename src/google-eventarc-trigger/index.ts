...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_eventarc_trigger
...
export interface GoogleEventarcTriggerConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly retryPolicy?: GoogleEventarcTriggerRetryPolicy;
  /**
  * timeouts block
  *
...
export interface GoogleEventarcTriggerRetryPolicy {
  /**
...
export function googleEventarcTriggerRetryPolicyToTerraform(struct?: GoogleEventarcTriggerRetryPolicyOutputReference | GoogleEventarcTriggerRetryPolicy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function googleEventarcTriggerRetryPolicyToHclTerraform(struct?: GoogleEventarcTriggerRetryPolicyOutputReference | GoogleEventarcTriggerRetryPolicy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GoogleEventarcTriggerRetryPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleEventarcTriggerRetryPolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GoogleEventarcTriggerRetryPolicy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleEventarcTrigger extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleEventarcTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_eventarc_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/resources/google_eventarc_trigger google_eventarc_trigger} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _retryPolicy = new GoogleEventarcTriggerRetryPolicyOutputReference(this, "retry_policy");
  public get retryPolicy() {
    return this._retryPolicy;
  }
  public putRetryPolicy(value: GoogleEventarcTriggerRetryPolicy) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      retry_policy: googleEventarcTriggerRetryPolicyToTerraform(this._retryPolicy.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      retry_policy: {
        value: googleEventarcTriggerRetryPolicyToHclTerraform(this._retryPolicy.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GoogleEventarcTriggerRetryPolicyList",
      },
      timeouts: {
