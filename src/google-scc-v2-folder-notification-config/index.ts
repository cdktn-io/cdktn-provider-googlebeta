...
export interface GoogleSccV2FolderNotificationConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleSccV2FolderNotificationConfigStreamingConfigOutputReference extends cdktf.ComplexObject {
...
export function googleSccV2FolderNotificationConfigTimeoutsToTerraform(struct?: GoogleSccV2FolderNotificationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleSccV2FolderNotificationConfigTimeoutsToHclTerraform(struct?: GoogleSccV2FolderNotificationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleSccV2FolderNotificationConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleSccV2FolderNotificationConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleSccV2FolderNotificationConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleSccV2FolderNotificationConfig extends cdktf.TerraformResource {
