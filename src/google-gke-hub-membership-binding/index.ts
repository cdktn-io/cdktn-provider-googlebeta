...
export interface GoogleGkeHubMembershipBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleGkeHubMembershipBindingStateOutputReference extends cdktf.ComplexObject {
...
export class GoogleGkeHubMembershipBindingStateList extends cdktf.ComplexList {
...
export function googleGkeHubMembershipBindingTimeoutsToTerraform(struct?: GoogleGkeHubMembershipBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleGkeHubMembershipBindingTimeoutsToHclTerraform(struct?: GoogleGkeHubMembershipBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleGkeHubMembershipBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleGkeHubMembershipBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleGkeHubMembershipBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleGkeHubMembershipBinding extends cdktf.TerraformResource {
