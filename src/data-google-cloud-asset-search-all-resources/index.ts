...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_cloud_asset_search_all_resources
...
export interface DataGoogleCloudAssetSearchAllResourcesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleCloudAssetSearchAllResourcesResultsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleCloudAssetSearchAllResourcesResultsList extends cdktn.ComplexList {
...
*/
export class DataGoogleCloudAssetSearchAllResources extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudAssetSearchAllResources that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_cloud_asset_search_all_resources#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_cloud_asset_search_all_resources", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.42.0/docs/data-sources/google_cloud_asset_search_all_resources google_cloud_asset_search_all_resources} Data Source
  *
  * @param scope The scope in which to define this construct
