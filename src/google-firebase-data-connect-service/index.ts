...
export interface GoogleFirebaseDataConnectServiceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleFirebaseDataConnectServiceTimeoutsToTerraform(struct?: GoogleFirebaseDataConnectServiceTimeouts | cdktf.IResolvable): any {
...
export function googleFirebaseDataConnectServiceTimeoutsToHclTerraform(struct?: GoogleFirebaseDataConnectServiceTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleFirebaseDataConnectServiceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFirebaseDataConnectServiceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleFirebaseDataConnectServiceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleFirebaseDataConnectService extends cdktf.TerraformResource {
