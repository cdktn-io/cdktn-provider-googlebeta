...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_organization_iam_custom_roles
...
export interface DataGoogleOrganizationIamCustomRolesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleOrganizationIamCustomRolesRolesOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleOrganizationIamCustomRolesRolesList extends cdktn.ComplexList {
...
*/
export class DataGoogleOrganizationIamCustomRoles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOrganizationIamCustomRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_organization_iam_custom_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_organization_iam_custom_roles", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_organization_iam_custom_roles google_organization_iam_custom_roles} Data Source
  *
  * @param scope The scope in which to define this construct
