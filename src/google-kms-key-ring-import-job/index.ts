...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_kms_key_ring_import_job
...
export class GoogleKmsKeyRingImportJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleKmsKeyRingImportJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_kms_key_ring_import_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.40.0/docs/resources/google_kms_key_ring_import_job google_kms_key_ring_import_job} Resource
  *
  * @param scope The scope in which to define this construct
