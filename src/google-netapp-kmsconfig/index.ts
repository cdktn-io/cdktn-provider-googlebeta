...
export interface GoogleNetappKmsconfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function googleNetappKmsconfigTimeoutsToTerraform(struct?: GoogleNetappKmsconfigTimeouts | cdktf.IResolvable): any {
...
export function googleNetappKmsconfigTimeoutsToHclTerraform(struct?: GoogleNetappKmsconfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetappKmsconfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetappKmsconfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetappKmsconfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleNetappKmsconfig extends cdktf.TerraformResource {
