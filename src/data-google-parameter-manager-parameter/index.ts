...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_parameter_manager_parameter
...
export class DataGoogleParameterManagerParameterPolicyMemberOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleParameterManagerParameterPolicyMemberList extends cdktn.ComplexList {
...
export class DataGoogleParameterManagerParameter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleParameterManagerParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_parameter_manager_parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/data-sources/google_parameter_manager_parameter google_parameter_manager_parameter} Data Source
  *
  * @param scope The scope in which to define this construct
