...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/data-sources/google_network_management_connectivity_test_run
...
export class DataGoogleNetworkManagementConnectivityTestRun extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleNetworkManagementConnectivityTestRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/data-sources/google_network_management_connectivity_test_run#import import section} in the documentation of this resource for the id to use
