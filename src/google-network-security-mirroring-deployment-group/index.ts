...
export interface GoogleNetworkSecurityMirroringDeploymentGroupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GoogleNetworkSecurityMirroringDeploymentGroupConnectedEndpointGroupsOutputReference extends cdktf.ComplexObject {
...
export class GoogleNetworkSecurityMirroringDeploymentGroupConnectedEndpointGroupsList extends cdktf.ComplexList {
...
export class GoogleNetworkSecurityMirroringDeploymentGroupLocationsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class GoogleNetworkSecurityMirroringDeploymentGroupLocationsList extends cdktf.ComplexList {
...
export function googleNetworkSecurityMirroringDeploymentGroupTimeoutsToTerraform(struct?: GoogleNetworkSecurityMirroringDeploymentGroupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function googleNetworkSecurityMirroringDeploymentGroupTimeoutsToHclTerraform(struct?: GoogleNetworkSecurityMirroringDeploymentGroupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetworkSecurityMirroringDeploymentGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleNetworkSecurityMirroringDeploymentGroupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetworkSecurityMirroringDeploymentGroupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class GoogleNetworkSecurityMirroringDeploymentGroup extends cdktf.TerraformResource {
