...
// https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_dataplex_entry_type_iam_binding
...
export interface GoogleDataplexEntryTypeIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class GoogleDataplexEntryTypeIamBindingConditionOutputReference extends cdktn.ComplexObject {
...
*/
export class GoogleDataplexEntryTypeIamBinding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleDataplexEntryTypeIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_dataplex_entry_type_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_dataplex_entry_type_iam_binding google_dataplex_entry_type_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
